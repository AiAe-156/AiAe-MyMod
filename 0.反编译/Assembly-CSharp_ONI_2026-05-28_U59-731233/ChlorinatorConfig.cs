...
public class ChlorinatorConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("Chlorinator", 3, 3, "chlorinator_kanim", 100, 120f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, MATERIALS.REFINED_METALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER2);
	...
	private void ConfigureRecipes()
	{
		...
		string id = ComplexRecipeManager.MakeRecipeID("Chlorinator", array, array2);
