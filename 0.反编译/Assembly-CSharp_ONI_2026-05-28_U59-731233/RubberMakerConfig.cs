...
public class RubberMakerConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("RubberMaker", 3, 3, "vulcanizer_kanim", 100, 30f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.REFINED_METALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER3, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER1);
	...
	private void ConfigureRecipes()
	{
		...
		string id = ComplexRecipeManager.MakeRecipeID("RubberMaker", array, array2);
