...
public class HijackedHeadquartersConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("HijackedHeadquarters", 5, 5, "hijacked_hq_kanim", 250, 120f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, new string[1] { SimHashes.Steel.ToString() }, 3200f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER5, decor: BUILDINGS.DECOR.NONE);
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		HijackedHeadquarters.Def def = go.AddOrGetDef<HijackedHeadquarters.Def>();
		...
		DropToUserCapacity dropToUserCapacity = go.AddComponent<DropToUserCapacity>();
		go.GetComponent<KPrefabID>().prefabInitFn += delegate(GameObject game_object)
		{
			Activatable component2 = game_object.GetComponent<Activatable>();
			component2.SetOffsets(OffsetGroups.LeftOrRight);
