...
public class EnergyConsumer : KMonoBehaviour, ISaveLoadable, IEnergyConsumer, ICircuitConnected, IGameObjectEffectDescriptor
{
	...
	public float WattsUsed => operational.IsActive ? BaseWattageRating : 0f;

	public float WattsNeededWhenActive => (_BaseWattageRating > 0f) ? _BaseWattageRating : building.Def.EnergyConsumptionWhenActive;
