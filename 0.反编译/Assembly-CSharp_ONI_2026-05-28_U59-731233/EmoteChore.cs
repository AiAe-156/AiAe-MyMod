...
public class EmoteChore : Chore<EmoteChore.StatesInstance>
{
	public class StatesInstance : GameStateMachine<States, StatesInstance, EmoteChore, object>.GameInstance
	{
		...
		{
			Navigator component;
			return (emote.ManifestSwimAnimSet() != null && emoter.TryGetComponent<Navigator>(out component) && component.CurrentNavType == NavType.Swim) ? emote.ManifestSwimAnimSet() : emote.AnimSet;
		}
	}
