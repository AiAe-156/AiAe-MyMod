...
public class FlyTrapPlantConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		growing.MaxMaturityValuePercentageToSpawnWith = 0f;
		...
		GameObject template = EntityTemplates.CreateAndRegisterPreviewForPlant(seed, "FlyTrapPlant_preview", Assets.GetAnim("ceiling_carnie_kanim"), "place", 1, 2);
	...
	{
		StandardCropPlant standardCropPlant = inst.AddOrGet<StandardCropPlant>();
		standardCropPlant.anims = Default_StandardCropAnimSet;
	}
