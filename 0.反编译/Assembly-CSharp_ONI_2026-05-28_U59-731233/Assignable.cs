...
public abstract class Assignable : KMonoBehaviour, ISaveLoadable
{
	...
	protected override void OnSpawn()
	{
		...
		assignmentPreconditions.Add(delegate(MinionAssignablesProxy proxy)
		{
			...
			int myWorldId = targetGameObject.GetComponent<KMonoBehaviour>().GetMyWorldId();
			return (myWorldId == this.GetMyWorldId() || targetGameObject.IsMyParentWorld(base.gameObject)) ? true : false;
		});
