...
public class ClusterMapMeteorShowerVisualizer : ClusterGridEntity
{
	...
	public bool forceRevealed = false;
	...
	public string UI_ANIM_NAME => (forceRevealed || (revealed && clusterCellRevealLevel == ClusterRevealLevel.Visible)) ? "ui" : "unknown";

	public string AnimName => (forceRevealed || (revealed && clusterCellRevealLevel == ClusterRevealLevel.Visible)) ? "idle_loop" : "unknown";

	public string QuestionMarkAnimName => (forceRevealed || (revealed && clusterCellRevealLevel == ClusterRevealLevel.Visible)) ? "off" : questionMarkAnimConfig.initialAnim;
	...
	public void PlayRevealAnimation(bool playIdentifyAnimationIfVisible)
	{
		...
		if (playIdentifyAnimationIfVisible)
		{
			...
			KBatchedAnimController animController2 = entityVisAnim.GetAnimController(2);
			if (animController != null)
			{
