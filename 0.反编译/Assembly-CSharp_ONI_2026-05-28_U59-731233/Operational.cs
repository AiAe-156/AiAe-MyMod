...
public class Operational : KMonoBehaviour
{
	...
	private void UpdateFunctional()
	{
		...
		Trigger(-1852328367, (object)BoxedBools.Box(IsFunctional));
	}
	...
	private void UpdateOperational()
	{
		...
		if (flag != IsOperational)
		{
			...
			Trigger(-592767678, (object)BoxedBools.Box(IsOperational));
			Game.Instance.Trigger(-809948329, (object)base.gameObject);
		}
	}
