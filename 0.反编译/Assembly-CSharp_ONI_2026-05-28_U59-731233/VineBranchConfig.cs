...
public class VineBranchConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		if (component2 == null)
		{
			component2 = gameObject.AddOrGet<Traits>();
		...
		VineBranch.Def def = gameObject.AddOrGetDef<VineBranch.Def>();
	...
	{
		UprootedMonitor uprootedMonitor = inst.AddOrGet<UprootedMonitor>();
		uprootedMonitor.monitorCells = new CellOffset[0];
		HarvestDesignatable harvestDesignatable = inst.AddOrGet<HarvestDesignatable>();
		harvestDesignatable.iconOffset = new Vector2(0f, Grid.CellSizeInMeters * 0.75f);
	}
