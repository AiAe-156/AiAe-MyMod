...
public class NameDisplayScreen : KScreen
{
	...
	private bool isOverlayChangeBound = false;
	...
	private void LateUpdate()
	{
		...
		if (!(mainCamera == null) && !(lastKnownOverlayID != OverlayModes.None.ID))
		{
			...
			bool flag = IsVisibleToZoom();
			bool flag2 = flag && lastKnownOverlayID == OverlayModes.None.ID;
			if (nameDisplayCanvas.enabled != flag2)
			{
				nameDisplayCanvas.enabled = flag2;
			}
			if (flag)
			{
