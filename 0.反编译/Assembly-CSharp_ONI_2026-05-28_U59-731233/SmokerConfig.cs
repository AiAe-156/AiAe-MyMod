...
public class SmokerConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("Smoker", 4, 3, "smoker_kanim", 30, 30f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER3, decor: TUNING.BUILDINGS.DECOR.NONE);
	...
	private void ConfigureRecipes()
	{
		...
		string id = ComplexRecipeManager.MakeRecipeID("Smoker", array, array2);
		...
		string id2 = ComplexRecipeManager.MakeRecipeID("Smoker", array3, array4);
		...
		string id3 = ComplexRecipeManager.MakeRecipeID("Smoker", array5, array6);
