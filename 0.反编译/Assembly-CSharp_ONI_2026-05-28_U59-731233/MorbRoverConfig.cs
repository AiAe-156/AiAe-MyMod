...
public class MorbRoverConfig : IEntityConfig
{
	...
	public void TriggerDeconstructChoreOnDeath(object obj)
	{
		if (obj != null)
		{
			...
			Deconstructable component = gameObject.GetComponent<Deconstructable>();
