...
public class IncapacitationMonitor : GameStateMachine<IncapacitationMonitor, IncapacitationMonitor.Instance>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		incapacitated.EventTransition(GameHashes.IncapacitationRecovery, healthy).ToggleTag(GameTags.Incapacitated).ToggleRecurringChore((Instance smi) => new BeIncapacitatedChore(smi.master))
