...
public class OxygenBreather : KMonoBehaviour, ISim200ms
{
	...
	public float ConsumptionRate => (airConsumptionRate == null) ? 0f : airConsumptionRate.GetTotalValue();
	...
	protected override void OnSpawn()
	{
		...
		Tag tag = base.gameObject.PrefabID();
		bool flag = tag == BionicMinionConfig.ID;
	...
	public bool RemoveGasProvider(IGasProvider provider)
	{
		...
		{
			IGasProvider gasProvider = gasProviders[gasProviders.Count - 1];
