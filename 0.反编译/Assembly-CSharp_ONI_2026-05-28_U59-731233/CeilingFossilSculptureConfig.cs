...
public class CeilingFossilSculptureConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("CeilingFossilSculpture", 3, 2, "fossilsculpture_hanging_kanim", 100, 240f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.FOSSILS, 800f, BuildLocationRule.OnCeiling, DECOR.BONUS.TIER5, NOISE_POLLUTION.NONE);
	...
	{
		Artable artable = go.AddOrGet<LongRangeSculpture>();
		artable.requiredSkillPerk = Db.Get().SkillPerks.CanArtGreat.Id;
