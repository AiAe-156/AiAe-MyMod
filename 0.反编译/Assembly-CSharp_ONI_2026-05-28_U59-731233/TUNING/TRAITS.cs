...
public class TRAITS
{
	public class JOY_REACTIONS
	{
		...
		public static float MIN_REACTION_CHANCE = 1f / 12f;

		public static float MAX_REACTION_CHANCE = 5f / 24f;
	...
	public static readonly List<System.Action> TRAIT_CREATORS = new List<System.Action>
	{
		...
		TraitUtil.CreateAttributeEffectTrait("Ellie", DUPLICANTS.CONGENITALTRAITS.ELLIE.NAME, DUPLICANTS.CONGENITALTRAITS.ELLIE.DESC, "AirConsumptionRate", (0f - DUPLICANTSTATS.STANDARD.BaseStats.OXYGEN_USED_PER_SECOND) * 0.45f, "DecorExpectation", -5f),
		...
		TraitUtil.CreateAttributeEffectTrait("Minnow", DUPLICANTS.CONGENITALTRAITS.MINNOW.NAME, DUPLICANTS.CONGENITALTRAITS.MINNOW.DESC, new string[2] { "BreathMax", "ThermalConductivityBarrier" }, new float[2]
		{
			DUPLICANTSTATS.STANDARD.Breath.MINNOW_LUNG_CAPACITY_BONUS,
			0.008f
		}, positiveTrait: true, delegate(GameObject go)
		{
			if (go.TryGetComponent<MinionResume>(out var component) && !component.HasBeenGrantedSkill("Swimming"))
			{
				component.GrantSkill("Swimming");
				AmountInstance amountInstance = Db.Get().Amounts.Breath.Lookup(go);
				amountInstance?.SetValue(amountInstance.GetMax());
			}
			if (go.TryGetComponent<Effects>(out var component2))
			{
		...
		TraitUtil.CreateAttributeEffectTrait("BionicBug1", DUPLICANTS.TRAITS.BIONICBUG1.NAME, DUPLICANTS.TRAITS.BIONICBUG1.DESC, new string[2] { "Learning", "Strength" }, new float[2] { -3f, -3f }, positiveTrait: false),
		TraitUtil.CreateAttributeEffectTrait("BionicBug2", DUPLICANTS.TRAITS.BIONICBUG2.NAME, DUPLICANTS.TRAITS.BIONICBUG2.DESC, new string[2] { "Ranching", "Caring" }, new float[2] { -3f, -3f }, positiveTrait: false),
		TraitUtil.CreateAttributeEffectTrait("BionicBug3", DUPLICANTS.TRAITS.BIONICBUG3.NAME, DUPLICANTS.TRAITS.BIONICBUG3.DESC, new string[2] { "Digging", "Machinery" }, new float[2] { -3f, -3f }, positiveTrait: false),
		TraitUtil.CreateAttributeEffectTrait("BionicBug4", DUPLICANTS.TRAITS.BIONICBUG4.NAME, DUPLICANTS.TRAITS.BIONICBUG4.DESC, new string[2] { "Construction", "Art" }, new float[2] { -3f, -3f }, positiveTrait: false),
		TraitUtil.CreateAttributeEffectTrait("BionicBug5", DUPLICANTS.TRAITS.BIONICBUG5.NAME, DUPLICANTS.TRAITS.BIONICBUG5.DESC, new string[2] { "Athletics", "Botanist" }, new float[2] { -3f, -3f }, positiveTrait: false),
		TraitUtil.CreateAttributeEffectTrait("BionicBug6", DUPLICANTS.TRAITS.BIONICBUG6.NAME, DUPLICANTS.TRAITS.BIONICBUG6.DESC, new string[2] { "Cooking", "Botanist" }, new float[2] { -3f, -3f }, positiveTrait: false),
		TraitUtil.CreateAttributeEffectTrait("BionicBug7", DUPLICANTS.TRAITS.BIONICBUG7.NAME, DUPLICANTS.TRAITS.BIONICBUG7.DESC, new string[2] { "Caring", "Learning" }, new float[2] { -3f, -3f }, positiveTrait: false),
		...
		TraitUtil.CreateAttributeEffectTrait("MouthBreather", DUPLICANTS.TRAITS.MOUTHBREATHER.NAME, DUPLICANTS.TRAITS.MOUTHBREATHER.DESC, "AirConsumptionRate", DUPLICANTSTATS.STANDARD.BaseStats.OXYGEN_USED_PER_SECOND),
		TraitUtil.CreateAttributeEffectTrait("CalorieBurner", DUPLICANTS.TRAITS.CALORIEBURNER.NAME, DUPLICANTS.TRAITS.CALORIEBURNER.DESC, "CaloriesDelta", DUPLICANTSTATS.STANDARD.BaseStats.CALORIES_BURNED_PER_SECOND * 0.5f),
		TraitUtil.CreateAttributeEffectTrait("SmallBladder", DUPLICANTS.TRAITS.SMALLBLADDER.NAME, DUPLICANTS.TRAITS.SMALLBLADDER.DESC, "BladderDelta", DUPLICANTSTATS.STANDARD.BaseStats.BLADDER_INCREASE_PER_SECOND / 600f),
		...
		TraitUtil.CreateAttributeEffectTrait("DeeperDiversLungs", DUPLICANTS.TRAITS.DEEPERDIVERSLUNGS.NAME, DUPLICANTS.TRAITS.DEEPERDIVERSLUNGS.DESC, "AirConsumptionRate", (0f - DUPLICANTSTATS.STANDARD.BaseStats.OXYGEN_USED_PER_SECOND) * 0.5f),
		...
		TraitUtil.CreateAttributeEffectTrait("IrritableBowel", DUPLICANTS.TRAITS.IRRITABLEBOWEL.NAME, DUPLICANTS.TRAITS.IRRITABLEBOWEL.DESC, "ToiletEfficiency", (0f - DUPLICANTSTATS.STANDARD.BaseStats.TOILET_EFFICIENCY) * 0.5f),
		...
		TraitUtil.CreateAttributeEffectTrait("DiversLung", DUPLICANTS.TRAITS.DIVERSLUNG.NAME, DUPLICANTS.TRAITS.DIVERSLUNG.DESC, "AirConsumptionRate", (0f - DUPLICANTSTATS.STANDARD.BaseStats.OXYGEN_USED_PER_SECOND) * 0.25f, positiveTrait: true),
		...
		TraitUtil.CreateTrait("StressShocker", DUPLICANTS.TRAITS.STRESSSHOCKER.NAME, DUPLICANTS.TRAITS.STRESSSHOCKER.DESC, OnAddShocker, DlcManager.DLC3),
		...
		TraitUtil.CreateTrait("DataRainer", DUPLICANTS.TRAITS.DATARAINER.NAME, DUPLICANTS.TRAITS.DATARAINER.DESC, OnAddDataRainer, DlcManager.DLC3),
		TraitUtil.CreateTrait("RoboDancer", DUPLICANTS.TRAITS.ROBODANCER.NAME, DUPLICANTS.TRAITS.ROBODANCER.DESC, OnAddRoboDancer, DlcManager.DLC3),
	...
	private static void OnAddBanshee(GameObject go)
	{
		...
		StressBehaviourMonitor.Instance instance = new StressBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), (ChoreProvider chore_provider) => new StressEmoteChore(chore_provider, Db.Get().ChoreTypes.StressEmote, "anim_interrupt_banshee_kanim", new HashedString[1] { "interrupt_banshee" }, KAnim.PlayMode.Once, () => tierOneBehaviourStatusItem), (ChoreProvider chore_provider) => new BansheeChore(Db.Get().ChoreTypes.BansheeWail, chore_provider, notification), "anim_loco_banshee_60_kanim");
		instance.StartSM();
	}

	private static void OnAddShocker(GameObject go)
	{
		Notification notification = new Notification(DUPLICANTS.MODIFIERS.STRESSSHOCKER.NOTIFICATION_NAME, NotificationType.Bad, (List<Notification> notificationList, object data) => string.Concat(DUPLICANTS.MODIFIERS.STRESSSHOCKER.NOTIFICATION_TOOLTIP, notificationList.ReduceMessages(countNames: false)));
		StatusItem tierOneBehaviourStatusItem = new StatusItem("StressSignalShocker", DUPLICANTS.STATUSITEMS.STRESS_SIGNAL_STRESS_SHOCKER.NAME, DUPLICANTS.STATUSITEMS.STRESS_SIGNAL_STRESS_SHOCKER.TOOLTIP, "", StatusItem.IconType.Info, NotificationType.BadMinor, allow_multiples: false, OverlayModes.None.ID);
		StressBehaviourMonitor.Instance instance = new StressBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), (ChoreProvider chore_provider) => new StressEmoteChore(chore_provider, Db.Get().ChoreTypes.StressEmote, "anim_loco_stressshocker_kanim", new HashedString[1] { "interrupt_shocker" }, KAnim.PlayMode.Once, () => tierOneBehaviourStatusItem), (ChoreProvider chore_provider) => new StressShockChore(Db.Get().ChoreTypes.StressShock, chore_provider, notification), "anim_loco_stressshocker_kanim", 12f);
		instance.StartSM();
	}
	...
	private static void OnAddBalloonArtist(GameObject go)
	{
		...
		instance.StartSM();
		JoyBehaviourMonitor.Instance instance2 = new JoyBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), "anim_loco_happy_balloon_kanim", null, Db.Get().Expressions.Balloon);
		instance2.StartSM();
	}
	...
	private static void OnAddStickerBomber(GameObject go)
	{
		...
		instance.StartSM();
		JoyBehaviourMonitor.Instance instance2 = new JoyBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), "anim_loco_stickers_kanim", null, Db.Get().Expressions.Sticker);
		instance2.StartSM();
	}
	...
	{
		HappySinger.Instance instance = new HappySinger.Instance(go.GetComponent<KMonoBehaviour>());
		instance.StartSM();
		JoyBehaviourMonitor.Instance instance2 = new JoyBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), "anim_loco_singer_kanim", null, Db.Get().Expressions.Music);
		instance2.StartSM();
	}

	private static void OnAddDataRainer(GameObject go)
	{
		DataRainer.Instance instance = new DataRainer.Instance(go.GetComponent<KMonoBehaviour>());
		instance.StartSM();
		JoyBehaviourMonitor.Instance instance2 = new JoyBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), "anim_loco_productive_kanim", "anim_loco_walk_productive_kanim", Db.Get().Expressions.Happy);
		instance2.StartSM();
	}

	private static void OnAddRoboDancer(GameObject go)
	{
		RoboDancer.Instance instance = new RoboDancer.Instance(go.GetComponent<KMonoBehaviour>());
		instance.StartSM();
		JoyBehaviourMonitor.Instance instance2 = new JoyBehaviourMonitor.Instance(go.GetComponent<KMonoBehaviour>(), "anim_loco_run_robotdance_kanim", "anim_loco_walk_robotdance_kanim", Db.Get().Expressions.Happy);
		instance2.StartSM();
	}
}
