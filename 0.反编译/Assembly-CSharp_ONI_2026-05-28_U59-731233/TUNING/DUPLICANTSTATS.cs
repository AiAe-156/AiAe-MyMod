...
public class DUPLICANTSTATS
{
	...
	public class BASESTATS
	{
		...
		public float DECOR_EXPECTATION = 0f;

		public float FOOD_QUALITY_EXPECTATION = 0f;

		public float RECREATION_EXPECTATION = 2f;

		public float MAX_PROFESSION_DECOR_EXPECTATION = 75f;

		public float MAX_PROFESSION_FOOD_EXPECTATION = 0f;

		public int MAX_UNDERWATER_TRAVEL_COST = 8;

		public float TOILET_EFFICIENCY = 1f;

		public float ROOM_TEMPERATURE_PREFERENCE = 0f;
		...
		public float RADIATION_RESISTANCE = 0f;
	...
	public class TEMPERATURE
	{
		...
		public float GROUND_TRANSFER_SCALE = 0f;
	}
	...
	public class COMBAT
	{
		public class BASICWEAPON
		{
			...
			public AttackProperties.TargetType TARGET_TYPE = AttackProperties.TargetType.Single;

			public AttackProperties.DamageType DAMAGE_TYPE = AttackProperties.DamageType.Standard;

			public int MAX_HITS = 1;

			public float AREA_OF_EFFECT_RADIUS = 0f;
		}
