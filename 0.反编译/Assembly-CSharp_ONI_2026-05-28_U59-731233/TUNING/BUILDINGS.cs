...
public class BUILDINGS
{
	...
	public static List<PlanScreen.PlanInfo> PLANORDER = new List<PlanScreen.PlanInfo>
	{
		new PlanScreen.PlanInfo(new HashedString("Base"), hideIfNotResearched: false, new List<string>
		{
			...
			"MetalTile", "GlassTile", "StorageTile", "BunkerTile", "CarpetTile", "ExteriorWall", "GlassExteriorWall", "ExobaseHeadquarters", "Door", "WoodenDoor",
			"ManualPressureDoor", "InsulatedDoor", "PressureDoor", "BunkerDoor", "StorageLocker", "StorageLockerSmart", "LiquidReservoir", "GasReservoir", "ObjectDispenser", "TravelTube",
		...
		new PlanScreen.PlanInfo(new HashedString("Food"), hideIfNotResearched: false, new List<string>
		{
			...
			"CritterDropOff", "FishDeliveryPoint", "FishPickUp", "CreatureFeeder", "FishFeeder", "MilkFeeder", "EggIncubator", "EggCracker", "CreatureGroundTrap", "WaterTrap",
