...
public class WarpConduitSender : StateMachineComponent<WarpConduitSender.StatesInstance>, ISecondaryInput
{
	private class ConduitPort
	{
		...
		public bool IsOn()
		{
			...
			{
				return conduitConsumer.IsConnected && conduitConsumer.IsSatisfied && conduitConsumer.consumedLastTick;
			}
			return false;
		}
	...
	private void FindPartner()
	{
		...
		WarpConduitReceiver[] array = Object.FindObjectsByType<WarpConduitReceiver>(FindObjectsSortMode.None);
