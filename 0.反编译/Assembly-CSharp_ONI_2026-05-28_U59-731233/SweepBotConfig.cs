...
public class SweepBotConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreatePlacedEntity("SweepBot", name, desc, MASS, decor: TUNING.BUILDINGS.DECOR.NONE, anim: Assets.GetAnim("sweep_bot_kanim"), initialAnim: "idle_loop", sceneLayer: Grid.SceneLayer.Creatures, width: 1, height: 1);
		...
		DrinkMilkMonitor.Def def2 = gameObject.AddOrGetDef<DrinkMilkMonitor.Def>();
		def2.consumesMilk = false;
		...
		storage2.storageFXOffset = new Vector3(0f, 0.5f, 0f);
		MovingOrnamentReceptacle movingOrnamentReceptacle = gameObject.AddOrGet<MovingOrnamentReceptacle>();
		movingOrnamentReceptacle.AddDepositTag(GameTags.PedestalDisplayable);
	...
	public void OnSpawn(GameObject inst)
	{
		...
		MovingOrnamentReceptacle component = inst.GetComponent<MovingOrnamentReceptacle>();
