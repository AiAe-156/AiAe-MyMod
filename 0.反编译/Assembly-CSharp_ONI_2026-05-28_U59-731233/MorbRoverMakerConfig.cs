...
public class MorbRoverMakerConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("MorbRoverMaker", 5, 4, "gravitas_morb_tank_kanim", 250, 120f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, MATERIALS.REFINED_METALS, 3200f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER2, decor: BUILDINGS.DECOR.BONUS.TIER1);
		...
		buildingDef.InputConduitType = GERM_INTAKE_CONDUIT_TYPE;
		buildingDef.OutputConduitType = GERM_INTAKE_CONDUIT_TYPE;
