...
public class SuitFabricatorConfig : IBuildingConfig
{
	...
	private void ConfigureRecipes()
	{
		...
		ComplexRecipe complexRecipe = new ComplexRecipe(id2, array3, array4)
		{
			time = TUNING.EQUIPMENT.SUITS.ATMOSUIT_FABTIME,
		...
		JetSuitConfig.recipe = new ComplexRecipe(id3, array5, array6)
		{
			time = TUNING.EQUIPMENT.SUITS.ATMOSUIT_FABTIME,
		...
		ComplexRecipe complexRecipe2 = new ComplexRecipe(id4, array7, array8)
		{
			time = TUNING.EQUIPMENT.SUITS.ATMOSUIT_FABTIME,
		...
		if (DlcManager.FeatureRadiationEnabled())
		{
			...
			ComplexRecipe complexRecipe3 = new ComplexRecipe(id6, array11, array12)
			{
				time = TUNING.EQUIPMENT.SUITS.ATMOSUIT_FABTIME,
