...
public class ResearchCenter : Workable, ISim200ms, IResearchCenter
{
	...
	private static bool CanPreemptCB(Chore.Precondition.Context context)
	{
		...
		WorkerBase cmp = context.consumerState.worker;
		float num2 = Db.Get().AttributeConverters.ResearchSpeed.Lookup(cmp).Evaluate();
		return num2 > num && context.chore.gameObject.GetComponent<ResearchCenter>().GetPercentComplete() < 1f;
	}
	...
	protected override void OnStartWork(WorkerBase worker)
	{
		...
		component.AddStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, this);
	...
	protected override void OnStopWork(WorkerBase worker)
	{
		...
		KSelectable component = GetComponent<KSelectable>();
		component.RemoveStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, this);
