...
public class VirtualInputModule : PointerInputModule, IInputHandler
{
	...
	public bool mouseMovementOnly = false;
	...
	private Canvas m_virtualCursorCanvas = null;

	private CanvasScaler m_virtualCursorScaler = null;

	private PointerEventData leftClickData;

	private PointerEventData rightClickData;

	private ControllerButtonStates conButtonStates = default(ControllerButtonStates);

	private GameObject m_CurrentFocusedGameObject;

	private bool leftReleased = false;

	private bool rightReleased = false;

	private bool leftFirstClick = false;

	private bool rightFirstClick = false;
	...
	protected void ProcessControllerPress(MouseButtonEventData data, bool leftClick)
	{
		...
		if (rightFirstClick)
		{
			...
			{
				float num2 = unscaledTime2 - buttonData2.clickTime;
				if (num2 < 0.3f)
				{
