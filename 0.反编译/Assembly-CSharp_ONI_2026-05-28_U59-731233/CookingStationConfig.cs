...
public class CookingStationConfig : IBuildingConfig
{
	...
	private void ConfigureRecipes()
	{
		...
		CookedEggConfig.recipe = new ComplexRecipe(id4, array7, array8)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		CookedMeatConfig.recipe = new ComplexRecipe(id6, array11, array12)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
			description = STRINGS.ITEMS.FOOD.COOKEDMEAT.RECIPEDESC,
			nameDisplay = ComplexRecipe.RecipeNameDisplay.Result,
		...
		GrilledPrickleFruitConfig.recipe = new ComplexRecipe(id7, array13, array14)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		if (DlcManager.IsExpansion1Active())
		{
			...
			CookedEggConfig.recipe = new ComplexRecipe(id8, array15, array16)
			{
				time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		ColdWheatBreadConfig.recipe = new ComplexRecipe(id9, array17, array18)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		CookedEggConfig.recipe = new ComplexRecipe(id10, array19, array20)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		if (DlcManager.IsExpansion1Active())
		{
			...
			WormBasicFoodConfig.recipe = new ComplexRecipe(id11, array21, array22)
			{
				time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		if (DlcManager.IsExpansion1Active())
		{
			...
			string id12 = ComplexRecipeManager.MakeRecipeID("CookingStation", array23, array24);
			WormSuperFoodConfig.recipe = new ComplexRecipe(id12, array23, array24)
			{
				time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		string id13 = ComplexRecipeManager.MakeRecipeID("CookingStation", array25, array26);
		CookedPikeappleConfig.recipe = new ComplexRecipe(id13, array25, array26, DlcManager.DLC2)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		string id14 = ComplexRecipeManager.MakeRecipeID("CookingStation", array27, array28);
		ButterflyFoodConfig.recipe = new ComplexRecipe(id14, array27, array28, DlcManager.DLC4)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
