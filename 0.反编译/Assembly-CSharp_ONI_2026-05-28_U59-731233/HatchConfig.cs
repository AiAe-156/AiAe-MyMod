...
public class HatchConfig : IEntityConfig
{
	...
	public static GameObject CreateHatch(string id, string name, string desc, string anim_file, bool is_baby)
	{
		...
		prefab = BaseHatchConfig.SetupDiet(prefab, list, CALORIES_PER_KG_OF_ORE, MIN_POOP_SIZE_IN_KG);
	...
	public GameObject CreatePrefab()
	{
		...
		return EntityTemplates.ExtendEntityToFertileCreature(prefab, this as IHasDlcRestrictions, "HatchEgg", STRINGS.CREATURES.SPECIES.HATCH.EGG_NAME, STRINGS.CREATURES.SPECIES.HATCH.DESC, "egg_hatch_kanim", HatchTuning.EGG_MASS, "HatchBaby", 60.000004f, 20f, HatchTuning.EGG_CHANCES_BASE, EGG_SORT_ORDER);
	}
