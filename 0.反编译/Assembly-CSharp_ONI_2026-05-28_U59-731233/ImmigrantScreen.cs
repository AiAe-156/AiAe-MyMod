...
public class ImmigrantScreen : CharacterSelectionController
{
	...
	public void DebugShuffleOptionsInstant()
	{
		...
		{
			Object.Destroy(container.GetGameObject());
		}
		containers.Clear();
		InitializeContainers();
		foreach (ITelepadDeliverableContainer container2 in containers)
		{
			if (container2 is CharacterContainer characterContainer)
			{
