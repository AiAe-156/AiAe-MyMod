...
public class NoseconeHarvestConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("NoseconeHarvest", 5, 4, "rocket_nosecone_gathering_kanim", 1000, 60f, new float[2]
		{
			BUILDINGS.ROCKETRY_MASS_KG.NOSE_CONE_TIER2[0],
			4f
		}, new string[2] { "RefinedMetal", "BuildingGasket" }, 9999f, BuildLocationRule.Anywhere, noise: NOISE_POLLUTION.NOISY.TIER2, decor: BUILDINGS.DECOR.NONE);
