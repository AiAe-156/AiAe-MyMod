...
public class TubeWormConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(plant, this, SeedProducer.ProductionType.Harvest, "TubeWormSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 21, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f);
		EntityTemplates.CreateAndRegisterPreviewForPlant(seed, "TubeWorm_preview", Assets.GetAnim("tube_worm_kanim"), "place", 1, 2);
		return gameObject;
	}
