...
public class ScannerModuleConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("ScannerModule", 5, 5, "rocket_scanner_module_kanim", 1000, 120f, new float[2] { 350f, 1000f }, new string[2]
		{
