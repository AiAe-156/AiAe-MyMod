...
public class ReportManager : KMonoBehaviour
{
	...
	public class ReportEntry
	{
		...
		public ReportEntry FindEntryFromGameObject(GameObject contextGameObject)
		{
			...
			KPrefabID component;
			return contextGameObject.TryGetComponent<KPrefabID>(out component) ? FindEntryFromPrefabInstance(component) : FindEntry(contextGameObject.GetProperName());
		}
	...
	public class DailyReport
	{
		...
		{
			ReportEntry entry = GetEntry(reportType);
			entry.AddDataWithPrefabInstanceContext(noteStorage, value, context, note);
		}

		public void AddDataWithGameObjectContext(ReportType reportType, float value, GameObject context, string note = null)
		{
			ReportEntry entry = GetEntry(reportType);
			entry.AddDataWithGameObjectContext(noteStorage, value, context, note);
		}
	}
