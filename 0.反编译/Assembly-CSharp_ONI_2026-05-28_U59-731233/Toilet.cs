...
public class Toilet : StateMachineComponent<Toilet.StatesInstance>, ISaveLoadable, IUsable, IGameObjectEffectDescriptor, IBasicBuilding
{
	...
	public class StatesInstance : GameStateMachine<States, StatesInstance, Toilet, object>.GameInstance
	{
		...
		public bool RequiresDirtDelivery()
		{
			...
			float amountAvailable = base.master.storage.GetAmountAvailable(GameTags.Dirt);
	...
	public class States : GameStateMachine<States, StatesInstance, Toilet>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			}).Exit(delegate(StatesInstance smi)
			{
				...
				.ToggleMainStatusItem((StatesInstance smi) => smi.sm.cloggedWithGunk.Get(smi) ? Db.Get().BuildingStatusItems.UnusableGunked : Db.Get().BuildingStatusItems.Unusable)
		...
		{
			return smi.sm.cloggedWithGunk.Get(smi) ? "full_gunk_pst" : "full_pst";
		}
	...
	public void FlushMultiple(WorkerBase worker, int flushCount)
	{
		...
		GameObject gameObject = element.substance.SpawnResource(base.transform.GetPosition(), mass, solidWasteTemperature, index, num2, prevent_merge: true);
		...
		component2.AddDisease(index, num3, "Toilet.Flush");
