...
public class SpaceArtifact : KMonoBehaviour, IGameObjectEffectDescriptor
{
	...
	{
		DecorProvider component = GetComponent<DecorProvider>();
		component.SetValues(DECOR.BONUS.TIER0);
	}

	private void SetAnalyzedDecor()
	{
		DecorProvider component = GetComponent<DecorProvider>();
		component.SetValues(artifactTier.decorValues);
	}
	...
	private void UpdateAnim()
	{
		...
		component.Play(text, KAnim.PlayMode.Loop);
	}
