...
public class ResetSkillsStation : Workable
{
	...
	protected override void OnStartWork(WorkerBase worker)
	{
		...
		component.AddStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorTraining, this);
	}
	...
	protected override void OnStopWork(WorkerBase worker)
	{
		...
		KSelectable component = GetComponent<KSelectable>();
		component.RemoveStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorTraining, this);
		chore = null;
	}
}
