...
public class RaptorConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject prefab = CreateRaptor("Raptor", STRINGS.CREATURES.SPECIES.RAPTOR.NAME, STRINGS.CREATURES.SPECIES.RAPTOR.DESC, "raptor_kanim", is_baby: false);
		prefab = EntityTemplates.ExtendEntityToFertileCreature(prefab, this, "RaptorEgg", STRINGS.CREATURES.SPECIES.RAPTOR.EGG_NAME, STRINGS.CREATURES.SPECIES.RAPTOR.DESC, "egg_raptor_kanim", 8f, "RaptorBaby", 120.00001f, 40f, RaptorTuning.EGG_CHANCES_BASE, EGG_SORT_ORDER);
