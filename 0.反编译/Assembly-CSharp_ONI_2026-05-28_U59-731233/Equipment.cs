...
public class Equipment : Assignables
{
	...
	public void Unequip(Equippable equippable)
	{
		...
		{
			float num = GameClock.Instance.GetTimeInCycles() - component.TimeEquipped;
			float num2 = num * EQUIPMENT.SUITS.SUIT_DURABILITY_SKILL_BONUS;
			component.TimeEquipped += num2;
		}
