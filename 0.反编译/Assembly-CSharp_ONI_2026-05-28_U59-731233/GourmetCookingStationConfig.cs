...
public class GourmetCookingStationConfig : IBuildingConfig
{
	...
	private void ConfigureRecipes()
	{
		...
		SpicyTofuConfig.recipe = new ComplexRecipe(id6, array11, array12)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		QuicheConfig.recipe = new ComplexRecipe(id7, array13, array14)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		string id8 = ComplexRecipeManager.MakeRecipeID("GourmetCookingStation", array15, array16);
		BurgerConfig.recipe = new ComplexRecipe(id8, array15, array16)
		{
			time = FOOD.RECIPES.STANDARD_COOK_TIME,
		...
		if (DlcManager.IsExpansion1Active())
		{
			...
			string id9 = ComplexRecipeManager.MakeRecipeID("GourmetCookingStation", array17, array18);
			BerryPieConfig.recipe = new ComplexRecipe(id9, array17, array18)
			{
				time = FOOD.RECIPES.STANDARD_COOK_TIME,
