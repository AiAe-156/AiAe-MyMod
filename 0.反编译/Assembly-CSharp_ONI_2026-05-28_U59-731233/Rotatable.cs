...
public class Rotatable : KMonoBehaviour, ISaveLoadable
{
	...
	private void OrientVisualizer(Orientation orientation)
	{
		...
		Trigger(-1643076535, (object)this);
	}
	...
	private void OrientCollider(Orientation orientation)
	{
		...
		if (!(component == null))
		{
			...
			if (num2 != 0f)
			{
				...
				Matrix2x3 matrix2x2 = Matrix2x3.Rotate(num2 * (MathF.PI / 180f));
				Matrix2x3 matrix2x3 = Matrix2x3.Translate(pivot + new Vector3(num, 0f, 0f));
