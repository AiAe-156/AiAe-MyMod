...
public class PlantablePlot : SingleEntityReceptacle, ISaveLoadable
{
	...
	private void RegisterWithPlant(GameObject plant)
	{
		...
		bool irrigate = def != null && def.consumedElements != null && def.consumedElements.Length != 0;
		ApplyRequireInputs(irrigate);
		...
		plant.Trigger(1309017699, (object)storage);
	}
	...
	protected override void SubscribeToOccupant()
	{
		...
		if (base.occupyingObject != null)
		{
			onOccupantUprootedHandle = Subscribe(base.occupyingObject, -216549700, OnOccupantUprootedDispatcher, this);
		}
	}
	...
	protected override void UnsubscribeFromOccupant()
	{
		...
		if (base.occupyingObject != null)
		{
			Unsubscribe(base.occupyingObject, ref onOccupantUprootedHandle);
		}
	}
	...
	private void ClearRequireInputs()
	{
		...
		{
			requireInputs.RequiresInputConduit = false;
		}
	}
	...
	private void ApplyRequireInputs(bool irrigate)
	{
		if (requireInputs != null)
		{
			requireInputs.RequiresInputConduit = irrigate && AcceptsIrrigation;
		}
	}
	...
	public override void SetPreview(Tag entityTag, bool solid = false)
	{
		...
		if (rotatable != null)
		{
			...
			{
				gameObject.transform.SetLocalPosition(Rotatable.GetRotatedOffset(vector, Orientation.R90));
			}
			else
			{
				gameObject.transform.SetLocalPosition(Rotatable.GetRotatedOffset(vector, Orientation.R180));
			}
		}
		else
		{
