...
public class AgeMonitor : GameStateMachine<AgeMonitor, AgeMonitor.Instance, IStateMachineTarget, AgeMonitor.Def>
{
	...
	{
		public float minAgePercentOnSpawn = 0f;
	...
	public new class Instance : GameInstance
	{
		...
		public bool IsElderly => age.value > age.GetMax() * 0.9f;
		...
		{
			age.value = Mathf.Lerp(age.GetMax() * base.def.minAgePercentOnSpawn, age.GetMax() * base.def.maxAgePercentOnSpawn, UnityEngine.Random.value);
