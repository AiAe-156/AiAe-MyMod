...
public class MushroomConfig : IEntityConfig
{
	...
	{
		GameObject template = EntityTemplates.CreateLooseEntity(ID, STRINGS.ITEMS.FOOD.MUSHROOM.NAME, STRINGS.ITEMS.FOOD.MUSHROOM.DESC, 1f, unitMass: false, Assets.GetAnim("funguscap_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.77f, 0.48f, isPickupable: true);
