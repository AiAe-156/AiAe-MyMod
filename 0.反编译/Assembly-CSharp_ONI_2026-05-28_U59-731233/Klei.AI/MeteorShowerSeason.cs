...
public class MeteorShowerSeason : GameplaySeason
{
	...
	{
		MeteorShowerEvent.StatesInstance statesInstance = generic_smi as MeteorShowerEvent.StatesInstance;
		statesInstance.clusterTravelDuration = clusterTravelDuration;
	}
