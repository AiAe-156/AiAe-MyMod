...
public class PeriodicEmoteSickness : Sickness.SicknessComponent
{
	public class StatesInstance : GameStateMachine<States, StatesInstance, SicknessInstance, object>.GameInstance
	{
		...
		{
			SelfEmoteReactable selfEmoteReactable = new SelfEmoteReactable(base.master.gameObject, "PeriodicEmoteSickness", Db.Get().ChoreTypes.Emote, 0f, periodicEmoteSickness.cooldown);
			return selfEmoteReactable.SetEmote(periodicEmoteSickness.emote);
		}
	}
