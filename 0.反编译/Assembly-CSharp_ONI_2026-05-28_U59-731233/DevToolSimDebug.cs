...
public class DevToolSimDebug : DevTool
{
	...
	private bool showAccessRestrictions = false;

	private bool showGridContents = false;

	private bool showScenePartitionerContents = false;

	private bool showLayerToggles = false;

	private bool showCavityInfo = false;

	private bool showPropertyInfo = false;

	private bool showBuildings = false;

	private bool showCreatures = false;

	private bool showPhysicsData = false;

	private bool showGasConduitData = false;

	private bool showLiquidConduitData = false;

	private string[] overlayModes = null;

	private int selectedOverlayMode = 0;

	private string[] gameGridModes = null;
