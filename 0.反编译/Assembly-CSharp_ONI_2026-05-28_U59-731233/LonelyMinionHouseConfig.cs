...
public class LonelyMinionHouseConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("LonelyMinionHouse", 4, 6, "lonely_dupe_home_kanim", 1000, 480f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, new string[1] { SimHashes.Steel.ToString() }, 9999f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, decor: HOUSE_DECOR);
