...
public class DevToolAccessControl : DevTool
{
	...
	private AccessControl selectedAccessControl = null;
	...
	private bool Init()
	{
		...
		{
			initialized = true;
			List<Tag> list = (from e in Assets.GetPrefabsWithTag(GameTags.BaseMinion)
	...
	{
		return SelectTool.Instance != null && SelectTool.Instance.selected != null && SetDoorAccessControl() != null;
	}
