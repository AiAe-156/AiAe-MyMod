...
public class FrontEndManager : KMonoBehaviour
{
	...
	protected override void OnPrefabInit()
	{
		...
		GameObject original = (DlcManager.IsExpansion1Active() ? ScreenPrefabs.Instance.MainMenuForSpacedOut : ScreenPrefabs.Instance.MainMenuForVanilla);
		Util.KInstantiateUI(original, parent, force_active: true);
		...
		if (firstInit)
		{
			...
			{
				Util.KInstantiateUI(original2, parent, force_active: true);
			}
		...
		{
			int num = 30;
			GameObject[] array3 = screensPrefabsToSpawn;
