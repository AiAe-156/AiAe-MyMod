...
public class ScannerModule : GameStateMachine<ScannerModule, ScannerModule.Instance, IStateMachineTarget, ScannerModule.Def>
{
	...
	public new class Instance : GameInstance
	{
		...
		public void Scan()
		{
			...
			List<ClusterGridEntity> notVisibleEntitiesAtAdjacentCell = ClusterGrid.Instance.GetNotVisibleEntitiesAtAdjacentCell(location);
			foreach (ClusterGridEntity item in notVisibleEntitiesAtAdjacentCell)
			{
