...
public class DestinationAsteroid2 : KMonoBehaviour
{
	...
	public void SetAsteroid(ColonyDestinationAsteroidBeltData newAsteroidData)
	{
		...
		string text = (getStartWorld.asteroidIcon.IsNullOrWhiteSpace() ? AsteroidGridEntity.DEFAULT_ASTEROID_ICON_ANIM : getStartWorld.asteroidIcon);
		Assets.TryGetAnim(text, out var anim);
		if (anim != null)
		{
