...
public class DewDripperPlantConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, this, SeedProducer.ProductionType.Harvest, "DewDripperPlantSeed", name2, desc2, anim2, "object", 1, additionalTags2, SingleEntityReceptacle.ReceptacleDirection.Bottom, default(Tag), 5, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f);
		GameObject template = EntityTemplates.CreateAndRegisterPreviewForPlant(seed, "DewDripperPlant_preview", Assets.GetAnim("brackwood_kanim"), "place", 1, 2);
