...
public class PlanBuildingToggle : KToggle
{
	...
	private bool researchComplete = false;
	...
	private StringEntry subcategoryName = null;
	...
	{
		bool flag = false;
		return (researchComplete || DebugHandler.InstantBuildMode || Game.Instance.SandboxModeActive) && (planScreen.ActiveCategoryToggleInfo == null || buildingCategory == (HashedString)planScreen.ActiveCategoryToggleInfo.userData);
	}
