...
public class CreaturePathFinderAbilities : PathFinderAbilities
{
	...
	{
		CreaturePathFinderAbilities creaturePathFinderAbilities = new CreaturePathFinderAbilities(navigator);
		creaturePathFinderAbilities.prefabInstanceID = prefabInstanceID;
		creaturePathFinderAbilities.canTraverseSubmered = canTraverseSubmered;
		return creaturePathFinderAbilities;
	}
