...
public class OxyCoralConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public const float MAX_LUX = 900f;

	public const float MIN_LUX_REQUIRED = 180f;
	...
	public GameObject CreatePrefab()
	{
		...
		template = EntityTemplates.ExtendEntityToBasicPlant(template, 253.15f, 298.15f, 318.15f, 373.15f, new SimHashes[4]
		{
			SimHashes.Water,
			SimHashes.SaltWater,
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(plant, this, SeedProducer.ProductionType.Hidden, "OxyCoralSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 20, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f);
		EntityTemplates.CreateAndRegisterPreviewForPlant(seed, "OxyCoral_preview", Assets.GetAnim("thalassaire_coral_kanim"), "place", 3, 2);
