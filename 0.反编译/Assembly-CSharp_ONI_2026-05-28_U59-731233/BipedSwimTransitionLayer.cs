...
public class BipedSwimTransitionLayer : TransitionDriver.OverrideLayer
{
	...
	public override void BeginTransition(Navigator navigator, Navigator.ActiveTransition transition)
	{
		...
		bool flag2 = transition.start == NavType.Swim && transition.end == NavType.Swim;
		bool flag3 = transition.x != 0 && transition.y != 0;
		bool flag4 = transition.x != 0 && transition.y == 0;
	...
	private static bool IsSurfaceSwimCell(int cell)
	{
		...
		return Grid.IsWorldValidCell(cell2) && !Grid.IsLiquid(cell2);
	}
