...
public class SingleItemSelectionSideScreen : SingleItemSelectionSideScreenBase
{
	...
	private StorageTile.Instance CurrentTarget = null;
	...
	{
		return (CurrentTarget == null) ? INVALID_OPTION_TAG : CurrentTarget.TargetTag;
	}
	...
	public override void SetTarget(GameObject target)
	{
		...
		HashSet<Tag> hashSet = new HashSet<Tag>(CurrentTarget.GetComponent<Storage>().storageFilters);
		...
		if (targetCurrentSelectedTag != INVALID_OPTION_TAG)
		{
			...
			Category categoryWithItem = GetCategoryWithItem(targetCurrentSelectedTag);
			categoryWithItem.SetUnfoldedState(Category.UnfoldedStates.Unfolded);
		}
		else
		{
