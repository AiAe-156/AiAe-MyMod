...
public class PauseScreen : KModalButtonMenu
{
	...
	private void ConfirmDecision(string questionText, string primaryButtonText, System.Action primaryButtonAction, string alternateButtonText = null, System.Action alternateButtonAction = null)
	{
		base.gameObject.SetActive(value: false);
		ConfirmDialogScreen confirmDialogScreen = (ConfirmDialogScreen)GameScreenManager.Instance.StartScreen(ScreenPrefabs.Instance.ConfirmDialogScreen.gameObject, base.transform.parent.gameObject);
		confirmDialogScreen.PopupConfirmDialog(questionText, primaryButtonAction, OnCancelPopup, alternateButtonText, alternateButtonAction, null, primaryButtonText);
	}
