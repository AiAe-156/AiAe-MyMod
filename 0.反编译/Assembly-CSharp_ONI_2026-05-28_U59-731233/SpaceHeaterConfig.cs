...
public class SpaceHeaterConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		KBatchedAnimHeatPostProcessingEffect kBatchedAnimHeatPostProcessingEffect = go.AddOrGet<KBatchedAnimHeatPostProcessingEffect>();
		...
		ColdImmunityProvider.Def def2 = go.AddOrGetDef<ColdImmunityProvider.Def>();
		def2.range = new CellOffset[2][]
		{
			new CellOffset[2]
			{
				new CellOffset(-1, 0),
