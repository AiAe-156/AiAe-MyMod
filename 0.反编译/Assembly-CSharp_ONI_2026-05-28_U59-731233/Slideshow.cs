...
public class Slideshow : KMonoBehaviour
{
	...
	private void Update()
	{
		if ((updateType != SlideshowUpdateType.preloadedSprites || (sprites != null && sprites.Length != 0)) && (updateType != SlideshowUpdateType.loadOnDemand || (files != null && files.Length != 0)) && !paused)
		{
