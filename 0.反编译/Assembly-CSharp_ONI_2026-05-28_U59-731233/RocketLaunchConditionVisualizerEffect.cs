...
public class RocketLaunchConditionVisualizerEffect : VisualizerEffect
{
	...
	protected override void OnPostRender()
	{
		...
		{
			RocketLaunchConditionVisualizer.RocketModuleVisualizeData moduleData = rocketLaunchConditionVisualizer.moduleVisualizeData[k];
			ComputeVisibility(moduleData, pixelData, world_min, world_max);
		}
