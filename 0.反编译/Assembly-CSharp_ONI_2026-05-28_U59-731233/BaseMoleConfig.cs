...
public static class BaseMoleConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreatePlacedEntity(id, name, desc, 25f, decor: TUNING.BUILDINGS.DECOR.NONE, anim: Assets.GetAnim(is_baby ? anim_file : "driller_build_kanim"), initialAnim: "idle_loop", sceneLayer: Grid.SceneLayer.Creatures, width: 1, height: 1);
		EntityTemplates.ExtendEntityToBasicCreature(isWarmBlooded: false, gameObject, anim_file, is_baby ? null : "driller_build_kanim", symbolOverridePrefix, FactionManager.FactionID.Pest, traitId, "DiggerNavGrid", NavType.Floor, 32, 2f, "Meat", on_death_drop_count, drownVulnerable: true, entombVulnerable: false, warningLowTemperature, warningHighTemperature, lethalLowTemperature, lethalHighTemperature);
