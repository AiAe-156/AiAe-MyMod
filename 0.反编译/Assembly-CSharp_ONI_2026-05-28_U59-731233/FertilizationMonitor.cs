...
public class FertilizationMonitor : GameStateMachine<FertilizationMonitor, FertilizationMonitor.Instance, IStateMachineTarget, FertilizationMonitor.Def>
{
	...
	public new class Instance : GameInstance, IWiltCause
	{
		...
		public string WiltStateString => base.smi.IsInsideState(base.smi.sm.replanted.starved) ? GetStarvedStatusItem().resolveStringCallback(CREATURES.STATUSITEMS.NEEDSFERTILIZER.NAME, this) : "";
		...
		public virtual bool AcceptsFertilizer()
		{
			...
			return base.sm.fertilizerStorage.Get(this).TryGetComponent<PlantablePlot>(out component) && component.AcceptsFertilizer;
		}
