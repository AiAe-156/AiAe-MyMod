...
public class ColdBreatherConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, dlcRestrictions, SeedProducer.ProductionType.Hidden, "ColdBreatherSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 21, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f);
	...
	public void OnPrefabInit(GameObject inst)
	{
		...
		entityCellVisualizer.AddPort(EntityCellVisualizer.Ports.HeatSink, default(CellOffset));
	}
