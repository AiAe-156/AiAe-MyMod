...
public class LargeImpactorStatus : GameStateMachine<LargeImpactorStatus, LargeImpactorStatus.Instance, IStateMachineTarget, LargeImpactorStatus.Def>
{
	...
	public new class Instance : GameInstance
	{
		...
		public float ArrivalTime => (clusterTraveler == null) ? ArrivalTime_Vanilla : ArrivalTime_SO;

		public float TimeRemainingBeforeCollision => (clusterTraveler == null) ? TimeRemainingBeforeCollision_Vanilla : TimeRemainingBeforeCollision_SO;
