...
public class WarpConduitReceiver : StateMachineComponent<WarpConduitReceiver.StatesInstance>, ISecondaryOutput
{
	public struct ConduitPort
	{
		...
		public bool IsOn()
		{
			...
			if (dispenser != null)
			{
				return !dispenser.blocked && !dispenser.empty;
			}
			return false;
		}
	...
	protected override void OnSpawn()
	{
		base.OnSpawn();
		FindPartner();
		if (solidPort.solidDispenser != null)
		{
			solidPort.solidDispenser.solidOnly = true;
		}
		base.smi.StartSM();
	}
	...
	private void FindPartner()
	{
		...
		WarpConduitSender[] array = Object.FindObjectsByType<WarpConduitSender>(FindObjectsSortMode.None);
