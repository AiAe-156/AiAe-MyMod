...
public class SearchBar : KMonoBehaviour
{
	...
	public Action<string> ValueChanged = null;

	public Action<bool> EditingStateChanged = null;

	public System.Action Focused = null;

	public string CurrentSearchValue => string.IsNullOrEmpty(inputField.text) ? "" : inputField.text;
