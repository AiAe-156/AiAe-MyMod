...
public class RocketInteriorGasOutputPortConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("RocketInteriorGasOutputPort", 1, 1, "rocket_interior_port_gas_out_kanim", 100, 30f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER2, MATERIALS.REFINED_METALS, 9999f, BuildLocationRule.Tile, noise: NOISE_POLLUTION.NONE, decor: BUILDINGS.DECOR.BONUS.TIER0);
	...
	private void AttachPort(GameObject go)
	{
		...
		conduitSecondaryOutput.portInfo = gasOutputPort;
	}
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		rocketConduitReceiver.conduitPortInfo = gasOutputPort;
	}
