...
public class BuildingDamageSoundEvent : SoundEvent
{
	...
	public override void PlaySound(AnimEventManager.EventPlayerData behaviour)
	{
		...
		if (component2 != null)
		{
			...
			string text2 = StringFormatter.Combine(base.name, "_", def.AudioCategory);
			string text3 = GlobalAssets.GetSound(text2);
			if (text3 == null)
			{
				text2 = "Building_Dmg_Metal";
				text3 = GlobalAssets.GetSound(text2);
			}
			...
			{
				SoundEvent.PlayOneShot(text3, sound_pos, SoundEvent.GetVolume(base.objectIsSelectedAndVisible));
			}
		}
	}
}
