...
public class StatusItemStackTraceWatcher : IDisposable
{
	public class StatusItemStackTraceWatcher_OnDestroyListenerMB : MonoBehaviour
	{
		...
		private void OnDestroy()
		{
			...
			bool flag2 = owner.currentTarget.IsSome() && owner.currentTarget.Unwrap().gameObject == base.gameObject;
			if (flag && flag2)
			{
	...
	private Option<StatusItemGroup> currentTarget = default(Option<StatusItemGroup>);

	private bool shouldWatch = false;

	private System.Action onCleanup = null;
