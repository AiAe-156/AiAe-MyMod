...
public class DevToolFuzzy : DevTool
{
	...
	protected override void RenderTo(DevPanel panel)
	{
		...
		bool flag = ImGui.DragInt("Score Threshold", ref scoreThreshold, 0.5f, 0, 100);
	...
	private void Refresh()
	{
		...
		if (techs.Count == 0)
		{
			Dictionary<string, SearchUtil.TechCache> dictionary = SearchUtil.CacheTechs();
			foreach (KeyValuePair<string, SearchUtil.TechCache> item in dictionary)
			{
