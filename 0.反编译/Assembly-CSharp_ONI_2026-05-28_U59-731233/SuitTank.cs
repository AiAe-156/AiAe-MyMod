...
public class SuitTank : KMonoBehaviour, IGameObjectEffectDescriptor, OxygenBreather.IGasProvider
{
	...
	private void OnEquipped(object data)
	{
		...
		if (component != null)
		{
			Sensors component2 = component.GetComponent<Sensors>();
			SafeCellSensor sensor = component2.GetSensor<SafeCellSensor>();
			sensor.AddIgnoredFlagsSet("SuitTank", SafeCellFlagsToIgnoreOnEquipped);
	...
	private void OnUnequipped(object data)
	{
		...
		if (!equipment.destroyed)
		{
			...
			if (component != null)
			{
				Sensors component2 = component.GetComponent<Sensors>();
				SafeCellSensor sensor = component2.GetSensor<SafeCellSensor>();
				sensor.RemoveIgnoredFlagsSet("SuitTank");
