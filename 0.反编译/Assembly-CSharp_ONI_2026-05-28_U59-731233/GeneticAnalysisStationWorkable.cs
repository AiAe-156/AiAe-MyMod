...
public class GeneticAnalysisStationWorkable : Workable
{
	...
	protected override void OnStartWork(WorkerBase worker)
	{
		...
		component.AddStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, storage.FindFirst(GameTags.UnidentifiedSeed));
	}
	...
	protected override void OnStopWork(WorkerBase worker)
	{
		...
		KSelectable component = GetComponent<KSelectable>();
		component.RemoveStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching);
	}
	...
	public void IdentifyMutant()
	{
		...
		if (gameObject != null)
		{
			...
			Pickupable pickupable = ((!(component.PrimaryElement.Units > 1f)) ? storage.Drop(gameObject).GetComponent<Pickupable>() : component.TakeUnit(1f));
