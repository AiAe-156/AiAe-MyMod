...
public class NoseconeBasicConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("NoseconeBasic", 5, 2, "rocket_nosecone_default_kanim", 1000, 60f, BUILDINGS.ROCKETRY_MASS_KG.NOSE_CONE_TIER2, new string[2] { "RefinedMetal", "Insulator" }, 9999f, BuildLocationRule.Anywhere, noise: NOISE_POLLUTION.NOISY.TIER2, decor: BUILDINGS.DECOR.NONE);
