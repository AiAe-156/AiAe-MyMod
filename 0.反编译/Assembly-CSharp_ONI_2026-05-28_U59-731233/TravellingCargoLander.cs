...
public class TravellingCargoLander : GameStateMachine<TravellingCargoLander, TravellingCargoLander.StatesInstance, IStateMachineTarget, TravellingCargoLander.Def>
{
	public class Def : BaseDef
	{
		...
		public bool deployOnLanding = false;
	}
	...
	public class StatesInstance : GameInstance
	{
		...
		public void StartLand()
		{
			...
			int randomSurfaceCell = ClusterManager.Instance.GetRandomSurfaceCell(world.id, base.def.landerWidth);
			Vector3 position = Grid.CellToPosCBC(randomSurfaceCell, animController.sceneLayer);
