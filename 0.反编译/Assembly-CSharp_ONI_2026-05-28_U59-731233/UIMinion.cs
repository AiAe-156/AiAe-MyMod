...
public class UIMinion : KMonoBehaviour, UIMinionOrMannequin.ITarget
{
	...
	private UIMinionOrMannequinReactSource lastReactSource = UIMinionOrMannequinReactSource.None;
	...
	public void SetMinion(Personality personality)
	{
		...
		minionVoiceProviderMB.voice = MinionVoice.ByPersonality(personality);
	}
