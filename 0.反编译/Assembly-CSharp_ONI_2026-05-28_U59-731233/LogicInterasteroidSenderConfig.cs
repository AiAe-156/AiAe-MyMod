...
public class LogicInterasteroidSenderConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		UserNameable userNameable = go.AddOrGet<UserNameable>();
		userNameable.savedName = STRINGS.BUILDINGS.PREFABS.LOGICINTERASTEROIDSENDER.DEFAULTNAME;
		LogicBroadcaster logicBroadcaster = go.AddOrGet<LogicBroadcaster>();
		logicBroadcaster.PORT_ID = "InputPort";
	}
