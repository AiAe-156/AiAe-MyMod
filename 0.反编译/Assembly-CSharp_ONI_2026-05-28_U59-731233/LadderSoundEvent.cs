...
public class LadderSoundEvent : SoundEvent
{
	...
	public override void PlaySound(AnimEventManager.EventPlayerData behaviour)
	{
		...
		if (buildingDef != null)
		{
			string text = ((buildingDef.PrefabID == "LadderFast") ? StringFormatter.Combine(base.name, "_Plastic") : base.name);
			string text2 = GlobalAssets.GetSound(text);
			if (text2 != null)
			{
				SoundEvent.PlayOneShot(text2, vector, volume);
			}
		}
	}
}
