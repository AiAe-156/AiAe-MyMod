...
public class SpiceNutConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreateLooseEntity(ID, STRINGS.ITEMS.FOOD.SPICENUT.NAME, STRINGS.ITEMS.FOOD.SPICENUT.DESC, 1f, unitMass: false, Assets.GetAnim("spicenut_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f, isPickupable: true);
