...
public class InhaleStates : GameStateMachine<InhaleStates, InhaleStates.Instance, IStateMachineTarget, InhaleStates.Def>
{
	public class Def : BaseDef
	{
		...
		public bool alwaysPlayPstAnim = false;
	...
	public new class Instance : GameInstance
	{
		...
		public void ComputeInhaleAmounts()
		{
			...
			if (dietInfo != null)
			{
				...
				float num5 = num * num4;
				float num6 = num5 + 0.8f * sMI.calories.GetMax() * num3 * num3 * num3;
				float num7 = num6 / num4;
				if (num7 > 5f * num)
				{
					inhaleTime = 5f * num;
					consumptionMult = num6 / (inhaleTime * num4);
				}
				else
				{
					inhaleTime = num7;
