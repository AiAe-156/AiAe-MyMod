...
public class Chlorinator : GameStateMachine<Chlorinator, Chlorinator.StatesInstance, IStateMachineTarget, Chlorinator.Def>
{
	...
	public class StatesInstance : GameInstance
	{
		...
		public MeterController hopperMeter = null;
		...
		private void TryEmit(int oreSpawnCount, Tag emitTag, float amount)
		{
			...
			float num = amount_consumed * component.MassPerUnit;
			float mass = num / (float)oreSpawnCount;
			...
			{
				float num2 = base.def.initialDirectionHalfAngleDegreesRange.Get();
