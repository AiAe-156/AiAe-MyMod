	...
	protected override void DefinePorts()
	{
		...
		foreach (ISecondaryInput secondaryInput in array)
		{
			if (secondaryInput != null)
			{
				...
				{
					BuildingCellVisualizerResources.ConnectedDisconnectedColours connectedDisconnectedColours2 = (def.CheckRequiresLiquidInput() ? base.Resources.alternateIOColours.input : base.Resources.liquidIOColours.input);
				...
				{
					BuildingCellVisualizerResources.ConnectedDisconnectedColours connectedDisconnectedColours3 = (def.CheckRequiresSolidInput() ? base.Resources.alternateIOColours.input : base.Resources.liquidIOColours.input);
		...
		foreach (ISecondaryOutput secondaryOutput in array2)
		{
			if (secondaryOutput != null)
			{
				...
				{
					BuildingCellVisualizerResources.ConnectedDisconnectedColours connectedDisconnectedColours4 = (def.CheckRequiresGasOutput() ? base.Resources.alternateIOColours.output : base.Resources.gasIOColours.output);
					AddPort(Ports.GasOut, secondaryOutput.GetSecondaryConduitOffset(ConduitType.Gas), connectedDisconnectedColours4.connected, connectedDisconnectedColours4.disconnected);
				}
				if (secondaryOutput.HasSecondaryConduitType(ConduitType.Liquid))
				{
					BuildingCellVisualizerResources.ConnectedDisconnectedColours connectedDisconnectedColours5 = (def.CheckRequiresLiquidOutput() ? base.Resources.alternateIOColours.output : base.Resources.liquidIOColours.output);
					AddPort(Ports.LiquidOut, secondaryOutput.GetSecondaryConduitOffset(ConduitType.Liquid), connectedDisconnectedColours5.connected, connectedDisconnectedColours5.disconnected);
				}
				if (secondaryOutput.HasSecondaryConduitType(ConduitType.Solid))
				{
					BuildingCellVisualizerResources.ConnectedDisconnectedColours connectedDisconnectedColours6 = (def.CheckRequiresSolidOutput() ? base.Resources.alternateIOColours.output : base.Resources.liquidIOColours.output);
					AddPort(Ports.SolidOut, secondaryOutput.GetSecondaryConduitOffset(ConduitType.Solid), connectedDisconnectedColours6.connected, connectedDisconnectedColours6.disconnected);
				}
			}
		}
	}
