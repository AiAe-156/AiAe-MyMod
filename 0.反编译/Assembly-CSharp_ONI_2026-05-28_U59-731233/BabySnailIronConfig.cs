...
public class BabySnailIronConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject gameObject = SnailConfig.CreateSnail("SnailIronBaby", CREATURES.SPECIES.SNAIL.VARIANT_IRON.BABY.NAME, CREATURES.SPECIES.SNAIL.VARIANT_IRON.BABY.DESC, "baby_snail_iron_kanim", is_baby: true);
