...
public class AcousticDisturbance
{
	...
	public static void Emit(object data, int EmissionRadius)
	{
		...
		Profiler.BeginSample("AcousticDisturbance - A");
		cellsInRange.Clear();
		...
		Profiler.EndSample();
		Profiler.BeginSample("AcousticDisturbance - B");
		DrawVisualEffect(num, cellsInRange);
		Profiler.EndSample();
		Profiler.BeginSample("AcousticDisturbance - C");
	...
	{
		Profiler.BeginSample("AcousticDisturbance - D");
