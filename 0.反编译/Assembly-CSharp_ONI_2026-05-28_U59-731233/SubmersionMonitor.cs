...
public class SubmersionMonitor : KMonoBehaviour, IGameObjectEffectDescriptor, IWiltCause, ISim1000ms
{
	...
	private ulong cellChangeMonitorHandlerID = 0uL;
	...
	protected override void OnSpawn()
	{
		...
		OnMove();
		CheckDry();
		cellChangeMonitorHandlerID = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(base.transform, OnMoveDispatcher, this, "SubmersionMonitor.OnSpawn");
	}
	...
	{
		Singleton<CellChangeMonitor>.Instance.UnregisterCellChangedHandler(ref cellChangeMonitorHandlerID);
