...
public class GraphBase : KMonoBehaviour
{
	...
	public void RefreshHorizontalGuides()
	{
		...
		int num = ((axis_y.guide_frequency > 0f) ? ((int)(axis_y.range / axis_y.guide_frequency)) : 0);
	...
	public void RefreshVerticalGuides()
	{
		...
		int num = ((axis_x.guide_frequency > 0f) ? ((int)(axis_x.range / axis_x.guide_frequency)) : 0);
		Vector2[] array = new Vector2[2 * num];
		for (int i = 0; i < array.Length; i += 2)
		{
