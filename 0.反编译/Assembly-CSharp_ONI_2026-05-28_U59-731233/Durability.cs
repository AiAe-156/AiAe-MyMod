...
public class Durability : KMonoBehaviour
{
	...
	public void ConvertToWornObject()
	{
		...
		if ((bool)component2)
		{
			...
			if ((bool)component3)
			{
				component2.AddLiquid((component3.lastFuelUsed != SimHashes.Vacuum) ? component3.lastFuelUsed : SimHashes.Petroleum, component3.amount, GetComponent<PrimaryElement>().Temperature, byte.MaxValue, 0);
			}
			component2.DropAll();
		}
