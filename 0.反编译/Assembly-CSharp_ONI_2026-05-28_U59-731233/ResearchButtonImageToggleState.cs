...
public class ResearchButtonImageToggleState : ImageToggleState
{
	...
	private Coroutine scrollIconCoroutine = null;

	private Sprite[] currentResearchIcons;

	private float mainIconScreenTime = 0f;

	private float itemScreenTime = 0f;

	private int item_idx = -1;

	private bool ReadyToDisplayIcons => progressBar.enabled && currentResearchIcons != null && item_idx >= 0 && item_idx < currentResearchIcons.Length;
