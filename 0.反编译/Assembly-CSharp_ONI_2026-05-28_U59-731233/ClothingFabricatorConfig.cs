...
public class ClothingFabricatorConfig : IBuildingConfig
{
	...
	private void ConfigureRecipes()
	{
		...
		FunkyVestConfig.recipe = new ComplexRecipe(id2, array3, array4)
		{
		...
		if (DlcManager.IsContentSubscribed("DLC5_ID"))
		{
			...
			DrySuitConfig.recipe = new ComplexRecipe(id3, array5, array6)
			{
				time = TUNING.EQUIPMENT.VESTS.WARM_VEST_FABTIME,
		...
		if (DlcManager.IsContentSubscribed("DLC5_ID"))
		{
			...
			string id4 = ComplexRecipeManager.MakeRecipeID("ClothingFabricator", array7, array8);
