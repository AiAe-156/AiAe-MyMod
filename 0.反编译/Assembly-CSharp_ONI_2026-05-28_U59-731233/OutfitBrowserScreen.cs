...
public class OutfitBrowserScreen : KMonoBehaviour
{
	...
	private System.Action RefreshGalleryFn = null;
	...
	private void PopulateGallery()
	{
		...
		MultiToggle component = addButtonGridItem.GetComponent<MultiToggle>();
		...
		void AddGridIconForTarget(Option<ClothingOutfitTarget> target)
		{
			...
			component2.offsetMax = new Vector2(0f - num, 0f - num2);
			...
			RefreshGalleryFn = (System.Action)Delegate.Combine(RefreshGalleryFn, (System.Action)delegate
			{
				...
				if (target.IsSome() && target.Unwrap().impl is ClothingOutfitTarget.DatabaseAuthoredTemplate databaseAuthoredTemplate)
				{
					...
					{
						Image component3 = dlcBannerGO.GetComponent<Image>();
						component3.sprite = Assets.GetSprite(DlcManager.GetDlcBannerSprite(dlcIdFrom));
						component3.color = DlcManager.GetDlcBannerColor(dlcIdFrom);
