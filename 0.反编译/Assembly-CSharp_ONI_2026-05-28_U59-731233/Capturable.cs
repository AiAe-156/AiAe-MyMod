...
public class Capturable : Workable
{
	...
	{
		FlopStates.Instance sMI = base.gameObject.GetSMI<FlopStates.Instance>();
		if (sMI == null)
		{
			IdleStates.Instance sMI2 = base.gameObject.GetSMI<IdleStates.Instance>();
			if (sMI2 != null)
			{
				sMI2.GoTo(sMI2.sm.root);
				sMI2.GetComponent<Navigator>().Stop();
			}
		}
	}
	...
	private void OnChoreEnds(Chore chore)
	{
		...
		{
			IdleStates.Instance sMI2 = base.gameObject.GetSMI<IdleStates.Instance>();
			sMI2?.GoTo(sMI2.sm.GetDefaultState());
		}
	}
	...
	protected override void OnStartWork(WorkerBase worker)
	{
		...
		component.AddTag(GameTags.Creatures.StunnedForCapture);
	}

	protected override void OnStopWork(WorkerBase worker)
	{
		KPrefabID component = GetComponent<KPrefabID>();
		component.RemoveTag(GameTags.Creatures.StunnedForCapture);
	}
