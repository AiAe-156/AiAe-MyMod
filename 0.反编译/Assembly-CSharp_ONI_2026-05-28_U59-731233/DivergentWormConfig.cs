...
public class DivergentWormConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject prefab = BaseDivergentConfig.BaseDivergent(id, name, desc, 200f, anim_file, is_baby ? null : "worm_build_kanim", "DivergentWormBaseTrait", is_baby, 8f, null, "DivergentCropTendedWorm", 3, is_pacifist: false, "worm_emotes_kanim");
	...
	public GameObject CreatePrefab()
	{
		...
		prefab = EntityTemplates.ExtendEntityToFertileCreature(prefab, this, "DivergentWormEgg", STRINGS.CREATURES.SPECIES.DIVERGENT.VARIANT_WORM.EGG_NAME, STRINGS.CREATURES.SPECIES.DIVERGENT.VARIANT_WORM.DESC, "egg_worm_kanim", DivergentTuning.EGG_MASS, "DivergentWormBaby", 90f, 30f, DivergentTuning.EGG_CHANCES_WORM, EGG_SORT_ORDER);
