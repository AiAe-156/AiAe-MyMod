...
public class Accessorizer : KMonoBehaviour
{
	...
	private void OnDeserialized()
	{
		...
		{
			WearableAccessorizer component2 = GetComponent<WearableAccessorizer>();
			component2.ApplyClothingItems(ClothingOutfitUtility.OutfitType.Clothing, clothingItems.Select((ResourceRef<ClothingItemResource> i) => i.Get()));
			clothingItems.Clear();
		}
		ApplyAccessories();
	}
	...
	public void AddAccessory(Accessory accessory)
	{
		...
		component.AddSymbolOverride(accessory.slot.targetSymbolId, accessory.symbol, accessory.slot.overrideLayer);
	...
	public void RemoveAccessory(Accessory accessory)
	{
		...
		SymbolOverrideController component = animController.GetComponent<SymbolOverrideController>();
		component.TryRemoveSymbolOverride(accessory.slot.targetSymbolId, accessory.slot.overrideLayer);
	}
