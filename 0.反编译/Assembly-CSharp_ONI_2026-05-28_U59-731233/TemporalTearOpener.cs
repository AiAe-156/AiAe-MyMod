...
public class TemporalTearOpener : GameStateMachine<TemporalTearOpener, TemporalTearOpener.Instance, IStateMachineTarget, TemporalTearOpener.Def>
{
	...
	public new class Instance : GameInstance, ISidescreenButtonControl
	{
		...
		{
			return GetCurrentState() == base.sm.ready || DebugHandler.InstantBuildMode;
		}
		...
		public void OnSidescreenButtonPressed()
		{
			...
			component.PopupConfirmDialog(UI.UISIDESCREENS.TEMPORALTEARSIDESCREEN.CONFIRM_POPUP_MESSAGE, delegate
			{
	...
	{
		StatusItem statusItem = new StatusItem("Temporal_Tear_Opener_Insufficient_Colonies", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, allow_multiples: false, OverlayModes.None.ID, showWorldIcon: false);
