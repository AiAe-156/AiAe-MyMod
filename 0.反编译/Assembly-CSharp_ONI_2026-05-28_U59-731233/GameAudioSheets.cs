			...
			default:
				if (!(type == "LoopingVoiceSoundEvent"))
				{
					...
					case "UIAnimationLoopingSoundEvent":
						...
						break;
					default:
						if (!(type == "CreatureVariationLoopingSoundEvent"))
						{
							if (type == "UnderwaterSoundEvent" || type == "UnderwaterLoopingSoundEvent")
							{
								soundEvent = new UnderwaterSoundEvent(file_name, sound_name, frame, do_load: true, type == "UnderwaterLoopingSoundEvent", min_interval, is_dynamic: false);
								break;
							}
							switch (type)
							{
						...
						goto case "CreatureVariationSoundEvent";
					case "CreatureVariationSoundEvent":
						soundEvent = new CreatureVariationSoundEvent(file_name, sound_name, frame, do_load: true, type == "CreatureVariationLoopingSoundEvent", min_interval, is_dynamic: false);
						break;
					}
					break;
				}
				goto case "VoiceSoundEvent";
