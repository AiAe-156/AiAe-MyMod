...
public class SkyVisibilityMonitor : GameStateMachine<SkyVisibilityMonitor, SkyVisibilityMonitor.Instance, IStateMachineTarget, SkyVisibilityMonitor.Def>
{
	...
	public new class Instance : GameInstance, BuildingStatusItems.ISkyVisInfo
	{
		...
		public System.Action SkyVisibilityChanged = null;

		private StatusItem visibilityStatusItem = null;
		...
		public bool HasSkyVisibility => PercentClearSky > 0f && !Mathf.Approximately(0f, PercentClearSky);
		...
		public void TriggerVisibilityChange()
		{
			...
			{
				KSelectable component = base.smi.GetComponent<KSelectable>();
				component.ToggleStatusItem(visibilityStatusItem, !HasSkyVisibility, this);
			}
			Operational component2 = base.smi.GetComponent<Operational>();
			component2.SetFlag(skyVisibilityFlag, HasSkyVisibility);
