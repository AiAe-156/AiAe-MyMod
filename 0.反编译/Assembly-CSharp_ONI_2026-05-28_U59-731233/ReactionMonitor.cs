...
public class ReactionMonitor : GameStateMachine<ReactionMonitor, ReactionMonitor.Instance, IStateMachineTarget, ReactionMonitor.Def>
{
	...
	{
		public ObjectLayer ReactionLayer = ObjectLayer.Minion;
	}
	...
	public new class Instance : GameInstance
	{
		...
		public Reactable ImmediateReactable { get; private set; } = null;
		...
		{
			return animController != null && e.IsValidForController(animController);
		}
