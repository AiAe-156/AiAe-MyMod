...
public class EatXKCalProducedByY : ColonyAchievementRequirement, AchievementRequirementSerialization_Deprecated
{
	...
	public override bool Success()
	{
		...
		float amountConsumedForIDs = WorldResourceAmountTracker<RationTracker>.Get().GetAmountConsumedForIDs(list.Distinct().ToList());
		return amountConsumedForIDs / 1000f > (float)numCalories;
	}
