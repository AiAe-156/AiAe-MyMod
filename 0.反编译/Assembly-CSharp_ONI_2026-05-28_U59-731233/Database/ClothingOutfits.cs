...
public class ClothingOutfits : ResourceSet<ClothingOutfitResource>
{
	...
	{
		List<string> standard_outfits = new List<string> { "StandardYellow", "StandardRed", "StandardGreen", "StandardBlue", "permit_standard_bionic_outfit", "permit_standard_regal_neutronium_outfit", "permit_standard_swim_outfit" };
