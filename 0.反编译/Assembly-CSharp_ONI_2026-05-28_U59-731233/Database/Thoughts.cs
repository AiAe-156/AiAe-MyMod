...
public class Thoughts : ResourceSet<Thought>
{
		...
		: base("Thoughts", parent)
	{
		...
		ExpellingGunk = new Thought("ExpellingGunk", this, "crew_state_gunk_dump_desire", null, "crew_state_gunk_dump_desire", "bubble_alert", SpeechMonitor.PREFIX_SAD, DUPLICANTS.THOUGHTS.EXPELLINGSPOILEDOIL.TOOLTIP);
		ExpellGunkDesire = new Thought("ExpellGunkDesire", this, "crew_state_gunk_dump_desire", null, "crew_state_gunk_dump_desire", "bubble_alert", SpeechMonitor.PREFIX_SAD, DUPLICANTS.THOUGHTS.EXPELLGUNKDESIRE.TOOLTIP);
		RefillOilDesire = new Thought("RefillOilDesire", this, "crew_state_oil_change_desire", null, "crew_state_oil_change_desire", "bubble_alert", SpeechMonitor.PREFIX_SAD, DUPLICANTS.THOUGHTS.REFILLOILDESIRE.TOOLTIP);
