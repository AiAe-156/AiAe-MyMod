...
public class ChoreTypes : ResourceSet<ChoreType>
{
		...
		: base("ChoreTypes", parent)
	{
		...
		Slip = Add("Slip", new string[0], "", new string[0], DUPLICANTS.CHORES.SLIP.NAME, DUPLICANTS.CHORES.SLIP.STATUS, DUPLICANTS.CHORES.SLIP.TOOLTIP, skip_implicit_priority_change: false);
		...
		WaterDamageZap = Add("WaterDamageZap", new string[0], "EmoteHighPriority", new string[1] { "MoveTo" }, DUPLICANTS.CHORES.WATERDAMAGEZAP.NAME, DUPLICANTS.CHORES.WATERDAMAGEZAP.STATUS, DUPLICANTS.CHORES.WATERDAMAGEZAP.TOOLTIP, skip_implicit_priority_change: false);
		BeOffline = Add("BeOffline", new string[0], "BeOffline", new string[0], DUPLICANTS.CHORES.BEOFFLINE.NAME, DUPLICANTS.CHORES.BEOFFLINE.STATUS, DUPLICANTS.CHORES.BEOFFLINE.TOOLTIP, skip_implicit_priority_change: false);
		...
		FindOxygenSourceItem_Critical = Add("FindOxygenSourceItem_Critical", new string[0], "FindOxygenRefill", new string[0], DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.NAME, DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.STATUS, DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.TOOLTIP, skip_implicit_priority_change: false);
		BionicAbsorbOxygen_Critical = Add("BionicAbsorbOxygen_Critical", new string[0], "FindOxygenRefill", new string[0], DUPLICANTS.CHORES.BIONICABSORBOXYGENCRITICAL.NAME, DUPLICANTS.CHORES.BIONICABSORBOXYGENCRITICAL.STATUS, DUPLICANTS.CHORES.BIONICABSORBOXYGENCRITICAL.TOOLTIP, skip_implicit_priority_change: false);
		ExpellGunk = Add("ExpellGunk", new string[0], "GunkPee", new string[0], DUPLICANTS.CHORES.EXPELLGUNK.NAME, DUPLICANTS.CHORES.EXPELLGUNK.STATUS, DUPLICANTS.CHORES.EXPELLGUNK.TOOLTIP, skip_implicit_priority_change: false);
		...
		StressShock = Add("StressShock", new string[0], "", new string[1] { "MoveTo" }, DUPLICANTS.CHORES.STRESSSHOCK.NAME, DUPLICANTS.CHORES.STRESSSHOCK.STATUS, DUPLICANTS.CHORES.STRESSSHOCK.TOOLTIP, skip_implicit_priority_change: false);
		...
		ReloadElectrobank = Add("ReloadElectrobank", new string[0], "ReloadElectrobank", new string[0], DUPLICANTS.CHORES.RELOADELECTROBANK.NAME, DUPLICANTS.CHORES.RELOADELECTROBANK.STATUS, DUPLICANTS.CHORES.RELOADELECTROBANK.TOOLTIP, skip_implicit_priority_change: false);
		SeekAndInstallUpgrade = Add("SeekAndInstallUpgrade", new string[0], "", new string[0], DUPLICANTS.CHORES.SEEKANDINSTALLUPGRADE.NAME, DUPLICANTS.CHORES.SEEKANDINSTALLUPGRADE.STATUS, DUPLICANTS.CHORES.SEEKANDINSTALLUPGRADE.TOOLTIP, skip_implicit_priority_change: false);
		OilChange = Add("OilChange", new string[0], "OilRefill", new string[0], DUPLICANTS.CHORES.OILCHANGE.NAME, DUPLICANTS.CHORES.OILCHANGE.STATUS, DUPLICANTS.CHORES.OILCHANGE.TOOLTIP, skip_implicit_priority_change: false);
		SolidOilChange = Add("SolidOilChange", new string[0], "OilRefill", new string[0], DUPLICANTS.CHORES.OILCHANGE.NAME, DUPLICANTS.CHORES.OILCHANGE.STATUS, DUPLICANTS.CHORES.OILCHANGE.TOOLTIP, skip_implicit_priority_change: false);
		BionicAbsorbOxygen = Add("BionicAbsorbOxygen", new string[0], "FindOxygenRefill", new string[0], DUPLICANTS.CHORES.BIONICABSORBOXYGEN.NAME, DUPLICANTS.CHORES.BIONICABSORBOXYGEN.STATUS, DUPLICANTS.CHORES.BIONICABSORBOXYGEN.TOOLTIP, skip_implicit_priority_change: false);
		FindOxygenSourceItem = Add("FindOxygenCanister", new string[0], "FindOxygenRefill", new string[0], DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.NAME, DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.STATUS, DUPLICANTS.CHORES.FINDOXYGENSOURCEITEM.TOOLTIP, skip_implicit_priority_change: false);
		...
		BionicRestDueToDisease = Add("BionicRestDueToDisease", new string[0], "Heal", new string[3] { "Vomit", "Cough", "EmoteHighPriority" }, DUPLICANTS.CHORES.RESTDUETODISEASE.NAME, DUPLICANTS.CHORES.RESTDUETODISEASE.STATUS, DUPLICANTS.CHORES.RESTDUETODISEASE.TOOLTIP, skip_implicit_priority_change: false);
		...
		BionicBedtimeMode = Add("BionicBedtimeMode", new string[0], "", new string[0], DUPLICANTS.CHORES.BIONICBEDTIMEMODE.NAME, DUPLICANTS.CHORES.BIONICBEDTIMEMODE.STATUS, DUPLICANTS.CHORES.BIONICBEDTIMEMODE.TOOLTIP, skip_implicit_priority_change: false);
		...
		Fart = Add("Fart", new string[0], "Fart", new string[0], DUPLICANTS.CHORES.EMOTEHIGHPRIORITY.NAME, DUPLICANTS.CHORES.EMOTEHIGHPRIORITY.STATUS, DUPLICANTS.CHORES.EMOTEHIGHPRIORITY.TOOLTIP, skip_implicit_priority_change: false);
		...
		RemoteOperate = Add("RemoteOperate", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.REMOTEWORK.NAME, DUPLICANTS.CHORES.REMOTEWORK.STATUS, DUPLICANTS.CHORES.REMOTEWORK.TOOLTIP, skip_implicit_priority_change: false, 5000);
		...
		CleanLitterBox = Add("CleanLitterBox", new string[1] { "Ranching" }, "", new string[0], DUPLICANTS.CHORES.CLEANLITTERBOX.NAME, DUPLICANTS.CHORES.CLEANLITTERBOX.STATUS, DUPLICANTS.CHORES.CLEANLITTERBOX.TOOLTIP, skip_implicit_priority_change: false, 5000);
		...
		BuildUproot = Add("BuildUproot", new string[2] { "Build", "Farming" }, "", new string[0], DUPLICANTS.CHORES.BUILDUPROOT.NAME, DUPLICANTS.CHORES.BUILDUPROOT.STATUS, DUPLICANTS.CHORES.BUILDUPROOT.TOOLTIP, skip_implicit_priority_change: true, 5000);
		...
		ChoreType[][] array = new ChoreType[37][]
		{
			new ChoreType[1] { Die },
			new ChoreType[1] { Entombed },
			new ChoreType[1] { HealCritical },
			new ChoreType[3] { BeIncapacitated, GeneShuffle, Migrate },
			new ChoreType[1] { BeOffline },
			new ChoreType[1] { DebugGoTo },
			new ChoreType[1] { StressVomit },
			new ChoreType[2] { MoveTo, RocketEnterExit },
			new ChoreType[3] { RecoverBreath, FindOxygenSourceItem_Critical, BionicAbsorbOxygen_Critical },
			new ChoreType[1] { ReturnSuitUrgent },
			new ChoreType[1] { UglyCry },
			new ChoreType[3] { BingeEat, BansheeWail, StressShock },
			new ChoreType[1] { WaterDamageZap },
			new ChoreType[1] { ExpellGunk },
			new ChoreType[11]
			{
				EmoteHighPriority, StressActingOut, Vomit, Cough, Pee, StressIdle, RescueIncapacitated, SwitchHat, RadiationPain, OilChange,
				SolidOilChange
			},
			...
			new ChoreType[5] { LearnSkill, UnlearnSkill, Eat, ReloadElectrobank, BreakPee },
			new ChoreType[2] { FindOxygenSourceItem, BionicAbsorbOxygen },
			new ChoreType[1] { TakeMedicine },
			new ChoreType[4] { Heal, SleepDueToDisease, RestDueToDisease, BionicRestDueToDisease },
			new ChoreType[3] { Sleep, BionicBedtimeMode, Narcolepsy },
			new ChoreType[2] { Doctor, GetDoctored },
			new ChoreType[3] { Emote, Hug, Fart },
			new ChoreType[1] { Mourn },
			new ChoreType[1] { StressHeal },
			new ChoreType[1] { JoyReaction },
			new ChoreType[1] { Party },
			new ChoreType[1] { Relax },
			new ChoreType[3] { Equip, Unequip, SeekAndInstallUpgrade },
			new ChoreType[73]
			{
				DeliverFood, Sigh, EmptyStorage, Repair, Disinfect, Shower, CleanToilet, LiquidCooledFan, IceCooledFan, SuitMarker,
				Checkpoint, Slip, TravelTubeEntrance, WashHands, Recharge, ScrubOre, Ranch, MoveToSafety, Relocate, Research,
				Mop, Toggle, Deconstruct, Demolish, Capture, EggSing, Art, GeneratePower, CropTend, PowerTinker,
				MachineTinker, DropUnusedInventory, Harvest, Uproot, FarmingFabricate, PowerFabricate, Compound, Fabricate, Train, ProcessCritter,
				Cook, Build, Dig, BuildDig, BuildUproot, FlipCompost, CleanLitterBox, Depressurize, StressEmote, Astronaut,
				EmptyDesalinator, ArmTrap, FetchCritical, ResearchFetch, ExcavateFossil, AnalyzeArtifact, AnalyzeSeed, CreatureFetch, RanchingFetch, Fetch,
				Transport, FarmFetch, BuildFetch, CookFetch, DoctorFetch, MachineFetch, PowerFetch, FabricateFetch, FoodFetch, StorageFetch,
				RepairFetch, EquipmentFetch, RemoteOperate
			},
