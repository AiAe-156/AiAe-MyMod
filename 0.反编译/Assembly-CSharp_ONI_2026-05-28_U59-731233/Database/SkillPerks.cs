...
public class SkillPerks : ResourceSet<SkillPerk>
{
		...
		: base("SkillPerks", parent)
	{
		...
		CanFarmStation = Add(new SimpleSkillPerk("CanFarmStation", UI.ROLES_SCREEN.PERKS.CAN_FARM_STATION.DESCRIPTION));
		CanSalvagePlantFiber = Add(new SimpleSkillPerk("CanSalvagePlantFiber", UI.ROLES_SCREEN.PERKS.CAN_SALVAGE_PLANT_FIBER.DESCRIPTION));
		...
		IncreaseAthleticsLarge = Add(new SkillAttributePerk("IncreaseAthleticsLarge", Db.Get().Attributes.Athletics.Id, ROLES.ATTRIBUTE_BONUS_THIRD, DUPLICANTS.ROLES.SUIT_DURABILITY.NAME));
		CanSwim = Add(new SimpleSkillPerk("CanSwim", UI.ROLES_SCREEN.PERKS.CAN_SWIM.DESCRIPTION));
		IncreasedLungCapacity = Add(new LungCapacityPerk("IncreasedLungCapacity", DUPLICANTSTATS.STANDARD.Breath.SWIMMING_SKILL_LUNG_CAPACITY_BONUS, DUPLICANTS.ROLES.SWIMMER.NAME));
		IncreaseSwimmerStaminaInLiquid = Add(new SimpleSkillPerk("IncreaseSwimmerStaminaInLiquid", UI.ROLES_SCREEN.PERKS.INCREASE_SWIMMER_STAMINA_IN_LIQUID.DESCRIPTION));
		IncreaseSwimmerAthleticsInLiquid = Add(new SimpleSkillPerk("IncreaseSwimmerAthleticsInLiquid", UI.ROLES_SCREEN.PERKS.INCREASE_SWIMMER_ATHLETICS_IN_LIQUID.DESCRIPTION));
		ReduceSaltWaterSwimmingEyeIrritation = Add(new SimpleSkillPerk("ReduceSaltWaterSwimmingEyeIrritation", UI.ROLES_SCREEN.PERKS.REDUCE_SALTWATER_SWIMMER_EYE_IRRITATION.DESCRIPTION));
		ImprovedLiquidTemperatureTolerance = Add(new SimpleSkillPerk("ImprovedLiquidTemperatureTolerance", UI.ROLES_SCREEN.PERKS.IMPROVED_LIQUID_TEMPERATURE_TOLERANCE.DESCRIPTION));
		...
		CanCraftElectronics = Add(new SimpleSkillPerk("CanCraftElectronics", UI.ROLES_SCREEN.PERKS.CAN_CRAFT_ELECTRONICS.DESCRIPTION, DlcManager.DLC3));
		CanElectricGrill = Add(new SimpleSkillPerk("CanElectricGrill", UI.ROLES_SCREEN.PERKS.CAN_ELECTRIC_GRILL.DESCRIPTION));
		CanGasRange = Add(new SimpleSkillPerk("CanGasRange", UI.ROLES_SCREEN.PERKS.CAN_GAS_RANGE.DESCRIPTION));
		CanDeepFry = Add(new SimpleSkillPerk("CanDeepFry", UI.ROLES_SCREEN.PERKS.CAN_DEEP_FRYER.DESCRIPTION));
		CanSushiBar = Add(new SimpleSkillPerk("CanSushiBar", UI.ROLES_SCREEN.PERKS.CAN_SUSHI_BAR.DESCRIPTION));
		...
		IncreaseCookingLarge = Add(new SkillAttributePerk("IncreaseCookingLarge", Db.Get().Attributes.Cooking.Id, ROLES.ATTRIBUTE_BONUS_THIRD, DUPLICANTS.ROLES.COOK.NAME));
		...
		AllowChemistry = Add(new SimpleSkillPerk("AllowChemistry", UI.ROLES_SCREEN.PERKS.CHEMISTRY.DESCRIPTION));
		...
		CanUseClusterTelescopeEnclosed = Add(new SimpleSkillPerk("CanUseClusterTelescopeEnclosed", UI.ROLES_SCREEN.PERKS.CAN_CLUSTERTELESCOPEENCLOSED.DESCRIPTION));
		...
		{
			IncreaseCarryAmountBionic = Add(new SkillAttributePerk("IncreaseCarryAmountBionic", Db.Get().Attributes.CarryAmount.Id, 600f, DUPLICANTS.ROLES.MATERIALS_MANAGER.NAME));
			ExtraBionicBooster1 = Add(new SkillAttributePerk("ExtraBionicBooster1", Db.Get().Attributes.BionicBoosterSlots.Id, 1f, DUPLICANTS.ATTRIBUTES.BIONICBOOSTERSLOTS.DESC));
			ExtraBionicBooster2 = Add(new SkillAttributePerk("ExtraBionicBooster2", Db.Get().Attributes.BionicBoosterSlots.Id, 1f, DUPLICANTS.ATTRIBUTES.BIONICBOOSTERSLOTS.DESC));
			ExtraBionicBooster3 = Add(new SkillAttributePerk("ExtraBionicBooster3", Db.Get().Attributes.BionicBoosterSlots.Id, 2f, DUPLICANTS.ATTRIBUTES.BIONICBOOSTERSLOTS.DESC));
			ExtraBionicBooster4 = Add(new SkillAttributePerk("ExtraBionicBooster4", Db.Get().Attributes.BionicBoosterSlots.Id, 1f, DUPLICANTS.ATTRIBUTES.BIONICBOOSTERSLOTS.DESC));
			ExtraBionicBooster5 = Add(new SkillAttributePerk("ExtraBionicBooster5", Db.Get().Attributes.BionicBoosterSlots.Id, 1f, ""));
			ExtraBionicBooster6 = Add(new SkillAttributePerk("ExtraBionicBooster6", Db.Get().Attributes.BionicBoosterSlots.Id, 1f, DUPLICANTS.ATTRIBUTES.BIONICBOOSTERSLOTS.DESC));
			ExtraBionicBatteries = Add(new SkillAttributePerk("ExtraBionicBatteries", Db.Get().Attributes.BionicBatteryCountCapacity.Id, 2f, UI.ROLES_SCREEN.PERKS.EXTRA_BIONIC_BATTERIES.DESCRIPTION));
			BionicEardrumsDefense = Add(new ImmunitySkillPerk("BionicEardrumsDefense", "PoppedEarDrums"));
			BionicMinorEyeIrritationDefense = Add(new ImmunitySkillPerk("BionicMinorEyeIrritationDefense", "MinorIrritation"));
			BionicMajorEyeIrritationDefense = Add(new ImmunitySkillPerk("BionicMajorEyeIrritationDefense", "MajorIrritation"));
			BionicToastySurroundingsDefense = Add(new ImmunitySkillPerk("BionicToastySurroundingsDefense", "WarmAir"));
			BionicChillySurroundingsDefense = Add(new ImmunitySkillPerk("BionicChillySurroundingsDefense", "ColdAir"));
			ReducedBionicGunkProduction = Add(new SimpleSkillPerk("ReducedBionicGunkProduction", UI.ROLES_SCREEN.PERKS.REDUCED_GUNK_PRODUCTION.DESCRIPTION));
			EfficientBionicGears = Add(new SimpleSkillPerk("EfficientBionicGears", UI.ROLES_SCREEN.PERKS.EFFICIENT_BIONIC_GEARS.DESCRIPTION));
			IncreaseAthleticsBionicsC1 = Add(new SkillAttributePerk("IncreaseAthleticsBionicsC1", Db.Get().Attributes.Athletics.Id, 2f, DUPLICANTS.ROLES.BIONICS_C1.NAME));
			IncreaseAthleticsBionicsC2 = Add(new SkillAttributePerk("IncreaseAthleticsBionicsC2", Db.Get().Attributes.Athletics.Id, 2f, DUPLICANTS.ROLES.BIONICS_C2.NAME));
			IncreaseAthleticsBionicsB2 = Add(new SkillAttributePerk("IncreaseAthleticsBionicsB2", Db.Get().Attributes.Athletics.Id, 2f, DUPLICANTS.ROLES.BIONICS_B2.NAME));
			IncreaseAthleticsBionicsA2 = Add(new SkillAttributePerk("IncreaseAthleticsBionicsA2", Db.Get().Attributes.Athletics.Id, 2f, DUPLICANTS.ROLES.BIONICS_A2.NAME));
			IncreasedCarryBionics = Add(new SkillAttributePerk("IncreasedCarryBionics", Db.Get().Attributes.CarryAmount.Id, 400f, STRINGS.ITEMS.BIONIC_BOOSTERS.BOOSTER_CARRY1.NAME, modifierCanStack: true));
		}
		if (DlcManager.IsContentSubscribed("DLC5_ID"))
		{
			CanFarmClams = Add(new SimpleSkillPerk("CanFarmClams", UI.ROLES_SCREEN.PERKS.CAN_FARM_CLAMS.DESCRIPTION));
		}
	}
}
