...
public class Attributes : ResourceSet<Attribute>
{
		...
		: base("Attributes", parent)
	{
		...
		{
			BionicBoosterSlots = Add(new Attribute("BionicBoosterSlots", is_trainable: false, Attribute.Display.Details, is_profession: false, 2f));
			BionicBoosterSlots.SetFormatter(new StandardAttributeFormatter(GameUtil.UnitClass.SimpleInteger, GameUtil.TimeSlice.None));
			BionicBatteryCountCapacity = Add(new Attribute("BionicBatteryCountCapacity", is_trainable: false, Attribute.Display.Details, is_profession: false, 4f));
			BionicBatteryCountCapacity.SetFormatter(new StandardAttributeFormatter(GameUtil.UnitClass.SimpleInteger, GameUtil.TimeSlice.None));
		}
		...
		RadiationResistance = Add(new Attribute("RadiationResistance", is_trainable: false, Attribute.Display.Details, is_profession: false, 0f, null, null, null, DlcManager.EXPANSION1));
		RadiationResistance.SetFormatter(new PercentAttributeFormatter());
		RadiationRecovery = Add(new Attribute("RadiationRecovery", is_trainable: false, Attribute.Display.Details, is_profession: false, 0f, null, null, null, DlcManager.EXPANSION1));
