...
public class ArtableStages : ResourceSet<ArtableStage>
{
	...
	{
		List<ArtableStage> prefabStages = GetPrefabStages(prefab_id);
		return prefabStages.Find((ArtableStage stage) => stage.statusItem == Db.Get().ArtableStatuses.AwaitingArting);
	}
}
