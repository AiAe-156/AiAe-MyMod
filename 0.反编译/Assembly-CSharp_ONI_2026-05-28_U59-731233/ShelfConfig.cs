...
public class ShelfConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		AnimTilableSingleController animTilableSingleController = go.AddOrGet<AnimTilableSingleController>();
		animTilableSingleController.tagsOfNeightboursThatICanTileWith = new Tag[1] { "Shelf" };
	...
	{
		AnimTilableSingleController animTilableSingleController = go.AddOrGet<AnimTilableSingleController>();
		animTilableSingleController.RefreshAnimCallback = RefreshTiledAnim;
	}
