...
public class Navigator : StateMachineComponent<Navigator.StatesInstance>, ISaveLoadableDetails
{
	...
	public bool reportOccupation = false;
	...
	{
		bool atNextNode;
		return PathGrid.BuildPath(cachedCell, reservedCell, CurrentNavType, ref path) && ValidatePath(ref path, out atNextNode);
	}
	...
	{
		DevOnly.Assert(Game.IsOnMainThread(), "IApproachable.GetOffsets is not threadsafe");
