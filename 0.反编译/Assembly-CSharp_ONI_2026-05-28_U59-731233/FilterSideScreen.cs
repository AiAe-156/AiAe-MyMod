...
public class FilterSideScreen : SingleItemSelectionSideScreenBase
{
	...
	{
		bool flag = false;
		flag = ((!isLogicFilter) ? (target.GetComponent<ElementFilter>() != null || target.GetComponent<RocketConduitStorageAccess>() != null || target.GetComponent<DevPump>() != null) : (target.GetComponent<ConduitElementSensor>() != null || target.GetComponent<LogicElementSensor>() != null));
