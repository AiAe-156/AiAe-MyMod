...
public class FoodDehydratorConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("FoodDehydrator", 3, 3, "dehydrator_kanim", 30, 30f, new float[2]
		{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		FoodDehydrator.Def def = go.AddOrGetDef<FoodDehydrator.Def>();
	}
	...
	private void ConfigureRecipes()
	{
		...
		foreach (var item3 in list)
		{
			...
			string id = ComplexRecipeManager.MakeRecipeID("FoodDehydrator", array, array2);
