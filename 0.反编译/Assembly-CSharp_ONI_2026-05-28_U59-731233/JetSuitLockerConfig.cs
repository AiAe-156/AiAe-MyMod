...
public class JetSuitLockerConfig : IBuildingConfig
{
	...
	public override BuildingDef CreateBuildingDef()
	{
		...
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(construction_mass: new float[1] { TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER3[0] }, construction_materials: rEFINED_METALS, melting_point: 1600f, build_location_rule: BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, id: "JetSuitLocker", width: 2, height: 4, anim: "changingarea_jetsuit_kanim", hitpoints: 30, construction_time: 30f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER1);
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		suitLocker.OutfitTags = new Tag[1] { GameTags.JetSuit };
