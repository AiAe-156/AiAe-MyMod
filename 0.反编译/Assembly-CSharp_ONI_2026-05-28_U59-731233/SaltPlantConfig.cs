...
public class SaltPlantConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, dlcRestrictions, SeedProducer.ProductionType.Harvest, "SaltPlantSeed", name2, desc2, anim2, "object", 1, additionalTags2, SingleEntityReceptacle.ReceptacleDirection.Bottom, default(Tag), 5, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.35f, 0.35f);
