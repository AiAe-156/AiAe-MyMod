...
public class AirBorneCritterCondoConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("AirBorneCritterCondo", 3, 3, "critter_condo_airborne_kanim", 100, 120f, new float[1] { 200f }, MATERIALS.PLASTICS, 1600f, BuildLocationRule.OnCeiling, noise: NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER3);
