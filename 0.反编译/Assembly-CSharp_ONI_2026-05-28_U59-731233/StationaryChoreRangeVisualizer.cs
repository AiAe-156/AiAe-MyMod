...
public class StationaryChoreRangeVisualizer : KMonoBehaviour
{
	...
	private ulong cellChangeMonitorHandle = 0uL;
	...
	protected override void OnSpawn()
	{
		...
		if (movable)
		{
			cellChangeMonitorHandle = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(base.transform, OnCellChangeDispatcher, this, "StationaryChoreRangeVisualizer.OnSpawn");
	...
	{
		if (cellChangeMonitorHandle != 0)
		{
			Singleton<CellChangeMonitor>.Instance.UnregisterCellChangedHandler(ref cellChangeMonitorHandle);
		}
