...
public class BatteryConfig : BaseBatteryConfig
{
	...
	{
		BuildingDef buildingDef = CreateBuildingDef("Battery", 1, 2, 30, "batterysm_kanim", 30f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.ALL_METALS, 800f, 0.25f, 1f, noise: NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER1);
