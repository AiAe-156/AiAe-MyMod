...
public class NoisePolluter : KMonoBehaviour, IPolluter
{
	...
	private ulong cellChangedHandlerCallback = 0uL;
	...
	protected override void OnSpawn()
	{
		...
		cellChangedHandlerCallback = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(base.transform, RefreshDispatcher, this, "NoisePolluter.OnSpawn");
	...
	protected override void OnCleanUp()
	{
		...
		if (base.isSpawned)
		{
			...
			if (isMovable)
			{
				Singleton<CellChangeMonitor>.Instance.UnregisterCellChangedHandler(ref cellChangedHandlerCallback);
			}
		}
		if (splat != null)
		{
