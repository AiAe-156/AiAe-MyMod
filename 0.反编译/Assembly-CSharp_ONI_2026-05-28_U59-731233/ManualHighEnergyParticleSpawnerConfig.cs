...
public class ManualHighEnergyParticleSpawnerConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("ManualHighEnergyParticleSpawner", 1, 3, "manual_radbolt_generator_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, MATERIALS.RAW_MINERALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER1);
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		string id = ComplexRecipeManager.MakeRecipeID("ManualHighEnergyParticleSpawner", array, array2);
		new ComplexRecipe(id, array, array2, 0, 5)
		{
			time = 40f,
		...
		string id2 = ComplexRecipeManager.MakeRecipeID("ManualHighEnergyParticleSpawner", array3, array4);
		new ComplexRecipe(id2, array3, array4, 0, 25)
		{
			time = 40f,
