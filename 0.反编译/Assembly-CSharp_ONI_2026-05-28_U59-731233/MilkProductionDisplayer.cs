...
public class MilkProductionDisplayer : AsPercentAmountDisplayer, IVariableImageAmountDisplayer, IAmountDisplayer
{
	...
	{
		MilkProductionMonitor.Instance sMI = instance.gameObject.GetSMI<MilkProductionMonitor.Instance>();
		Element element = ElementLoader.FindElementByHash(sMI.def.element);
