...
public class FixedCapturePoint : GameStateMachine<FixedCapturePoint, FixedCapturePoint.Instance, IStateMachineTarget, FixedCapturePoint.Def>
{
	public class Def : BaseDef
	{
		...
		public CellOffset? postCaptureOffset = null;

		public string preCaptureAnimName = null;

		public Func<Instance, string> getPreCaptureAnimSuffix = null;

		public string offAnimName = null;

		public string onAnimName = null;
	}
	...
	public new class Instance : GameInstance
	{
		...
		public bool IsOperational => operationComp != null && operationComp.IsOperational;
		...
		public void OnBuildingStrawChanged()
		{
			UpdateCaptureCell(straw.GetBottomCellOffset());
			string animSuffix = straw.GetAnimSuffix();
		...
		private static bool CanCapturableBeCapturedAtCapturePoint(FixedCapturableMonitor.Instance capturable, Instance capture_point, CavityInfo capture_cavity_info, int capture_cell)
		{
			...
			int navigationCost = capturable.Navigator.GetNavigationCost(capture_cell);
			if (navigationCost == -1)
			{
				return false;
			}
	...
	public static void RefreshOnOffAnim(Instance smi)
	{
		smi.PlayOnOffAnim();
	}
