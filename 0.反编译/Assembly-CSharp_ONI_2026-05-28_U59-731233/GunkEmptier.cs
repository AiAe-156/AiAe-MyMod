...
public class GunkEmptier : GameStateMachine<GunkEmptier, GunkEmptier.Instance, IStateMachineTarget, GunkEmptier.Def>
{
	...
	public new class Instance : GameInstance
	{
			...
			: base(master, def)
		{
			...
			Ownable ownable = base.gameObject.AddOrGet<Ownable>();
			ownable.AddAssignPrecondition(AssignablePrecondition_OnlyOnBionics);
		}
		...
		public void AddDisseaseToWorker(WorkerBase worker)
		{
			if (worker != null)
			{
				...
				component.AddDisease(index, DISEASE_ON_DUPE_COUNT_PER_USE, "GunkEmptier.Flush");
