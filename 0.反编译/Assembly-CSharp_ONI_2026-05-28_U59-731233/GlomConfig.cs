...
public class GlomConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicCreature(gameObject, FactionManager.FactionID.Pest, "GlomBaseTrait", "WalkerNavGrid1x1", NavType.Floor, 32, 2f, "", 0f, drownVulnerable: true, entombVulnerable: true, 303.15f, 373.15f, 273.15f, 473.15f);
