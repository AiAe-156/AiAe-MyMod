...
public class NuclearResearchCenterWorkable : Workable
{
	...
	protected override void OnStartWork(WorkerBase worker)
	{
		...
		component.AddStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, nrc);
	}
	...
	protected override void OnStopWork(WorkerBase worker)
	{
		...
		KSelectable component = GetComponent<KSelectable>();
		component.RemoveStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, nrc);
	}
