...
public class OxyfernConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		string name = STRINGS.CREATURES.SPECIES.SEEDS.OXYFERN.NAME;
		string desc = STRINGS.CREATURES.SPECIES.SEEDS.OXYFERN.DESC;
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(plant, dlcRestrictions, SeedProducer.ProductionType.Hidden, "OxyfernSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 20, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f);
