...
public class FaceGraph : KMonoBehaviour
{
	...
	public void ApplyShape()
	{
		...
		if (m_blinkMonitor == null)
		{
			...
			if (m_blinkMonitor != null)
			{
				m_blinkMonitor.eye_anim = accessory.Name;
			}
		}
		...
		{
			Accessory accessory2 = m_accessorizer.GetAccessory(Db.Get().AccessorySlots.Eyes);
			KAnim.Build.Symbol symbol = accessory2.symbol;
		...
		{
			Accessory accessory3 = m_accessorizer.GetAccessory(Db.Get().AccessorySlots.Mouth);
			KAnim.Build.Symbol symbol2 = accessory3.symbol;
