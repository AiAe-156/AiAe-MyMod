...
public class RadiationLightConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("RadiationLight", 1, 1, "radiation_lamp_kanim", 10, 10f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER1, MATERIALS.ALL_METALS, 800f, BuildLocationRule.OnWall, noise: NOISE_POLLUTION.NONE, decor: BUILDINGS.DECOR.NONE);
