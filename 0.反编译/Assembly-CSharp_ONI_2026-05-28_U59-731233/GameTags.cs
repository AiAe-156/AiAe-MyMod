...
public class GameTags
{
	...
	public static class CodexCategories
	{
		...
		public static Tag Submersible = AllTags.AddAndReturn("Ornament".ToTag());
	...
	public static TagSet HiddenElementTags = new TagSet { HideFromCodex, HideFromSpawnTool, StartingMetalOre, StartingRefinedMetal };
