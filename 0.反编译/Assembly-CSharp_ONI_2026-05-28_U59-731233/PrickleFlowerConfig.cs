...
public class PrickleFlowerConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		}, pressure_sensitive: true, 0f, 0.15f, PrickleFruitConfig.ID, can_drown: true, can_tinker: true, require_solid_tile: true, require_Backwall_Foundation: false, should_grow_old: true, 2400f, 0f, 4600f, "PrickleFlowerOriginal", STRINGS.CREATURES.SPECIES.PRICKLEFLOWER.NAME);
		...
		plantFiberProducer.amount = 48f;
		IHasDlcRestrictions dlcRestrictions = this as IHasDlcRestrictions;
		string name = STRINGS.CREATURES.SPECIES.SEEDS.PRICKLEFLOWER.NAME;
		string desc = STRINGS.CREATURES.SPECIES.SEEDS.PRICKLEFLOWER.DESC;
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, dlcRestrictions, SeedProducer.ProductionType.Harvest, "PrickleFlowerSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 2, domesticatedDescription);
