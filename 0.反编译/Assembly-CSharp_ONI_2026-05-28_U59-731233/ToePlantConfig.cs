...
public class ToePlantConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, this, SeedProducer.ProductionType.Hidden, "ToePlantSeed", name2, desc2, anim2, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 12, domesticatedDescription);
