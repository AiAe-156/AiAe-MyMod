...
public class CodexCollapsibleHeader : CodexWidget<CodexCollapsibleHeader>
{
	...
	protected GameObject ContentsGameObject
	{
		get
		{
			if (contentsGameObject == null)
			{
				contentsGameObject = contents.go;
			}
			return contentsGameObject;
		}
		set
		{
			contentsGameObject = value;
		}
	}
	...
	public override void Configure(GameObject contentGameObject, Transform displayPane, Dictionary<CodexTextStyle, TextStyleSetting> textStyles)
	{
		...
		{
			ToggleCategoryOpen(contentGameObject, !ContentsGameObject.activeSelf);
		};
	}
	...
	private void ToggleCategoryOpen(GameObject header, bool open)
	{
		...
		ContentsGameObject.SetActive(open);
	}
}
