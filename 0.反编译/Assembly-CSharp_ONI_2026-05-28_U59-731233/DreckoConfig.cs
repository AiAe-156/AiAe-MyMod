...
public class DreckoConfig : IEntityConfig
{
	...
	{
		GameObject prefab = CreateDrecko("Drecko", CREATURES.SPECIES.DRECKO.NAME, CREATURES.SPECIES.DRECKO.DESC, "drecko_kanim", is_baby: false);
		return EntityTemplates.ExtendEntityToFertileCreature(prefab, this as IHasDlcRestrictions, "DreckoEgg", CREATURES.SPECIES.DRECKO.EGG_NAME, CREATURES.SPECIES.DRECKO.DESC, "egg_drecko_kanim", DreckoTuning.EGG_MASS, "DreckoBaby", 90f, 30f, DreckoTuning.EGG_CHANCES_BASE, EGG_SORT_ORDER);
	}
