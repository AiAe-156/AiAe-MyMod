...
public static class LightGridManager
{
	public class LightGridEmitter
	{
		...
		public struct State : IEquatable<State>
		{
			...
			{
				return origin == rhs.origin && shape == rhs.shape && radius == rhs.radius && intensity == rhs.intensity && falloffRate == rhs.falloffRate && colour == rhs.colour && width == rhs.width && direction == rhs.direction;
			}
		}
