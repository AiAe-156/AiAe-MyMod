...
public class RecoverFromColdChore : Chore<RecoverFromColdChore.Instance>
{
	...
	public class Instance : GameStateMachine<States, Instance, RecoverFromColdChore, object>.GameInstance
	{
		...
		public ColdImmunityProvider.Instance lastKnownImmunityProvider => (base.sm.coldImmunityProvider.Get(this) == null) ? null : base.sm.coldImmunityProvider.Get(this).GetSMI<ColdImmunityProvider.Instance>();
