...
{
	[Serialize]
	public float thresholdPayload = 0f;
	...
	private readonly float minPayload = 0f;

	private readonly float maxPayload = 500f;

	private float foundPayload = 0f;

	private bool waitForLogicTick = false;
	...
	private void OnCopySettings(object data)
	{
		...
		LogicHEPSensor component = gameObject.GetComponent<LogicHEPSensor>();
		if (component != null)
		{
	...
	public void SimEveryTick(float dt)
	{
		...
		foreach (ScenePartitionerEntry item in pooledList)
		{
			...
			HighEnergyParticle component = kCollider2D.gameObject.GetComponent<HighEnergyParticle>();
