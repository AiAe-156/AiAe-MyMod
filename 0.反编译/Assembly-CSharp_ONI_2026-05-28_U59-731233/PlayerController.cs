...
{
	[SerializeField]
	private Action defaultConfigKey = Action.Invalid;

	[SerializeField]
	private List<InterfaceToolConfig> interfaceConfigs = null;
	...
	protected override void OnPrefabInit()
	{
		...
		vim = Object.FindFirstObjectByType<VirtualInputModule>(FindObjectsInactive.Include);
	...
	{
		return tools.Length != 0 && activeTool == tools[0];
	}
