...
public class ChorePreconditions
{
	...
	public Chore.Precondition IsPreferredAssignable = new Chore.Precondition
	{
		...
		fn = delegate(ref Chore.Precondition.Context context, object data)
		{
			...
			List<Assignable> preferredAssignables = Game.Instance.assignmentManager.GetPreferredAssignables(context.consumerState.assignables, component, assignable.slot);
			return preferredAssignables.Contains(assignable);
		},
		canExecuteOnAnyThread = true
	};
