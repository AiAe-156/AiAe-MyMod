...
public class BionicSuffocationMonitor : GameStateMachine<BionicSuffocationMonitor, BionicSuffocationMonitor.Instance, IStateMachineTarget, BionicSuffocationMonitor.Def>
{
	...
	public new class Instance : GameInstance
	{
		...
		{
			return oxygenBreather.HasOxygen || base.master.GetComponent<KPrefabID>().HasTag(GameTags.RecoveringBreath) || oxygenBreather.HasTag(GameTags.InTransitTube);
		}
		...
		{
			return breath.deltaAttribute.GetTotalValue() <= 0f && breath.value <= DUPLICANTSTATS.STANDARD.Breath.SUFFOCATE_AMOUNT;
		}
