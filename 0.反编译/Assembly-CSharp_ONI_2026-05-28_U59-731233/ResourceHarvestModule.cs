...
public class ResourceHarvestModule : GameStateMachine<ResourceHarvestModule, ResourceHarvestModule.StatesInstance, IStateMachineTarget, ResourceHarvestModule.Def>
{
	...
	public class StatesInstance : GameInstance
	{
			...
			: base(master, def)
		{
			...
			KBatchedAnimTracker component2 = meter.gameObject.GetComponent<KBatchedAnimTracker>();
			component2.matchParentOffset = true;
			component2.forceAlwaysAlive = true;
			UpdateMeter();
		}
		...
		public bool HasAnyAmountOfDiamond()
		{
			...
			return component.GetAmountAvailable(SimHashes.Diamond.CreateTag()) > 0f;
		}
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		not_grounded.drilling.PlayAnim("deploying").Exit(delegate(StatesInstance smi)
		{
			...
			component2.Trigger(939543986);
			StatesInstance.RemoveHarvestStatusItems(smi.master.gameObject.GetComponent<RocketModuleCluster>().CraftInterface.gameObject);
		}).Enter(delegate(StatesInstance smi)
		{
			RocketModuleCluster component = smi.master.gameObject.GetComponent<RocketModuleCluster>();
			Clustercraft component2 = component.CraftInterface.GetComponent<Clustercraft>();
			component2.AddTag(GameTags.RocketDrilling);
			...
			.Exit(delegate(StatesInstance smi)
			{
				RocketModuleCluster component = smi.master.gameObject.GetComponent<RocketModuleCluster>();
				Clustercraft component2 = component.CraftInterface.GetComponent<Clustercraft>();
				component2.RemoveTag(GameTags.RocketDrilling);
			})
			.Update(delegate(StatesInstance smi, float dt)
			{
