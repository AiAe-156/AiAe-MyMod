...
public class AutoStorageDropper : GameStateMachine<AutoStorageDropper, AutoStorageDropper.Instance, IStateMachineTarget, AutoStorageDropper.Def>
{
	...
	public class Def : BaseDef
	{
		...
		public bool invertElementFilterInitialValue = false;

		public bool blockedBySubstantialLiquid = false;
	...
	public new class Instance : GameInstance
	{
		...
		{
			return base.def.elementFilter == null || base.def.elementFilter.Length == 0 || (!isInvertElementFilter && IsFilteredElement(element)) || (isInvertElementFilter && !IsFilteredElement(element));
		}
		...
		{
			return (m_rotatable != null) ? (base.transform.GetPosition() + m_rotatable.GetRotatedCellOffset(base.def.dropOffset).ToVector3()) : (base.transform.GetPosition() + base.def.dropOffset.ToVector3());
		}
	}
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		idle.EventTransition(GameHashes.OnStorageChange, pre_drop).OnSignal(checkCanDrop, pre_drop, (Instance smi, SignalParameter param) => !smi.GetComponent<Storage>().IsEmpty()).ParamTransition(isBlocked, blocked, GameStateMachine<AutoStorageDropper, Instance, IStateMachineTarget, Def>.IsTrue);
