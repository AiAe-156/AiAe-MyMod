...
public class HotTubConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("HotTub", 5, 2, "hottub_kanim", 30, 10f, new float[2] { 200f, 200f }, new string[2] { "Metal", "BuildingWood" }, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER2);
