		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			fight.throwFood.Enter(delegate(StatesInstance smi)
			{
				...
				if (gameObject2 != null)
				{
					...
					ReportManager.Instance.ReportValueWithGameObjectContext(ReportManager.ReportType.CaloriesCreated, 0f - num, smi.master.gameObject, StringFormatter.Replace(UI.ENDOFDAYREPORT.NOTES.FOODFIGHT_CONTEXT, "{0}", component.GetProperName()));
