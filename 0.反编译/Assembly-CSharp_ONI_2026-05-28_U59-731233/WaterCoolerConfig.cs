...
public class WaterCoolerConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("WaterCooler", 2, 2, "watercooler_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.RAW_MINERALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER1);
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		WaterCooler waterCooler = go.AddOrGet<WaterCooler>();
	...
	{
		WaterCooler.StatesInstance sMI = smi.GetSMI<WaterCooler.StatesInstance>();
		sMI.Drink(duplicant, triggerOnDrinkCallback: false);
	}
