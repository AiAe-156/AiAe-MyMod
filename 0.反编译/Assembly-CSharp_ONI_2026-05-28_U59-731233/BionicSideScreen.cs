...
public class BionicSideScreen : SideScreenContent
{
	...
	private AssignableSlotInstance lastSlotSelected = null;
	...
	private void OnBionicUpgradeSlotClicked(BionicSideScreenUpgradeSlot slotClicked)
	{
		...
		OwnablesSecondSideScreen ownablesSecondSideScreen = (OwnablesSecondSideScreen)DetailsScreen.Instance.SetSecondarySideScreen(ownableSecondSideScreenPrefab, bionicUpgrade.Name);
		ownablesSecondSideScreen.SetSlot(assignableSlotInstance);
	}
	...
	private void OnBionicTagsChanged(object o)
	{
		if (o != null)
		{
			...
			if (value.tag == GameTags.BionicBedTime)
			{
