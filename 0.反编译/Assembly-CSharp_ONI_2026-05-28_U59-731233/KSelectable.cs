...
public class KSelectable : KMonoBehaviour
{
	...
	public bool DisableSelectMarker
	{
		get
		{
			return disableSelectMarker;
		}
		set
		{
			disableSelectMarker = value;
		}
	}
	...
	private void ClearHighlight()
	{
		...
		Trigger(-1201923725, (object)BoxedBools.False);
	}
	...
	private void ApplyHighlight(float highlight)
	{
		...
		Trigger(-1201923725, (object)BoxedBools.True);
	}
	...
	public void Select()
	{
		...
		ClearHighlight();
		ApplyHighlight(0.2f);
		Trigger(-1503271301, (object)BoxedBools.True);
	...
	public void Unselect()
	{
		if (selected)
		{
			selected = false;
			ClearHighlight();
			Trigger(-1503271301, (object)BoxedBools.False);
		}
		if (GetComponent<LoopingSounds>() != null)
		{
			GetComponent<LoopingSounds>().UpdateObjectSelection(selected);
	...
	{
		WorkerBase component = GetComponent<WorkerBase>();
		if (component != null && component.GetWorkable() != null)
		{
			Workable workable = GetComponent<WorkerBase>().GetWorkable();
