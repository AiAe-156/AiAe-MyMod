...
public class DiggerMonitor : GameStateMachine<DiggerMonitor, DiggerMonitor.Instance, IStateMachineTarget, DiggerMonitor.Def>
{
	...
	public new class Instance : GameInstance
	{
		...
		private static Func<int, bool> isValidDigCell = IsValidDigCell;
		...
		private bool FoundValidDigCell()
		{
			...
			if (num > 0)
			{
				cell = FloodFill.Find(isValidDigCell, num2, new FloodFill.MaxDepth(base.smi.def.depthToDig), stopAtSolid: false, stopAtLiquid: true);
			}
			lastDigCell = cell;
