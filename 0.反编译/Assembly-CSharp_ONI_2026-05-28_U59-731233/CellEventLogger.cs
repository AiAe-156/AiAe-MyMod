...
public class CellEventLogger : EventLogger<CellEventInstance, CellEvent>
{
	...
	protected override void OnPrefabInit()
	{
		...
		Photosynthesis = AddEvent(new CellAddRemoveSubstanceEvent("Photosynthesis", "Photosynthesis")) as CellAddRemoveSubstanceEvent;
		...
		BreathingGeyser = AddEvent(new CellAddRemoveSubstanceEvent("BreathingGeyser", "Breathing Geyser ExhaleUpdate")) as CellAddRemoveSubstanceEvent;
	}
}
