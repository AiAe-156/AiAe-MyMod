...
public class DevToolEntity_RanchStation : DevTool
{
	...
	protected override void RenderTo(DevPanel panel)
	{
		...
		for (int num = 0; num < list.Count; num++)
		{
			...
			{
				DevToolEntityTarget.ForWorldGameObject forWorldGameObject2 = new DevToolEntityTarget.ForWorldGameObject(instance.gameObject);
				Option<(Vector2, Vector2)> screenRect2 = forWorldGameObject2.GetScreenRect();
