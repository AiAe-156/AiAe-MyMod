...
public class MoltDropperMonitor : GameStateMachine<MoltDropperMonitor, MoltDropperMonitor.Instance, IStateMachineTarget, MoltDropperMonitor.Def>
{
	...
	{
		public bool synchWithBehaviour = false;
		...
		{
			Tag tag = new Tag(onGrowDropID);
			string newValue = tag.ProperName();
			float mass = massToDrop / 600f;
	...
	public new class Instance : GameInstance
	{
		...
		[Serialize]
		public bool spawnedThisCycle = false;
		...
		public void Drop()
		{
			GameObject gameObject = Scenario.SpawnPrefab(GetDropSpawnLocation(), 0, 0, base.def.onGrowDropID);
			gameObject.SetActive(value: true);
			PrimaryElement component = gameObject.GetComponent<PrimaryElement>();
			component.Mass = base.def.massToDrop;
