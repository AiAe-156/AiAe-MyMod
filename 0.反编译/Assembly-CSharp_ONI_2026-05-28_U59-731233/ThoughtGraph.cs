...
public class ThoughtGraph : GameStateMachine<ThoughtGraph, ThoughtGraph.Instance>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		}).Exit("DestroyBubble", delegate(Instance smi)
		{
			...
			.ScheduleGoTo((Instance smi) => thoughtDisplayTime.Get(smi), displayingthought.finishing);
		...
		displayingthought.finishing.EnterTransition(cooldown, (Instance smi) => !smi.Kpid.HasTag(GameTags.DoNotInterruptMe)).TagTransition(GameTags.DoNotInterruptMe, cooldown, on_remove: true);
