...
public class JoyResponseDesignerScreen : KMonoBehaviour
{
	...
	public abstract class GalleryItem : IEquatable<GalleryItem>
	{
		...
		{
			return obj is GalleryItem other && Equals(other);
		}
	...
	public JoyResponseCategory[] joyResponseCategories = null;
	...
	public System.Action RefreshPreviewFn = null;
	...
	public void PopulateGallery()
	{
		...
		void AddGridIcon(GalleryItem galleryItem)
		{
			...
			Image reference = component.GetReference<Image>("IsUnownedOverlay");
			reference.gameObject.SetActive(!galleryItem.IsUnlocked());
