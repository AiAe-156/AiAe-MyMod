...
public class DUPLICANTS
{
	...
	public class ROLES
	{
		...
		{
			public static LocString NAME = UI.FormatAsLink("Basic Swimming", "SWIMMER");
		...
		{
			public static LocString NAME = UI.FormatAsLink("Divemaster", "EXPERT_SWIMMER");
