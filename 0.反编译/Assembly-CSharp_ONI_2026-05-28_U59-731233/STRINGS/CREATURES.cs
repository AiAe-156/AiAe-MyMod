...
public class CREATURES
{
	...
	public class SPECIES
	{
		...
		public class PARROTFISH
		{
			...
			public static LocString DESC = string.Concat("Beakons are attractive aquatic critters who enjoy consuming ", UI.FormatAsLink("Oxygen", "OXYGEN"), ".\n\nThese bioluminescent fish feast on ", UI.FormatAsLink("Phosphorite", "PHOSPHORITE"), " and ", UI.FormatAsLink("Starnacle", "PLANKTONCORAL"), ", and excrete ", ELEMENTS.LIME.NAME, ".");
		...
		public class LIGHTBUG
		{
			...
			public class VARIANT_ORANGE
			{
				...
				public static LocString DESC = string.Concat("Sun Bugs emit a soft orange ", UI.FormatAsLink("Light", "LIGHT"), " in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_PURPLE
			{
				...
				public static LocString DESC = string.Concat("Royal Bugs emit a soft purple ", UI.FormatAsLink("Light", "LIGHT"), " in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_PINK
			{
				...
				public static LocString DESC = string.Concat("Coral Bugs emit a soft pink ", UI.FormatAsLink("Light", "LIGHT"), " in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_BLUE
			{
				...
				public static LocString DESC = string.Concat("Azure Bugs emit a soft blue ", UI.FormatAsLink("Light", "LIGHT"), " in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_CRYSTAL
			{
				...
				public static LocString DESC = string.Concat("Radiant Bugs emit an extra-bright ", UI.FormatAsLink("Light", "LIGHT"), " in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public static LocString DESC = string.Concat("Shine Bugs emit a soft ", UI.FormatAsLink("Light", "LIGHT"), " in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
		...
		public class SEATURTLE
		{
			...
			public static LocString DESC = string.Concat("Orehulls are shy aquatic critters that eat ", FAMILY_PLURAL.SEAFAIRYSPECIES, ".\n\nThey can be sheared for ", ELEMENTS.IRONORE.NAME, ".");
		...
		public class SQUID
		{
			...
			public static LocString DESC = string.Concat("Glo Squids are carnivorous aquatic critters that eat ", TUBEWORM.NAME, " and excrete ", UI.FormatAsLink("Abyssalite", "KATAIRITE"), " .\n\nThey can be milked for ", ELEMENTS.INK.NAME, ".");
		...
		public class GEYSER
		{
			...
			public class SMALLREEFGEYSER
			{
				...
				public static LocString LIQUID_CONSUMPTION = "Draining {ElementTypes}: {FlowRate}";
			}
		...
		public class TUBEWORM
		{
			...
			public static LocString DESC = "Tublias are aquatic organisms that sprout in " + UI.FormatAsLink("Hot", "TEMPERATURE") + " liquid environments.\n\nThey can be harvested for " + UI.FormatAsLink("Plastic", "POLYPROPYLENE") + ".";
	...
	public class STATS
	{
		...
		public class SCALEGROWTH
		{
			...
			public static LocString IRON = "Scale Growth";
	...
	public class MODIFIERS
	{
		...
		public class CAVIAREXTRACTED
		{
			public static LocString NAME = "Caviar Extracted";

			public static LocString TOOLTIP = "This critter recently visited the caviar extractor";
		}
