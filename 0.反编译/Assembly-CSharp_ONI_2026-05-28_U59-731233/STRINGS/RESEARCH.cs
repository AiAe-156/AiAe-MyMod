...
public class RESEARCH
{
	...
	public class OTHER_TECH_ITEMS
	{
		...
		public class RUBBER_BOOTS
		{
			...
			public static LocString DESC = "Enables fabrication of " + UI.PRE_KEYWORD + "Rubber Boots" + UI.PST_KEYWORD + " at the " + BUILDINGS.PREFABS.CRAFTINGTABLE.NAME;
		}
		...
		public class PILOTINGBOOSTER
		{
			...
			public static LocString DESC = "Enables fabrication of " + UI.PRE_KEYWORD + "Rocketry Boosters" + UI.PST_KEYWORD + " for Bionic Duplicants at the " + BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME;
		}
