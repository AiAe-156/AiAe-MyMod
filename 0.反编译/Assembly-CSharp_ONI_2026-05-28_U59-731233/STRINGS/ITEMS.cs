...
public class ITEMS
{
	...
	public class FOOD
	{
		...
		{
			public static LocString NAME = UI.FormatAsLink("Pacu Treat", "FISHFOOD");

			public static LocString DESC = "A gourmet loaf of ground seeds and " + UI.FormatAsLink("Water", "WATER") + ", formulated to delight " + UI.FormatAsLink("Pacus", "PACU") + ".";
	...
	public class INDUSTRIAL_PRODUCTS
	{
		...
		{
			public static LocString NAME = UI.FormatAsLink("Plastic Gasket", "BUILDINGGASKET");
		...
		{
			public static LocString NAME = UI.FormatAsLink("Rubber Gasket", "BUILDINGGASKET");
