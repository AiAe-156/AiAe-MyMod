...
public class COLONY_ACHIEVEMENTS
{
	public class MISC_REQUIREMENTS
	{
		...
		public static LocString WINCONDITION_AQUATIC = "Finding Minnow";
	...
	public class FINDING_MINNOW
	{
		public class ACHIEVEMENTS
		{
			...
			public static LocString REQUIREMENT_NAME_A_HIDDEN = "Unknown Requirement";

			public static LocString REQUIREMENT_DESCRIPTION_A = "Delivered pearls to the survivor Duplicant";

			public static LocString REQUIREMENT_DESCRIPTION_A_HIDDEN = "Requirement will become visible once discovered";

			public static LocString REQUIREMENT_NAME_B = "Deliver {AMOUNT} Sushi Rolls";

			public static LocString REQUIREMENT_NAME_B_HIDDEN = "Unknown Requirement";

			public static LocString REQUIREMENT_DESCRIPTION_B = "Delivered sushi to the survivor Duplicant";

			public static LocString REQUIREMENT_DESCRIPTION_B_HIDDEN = "Requirement will become visible once discovered";

			public static LocString REQUIREMENT_NAME_C = "Deliver {AMOUNT} Squid Ink";

			public static LocString REQUIREMENT_NAME_C_HIDDEN = "Unknown Requirement";

			public static LocString REQUIREMENT_DESCRIPTION_C = "Delivered squid ink to the survivor Duplicant";

			public static LocString REQUIREMENT_DESCRIPTION_C_HIDDEN = "Requirement will become visible once discovered";
		}
		...
		public class POPUPS
		{
			...
			public static LocString POPUP_START_POI_A_DESCRIPTION = "My Duplicants found the survivor exploring the Reef biome. She seems fascinated by the Clampum, and offered to trade us [AMOUNT1] gasket for [AMOUNT2] of its pearls.\n\nI must enable delivery to ensure we keep our end of this bargain.";
			...
			public static LocString POPUP_START_POI_B_DESCRIPTION = "My Duplicants found the survivor exploring the Kelp Forest biome. She appears to be hungry. My Duplicants offered to exchange [AMOUNT1] sushi rolls for [AMOUNT2] gasket, and she agreed.\n\nI must enable delivery to ensure she receives our package.";
			...
			public static LocString POPUP_COMPLETE_POI_C_TITLE = "RECRUIT SURVIVOR: Squid Ink Delivered";
		...
		public static LocString NAME = "Finding Minnow";
