...
public class Cluster
{
	...
	public WorldGenStatus Status { get; private set; } = WorldGenStatus.NotStarted;

	public bool HasGenerationStopped => Status == WorldGenStatus.Failed || Status == WorldGenStatus.Complete;
	...
	private void BeginGeneration()
	{
		...
		list.Sort(delegate(WorldGen a, WorldGen b)
		{
			...
			return (distance != distance2) ? ((distance >= distance2) ? 1 : (-1)) : 0;
		});
