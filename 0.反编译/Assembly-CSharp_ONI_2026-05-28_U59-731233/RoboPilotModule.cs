...
public class RoboPilotModule : KMonoBehaviour
{
	...
	public bool consumeDataBanksOnLand = false;
	...
	protected override void OnSpawn()
	{
		...
		else
		{
			...
			launchConditionManager.Subscribe(929158128, RequestDataBanksForDestination);
		}
	...
	protected override void OnCleanUp()
	{
		...
		else
		{
			...
			LaunchConditionManager launchConditionManager = GetComponent<RocketModule>().FindLaunchConditionManager();
			launchConditionManager.Unsubscribe(929158128, RequestDataBanksForDestination);
		}
		base.OnCleanUp();
	}
	...
	private void OnRocketLanded(object o)
	{
		if (consumeDataBanksOnLand)
		{
			...
			float amount = Math.Min(spacecraftDestination.OneBasedDistance * dataBankConsumption * 2, databankStorage.MassStored());
	...
	{
		return (databankStorage != null) ? databankStorage.UnitsStored() : 0f;
	}
