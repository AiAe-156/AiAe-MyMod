...
public class ForestTreeConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		StandardCropPlant standardCropPlant = gameObject.AddComponent<StandardCropPlant>();
		standardCropPlant.wiltsOnReadyToHarvest = true;
	...
	{
		ForestTreeSeedMonitor component = trunk_smi.GetComponent<ForestTreeSeedMonitor>();
		component.TryRollNewSeed();
	}

	public void TranslateOldBranchesToNewSystem(PlantBranchGrower.Instance smi)
	{
		BuddingTrunk component = smi.GetComponent<BuddingTrunk>();
		KPrefabID[] andForgetOldSerializedBranches = component.GetAndForgetOldSerializedBranches();
