...
public class BaseBeeHiveConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		InfoDescription component = gameObject.GetComponent<InfoDescription>();
		component.effect = STRINGS.BUILDINGS.PREFABS.BEEHIVE.EFFECT;
		...
		if (Sim.IsRadiationEnabled())
		{
			...
			BeehiveCalorieMonitor.Def def4 = gameObject.AddOrGetDef<BeehiveCalorieMonitor.Def>();
			def4.diet = diet;
