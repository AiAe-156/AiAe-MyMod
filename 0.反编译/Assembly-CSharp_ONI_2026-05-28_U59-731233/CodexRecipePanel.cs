...
public class CodexRecipePanel : CodexWidget<CodexRecipePanel>
{
	...
	private bool useFabricatorForTitle = false;
	...
	public override void Configure(GameObject contentGameObject, Transform displayPane, Dictionary<CodexTextStyle, TextStyleSetting> textStyles)
	{
		...
		else if (complexRecipe != null && Game.IsCorrectDlcActiveForCurrentSave(complexRecipe))
		{
	...
	private void ConfigureComplexRecipe()
	{
		...
		DebugUtil.DevAssert(complexRecipe.fabricators.Count > 0, "Codex assumes there is at most one fabricator per recipe, refactor if needed");
		string name = complexRecipe.fabricators[0].Name;
		...
		Tuple<Sprite, Color> uISprite3 = Def.GetUISprite(name);
