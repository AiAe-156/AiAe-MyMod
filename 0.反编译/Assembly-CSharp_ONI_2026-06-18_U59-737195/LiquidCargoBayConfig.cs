...
public class LiquidCargoBayConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("LiquidCargoBay", 5, 5, "rocket_storage_liquid_kanim", 1000, 60f, TUNING.BUILDINGS.ROCKETRY_MASS_KG.CARGO_MASS, new string[1] { SimHashes.Steel.ToString() }, 9999f, BuildLocationRule.BuildingAttachPoint, noise: NOISE_POLLUTION.NOISY.TIER2, decor: TUNING.BUILDINGS.DECOR.NONE);
