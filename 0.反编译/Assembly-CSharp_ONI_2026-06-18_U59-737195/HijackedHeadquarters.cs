...
public class HijackedHeadquarters : GameStateMachine<HijackedHeadquarters, HijackedHeadquarters.Instance, IStateMachineTarget, HijackedHeadquarters.Def>
{
	...
	public new class Instance : GameInstance, IUserControlledCapacity
	{
		...
		public void PrintSelectedEntity()
		{
			...
			GameObject obj = Util.KInstantiate(Assets.GetPrefab(PrinterceptorScreen.Instance.selectedEntityTag), Grid.CellToPosCCC(Grid.PosToCell(base.gameObject), Grid.SceneLayer.Creatures) + Vector3.up * 1.5f, Quaternion.identity);
		...
		public void ShowIntroNotification()
		{
			...
			EventInfoScreen.ShowPopup(EventInfoDataHelper.GenerateStoryTraitData(CODEX.STORY_TRAITS.HIJACK_HEADQUARTERS.BEGIN_POPUP.NAME, CODEX.STORY_TRAITS.HIJACK_HEADQUARTERS.BEGIN_POPUP.DESCRIPTION, CODEX.STORY_TRAITS.CLOSE_BUTTON, "printerceptordiscovered_kanim", EventInfoDataHelper.PopupType.BEGIN));
		}
