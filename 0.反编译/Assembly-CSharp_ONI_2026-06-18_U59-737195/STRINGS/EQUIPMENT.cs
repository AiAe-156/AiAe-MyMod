...
public class EQUIPMENT
{
	public class PREFABS
	{
		...
		public class RUBBERBOOTS
		{
			...
			public static LocString EFFECT_DLC3 = "Protects the wearer from " + UI.PRE_KEYWORD + "Soggy Feet" + UI.PST_KEYWORD + " and " + UI.PRE_KEYWORD + "Slippery" + UI.PST_KEYWORD + " floors.\n\nEnables Bionic Duplicants to cross small puddles without " + UI.PRE_KEYWORD + "Liquid Exposure" + UI.PST_KEYWORD + " damage.";

			public static LocString RECIPE_DESC = EFFECT;

			public static LocString RECIPE_DESC_DLC3 = EFFECT_DLC3;
		...
		public class DRYSUIT
		{
			...
			public static LocString RECIPE_DESC_DLC3 = "Protects the wearer from  " + UI.PRE_KEYWORD + "Soggy Feet" + UI.PST_KEYWORD + " and " + UI.PRE_KEYWORD + "Sopping Wet" + UI.PST_KEYWORD + " effects.\n\nEnables Bionic Duplicants to cross waist-deep pools without " + UI.PRE_KEYWORD + "Liquid Exposure" + UI.PST_KEYWORD + " damage.";
		}
