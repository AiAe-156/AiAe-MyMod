...
public class CODEX
{
	...
	public class STORY_TRAITS
	{
		...
		public class HIJACK_HEADQUARTERS
		{
			...
			public class UNLOCK_POPUP
			{
				...
				public static LocString DESCRIPTION = string.Concat("My Duplicants have recovered the access code to unlock the ", HIJACK_HEADQUARTERS.NAME, "!\n\nThe data storage medium was damaged during retrieval, but it has already served its purpose: the ", HIJACK_HEADQUARTERS.NAME, "'s targeted printing technology is now at my colony's fingertips.");
	...
	public class POLLINATORS
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Pollination is a symbiotic interaction between " + UI.FormatAsLink("Plants", "PLANTS") + " and certain " + UI.FormatAsLink("Critter", "CREATURES") + " species, which benefits plant growth.\n\nSome " + UI.FormatAsLink("Plants", "PLANTS") + " rely on pollinators in order to grow at all, while others receive a valuable acceleration to their natural growth speed.";
		}
	...
	public class MISC
	{
		public class TIP_ICON
		{
			...
			{
				public static LocString TOOLTIP = string.Concat("Skill Required\n\nDuplicants must possess the ", DUPLICANTS.ROLES.SENIOR_FARMER.NAME, " skill to salvage ", ITEMS.INDUSTRIAL_PRODUCTS.PLANT_FIBER.NAME, " during harvest");
			}
		}
	}
	...
	public class ROOM_REQUIREMENT_CLASS
	{
		...
		public class KITCHENREFRIGERATOR
		{
			...
			public static LocString DESCRIPTION = "Buildings that store perishable " + UI.FormatAsLink("Food", "FOOD") + " items at " + UI.FormatAsLink("temperatures", "HEAT") + " that to prevent spoilage.";
		...
		public class ORNAMENT
		{
			...
			public static LocString DESCRIPTION = string.Concat("Ornaments are items with exceptionally high ", UI.FormatAsLink("Decor", "DECOR"), ", and must be displayed on a ", BUILDINGS.PREFABS.ITEMPEDESTAL.NAME, " or ", BUILDINGS.PREFABS.SHELF.NAME, " in order to be counted toward a room's requirements.\n\nThey can be obtained through exploration, excavation, and study. Some are admired in their original form, while others can be reworked or crafted by ", UI.FormatAsLink("creative", "ARTING1"), " Duplicants.");
		...
		public class DININGTABLETYPE
		{
			...
			public static LocString ROOMSREQUIRING = "    • " + UI.FormatAsLink("Mess Hall", "MESSHALL") + "\n    • " + UI.FormatAsLink("Great Hall", "GREATHALL") + "\n    • " + UI.FormatAsLink("Banquet Hall", "GREATERHALL") + " (Communal Table)";
		}
	...
	public class FISHFOOD
	{
		public class BODY
		{
			...
			public static LocString CONTAINER2 = "A gourmet loaf of ground seeds and " + UI.FormatAsLink("Water", "WATER") + ", formulated to delight " + UI.FormatAsLink("Pacus", "PACUSPECIES") + ".";
		}
	...
	public class PARROTFISH
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("Beakons are highly sought-after by ichthyophiles due to their radiant bioluminescence and unusual habit of surfacing for ", UI.FormatAsLink("Oxygen", "OXYGEN"), ".\n\nThese brilliant critters enjoy the tickle of air in their gills, and are happiest cohabiting with bubbly ", CREATURES.SPECIES.OXYCORAL.NAME, " that provide abundant air pockets for their entertainment.\n\nSome ", CREATURES.FAMILY_PLURAL.PARROTFISHSPECIES, " have even been known to nap atop their preferred coral formation. Such sightings are extremely rare.");
		}
	...
	public class PUFFERFISH
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("Blowters are docile fish with a poorly developed gastrointestinal tract.\n\nThis species eats only ", UI.FormatAsLink("Waterweed", "SEALETTUCE"), " but lacks the digestive enzymes required to process the plant efficiently. Large amounts of excess ", ELEMENTS.OXYGEN.NAME, " build up in the critter's gut during digestion, resulting in chronic and extreme bloating.\n\nMarine explorers have learned to siphon ", ELEMENTS.OXYGEN.NAME, " from Blowters in an emergency. It's not clear who was the first to attempt this.");
		}
	...
	public class DEWDRIP
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "A crystallized blob of " + UI.FormatAsLink("Brackene", "MILK") + " from the " + UI.FormatAsLink("Dew Dripper", "DEWDRIPPERPLANT") + ".\n\nIt must be processed at the " + UI.FormatAsLink("Plant Pulverizer", "MILKPRESS") + " to release its contents.";
		}
	...
	public class GUMWOOD
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Gum Wood is a flexible type of " + UI.FormatAsLink("Wood", "WOODLOG") + " with the unique sap that can be used in the production of " + UI.FormatAsLink("Rubber", "RUBBER") + ".\n\nNote that it is not <i>made</i> of rubber, and thus will not bounce when thrown.";
		}
	...
	public class LUMBER
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Thick logs of " + UI.FormatAsLink("Wood", "WOOD") + " harvested from trees, " + UI.FormatAsLink("Oakshells", "CRABWOOD") + ", and other natural sources.\n\nWood is also used in the production of " + UI.FormatAsLink("Heat", "HEAT") + " and " + UI.FormatAsLink("Power", "POWER") + ". They are also a useful building material.";
		}
	...
	public class FARM_STATION_TOOLS
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("Micronutrient fertilizer is a specialized ", UI.FormatAsLink("Fertilizer", "FERTILIZER"), " produced at the ", UI.FormatAsLink("Farm Station", "FARMSTATION"), ".\n\nIt must be crafted by Duplicants with the ", DUPLICANTS.ROLES.FARMER.NAME, " Skill, and helps ", UI.FormatAsLink("Plants", "PLANTS"), " grow faster.");
		}
	...
	public class URCHIN
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Pinpoki are aquatic organisms grown in " + UI.FormatAsLink("Pinpokets", "URCHINPLANT") + ". They can be crushed to separate the " + UI.FormatAsLink("Diamond", "DIAMOND") + " spines from the edible " + UI.FormatAsLink("Uni", "URCHINMEAT") + " inside.\n\nThey can also be displayed whole as " + UI.FormatAsLink("Decor", "DECOR") + ".";
		}
	...
	public class ADVANCEDCURE
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("An extremely powerful medication created to treat severe ", UI.FormatAsLink("Diseases", "DISEASE"), ". ", ITEMS.PILLS.ADVANCEDCURE.NAME, " is very effective against ", UI.FormatAsLink("Zombie Spores", "ZOMBIESPORES"), ".\n\nMust be administered by a Duplicant with the ", DUPLICANTS.ROLES.SENIOR_MEDIC.NAME, " Skill.");
		}
	...
	public class BASICBOOSTER
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "A supplement that minorly reduces the chance of contracting a " + UI.PRE_KEYWORD + "Germ" + UI.PST_KEYWORD + "-based " + UI.FormatAsLink("Disease", "DISEASE") + ".\n\nMust be taken daily.";
		}
	...
	public class BASICCURE
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Duplicants can take this to cure themselves of minor " + UI.PRE_KEYWORD + "Germ" + UI.PST_KEYWORD + "-based " + UI.FormatAsLink("Diseases", "DISEASE") + ".\n\nCurative Tablets are very effective against " + UI.FormatAsLink("Food Poisoning", "FOODSICKNESS") + ".";
		}
	...
	public class INTERMEDIATEBOOSTER
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "A supplement that significantly reduces the chance of contracting a " + UI.PRE_KEYWORD + "Germ" + UI.PST_KEYWORD + "-based " + UI.FormatAsLink("Disease", "DISEASE") + ".\n\nMust be taken daily.";
		}
	...
	public class INTERMEDIATECURE
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("A doctor-administered cure for moderate ", UI.FormatAsLink("Diseases", "DISEASE"), ". ", ITEMS.PILLS.INTERMEDIATECURE.NAME, "s are very effective against ", UI.FormatAsLink("Slimelung", "SLIMESICKNESS"), ".\n\nMust be administered by a Duplicant with the ", DUPLICANTS.ROLES.MEDIC.NAME, " Skill.");
		}
	...
	public class ORNAMENT
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("Ornaments are decorative objects with which Duplicants enjoy sprucing up their colonies. They tend to be smaller than traditional artwork, and possess very high ", UI.FormatAsLink("Decor", "DECOR"), " value.\n\n", UI.FormatAsLink("Displayed Ornaments", "REQUIREMENTCLASSORNAMENT"), " exhibited atop a ", BUILDINGS.PREFABS.ITEMPEDESTAL.NAME, " or ", BUILDINGS.PREFABS.SHELF.NAME, " allow a colony to benefit from certain ", UI.FormatAsLink("Room", "ROOMS"), " bonuses.\n\n");
		}
	...
	public class SPACEARTIFACT
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("While out harvesting resources from space POIs, miners may discover rare artifacts that pique their interest.\n\nThese can be gathered and transported back to the colony using a rocket equipped with an ", BUILDINGS.PREFABS.ARTIFACTCARGOBAY.NAME, ".");
		}
	...
	public class SEATREE
	{
		public class BODY
		{
			public static LocString CONTAINER1 = string.Concat("This species of the Laminariales order is composed of vertical stems supported by structural vines. What appear to be leaves are actually ", CREATURES.FAMILY_PLURAL.SEAFAIRYSPECIES, ", aquatic critters that consume aeronutrients present in the Tower Kelp's hollow stalk.\n\nTower Kelp stalks that fail to attract these natural pressure regulators will collapse before reaching maturation.");
		}
	...
	public class SPINDLYGRUBFRUITPLANT
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Spindly Grubfruit Plants have leggy stems that limit the distribution of nutrients and enzymes to the fruit-bearing branch. This results in a reliable but relatively tasteless harvest.\n\nIntroducing the " + UI.FormatAsLink("Divergent", "DIVERGENTSPECIES") + " critter species to these plants enable them to develop into " + UI.FormatAsLink("Grubfruit Plants", "SUPERWORMPLANT") + " with stronger vascular systems and improved fruit.";
		}
	...
	public class DECORSYSTEM
	{
		...
		public static LocString PARAGRAPH_3 = "To learn more, watch " + UI.FormatAsLink("Video: Duplicant Morale", "VIDEOS13") + " and see " + UI.FormatAsLink("Tutorial: Stress Management", "MISCELLANEOUSTIPS2") + ".\n\n";
	}
	...
	public class EXOBASESDLC1
	{
		...
		public static LocString PARAGRAPH_2 = "To scan space and see nearby interstellar destinations a " + UI.FormatAsLink("Telescope", "CLUSTERTELESCOPE") + " must first be built on the surface of a Planetoid. Sending an " + UI.FormatAsLink("Orbital Data Collection Lab", "ORBITALRESEARCHCENTER") + " into orbit around a Planetoid, and having a " + UI.FormatAsLink("Cartographic Module", "SCANNERMODULE") + " attached to a rocket can also reveal places on a Starmap.\n\nAlways check engine fuel to determine if your rocket can reach its destination, keeping in mind that rockets can only land on Planetoids with a " + UI.FormatAsLink("Rocket Platform", "LAUNCHPAD") + " on it. Notably, some modules, like " + UI.FormatAsLink("Rover's Modules", "SCOUTMODULE") + " and " + UI.FormatAsLink("Trailblazer Modules", "PIONEERMODULE") + ", can be sent to the surface of a Planetoid from a rocket in orbit.\n\nIf a rocket runs out of fuel before it reaches a viable landing site, it will become stranded.";

		public static LocString HEADER_3 = "Crew Survival";

		public static LocString PARAGRAPH_3 = string.Concat("Rockets must be stocked with adequate ", UI.BUILDCATEGORIES.OXYGEN.NAME, " and ", UI.CODEX.CATEGORYNAMES.FOOD, " to sustain crew members for the entirety of the journey. Shelf-stable rations that do not require refrigeration should be prioritized as onboard space is limited.\n\nSpending extended periods confined to a rocket interior also takes a toll on ", UI.FormatAsLink("Morale", "MORALE"), ", which can be mitigated by providing a ", UI.FormatAsLink("Toilet", "REQUIREMENTCLASSTOILETTYPE"), " to prevent messes, choosing higher-", UI.FormatAsLink("Decor", "DECOR"), " furnishings, or dividing up the rocket's interior to benefit from ", UI.CODEX.CATEGORYNAMES.ROOMS, " bonuses.");

		public static LocString HEADER_4 = "Space Transport";

		public static LocString PARAGRAPH_4 = "Goods can be teleported between worlds with connected Supply Teleporters through " + UI.FormatAsLink("Gas", "ELEMENTS_GAS") + ", " + UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID") + ", and " + UI.FormatAsLink("Solid", "ELEMENTS_SOLID") + " conduits.\n\nPlanetoids not connected through Supply Teleporters can use rockets to transport goods, either by landing on a " + UI.FormatAsLink("Rocket Platform", "LAUNCHPAD") + " or a " + UI.FormatAsLink("Orbital Cargo Module", "ORBITALCARGOMODULE") + " deployed from a rocket in orbit. Additionally, the " + UI.FormatAsLink("Interplanetary Launcher", "RAILGUN") + " can send " + UI.FormatAsLink("Interplanetary Payloads", "RAILGUNPAYLOAD") + " full of goods through space but must be opened by a " + UI.FormatAsLink("Payload Opener", "RAILGUNPAYLOADOPENER") + ". A " + UI.FormatAsLink("Targeting Beacon", "LANDINGBEACON") + " can guide payloads and orbital modules to land at a specific location on a Planetoid surface.";

		public static LocString HEADER_5 = "Space Mining";

		public static LocString PARAGRAPH_5 = string.Concat("Retrieving resources from space requires mining a target mass using a rocket equipped with a ", BUILDINGS.PREFABS.NOSECONEHARVEST.NAME, ", then gathering the harvestable fragments with a cargo module designed for those materials. Cargo modules include ", BUILDINGS.PREFABS.SOLIDCARGOBAYSMALL.NAME, ", ", BUILDINGS.PREFABS.LIQUIDCARGOBAYCLUSTER.NAME, ", ", BUILDINGS.PREFABS.GASCARGOBAYSMALL.NAME, ", and more.\n\nFree-floating ", UI.FormatAsLink("Space Artifacts", "SPACEARTIFACT"), " and ", ITEMS.INDUSTRIAL_PRODUCTS.ORBITAL_RESEARCH_DATABANK.NAME, "s can be gathered with an ", BUILDINGS.PREFABS.ARTIFACTCARGOBAY.NAME, " or a ", BUILDINGS.PREFABS.RESEARCHCLUSTERMODULE.NAME, " respectively, no mining required.");
	}
	...
	public class GENETICS
	{
		...
		public static LocString PARAGRAPH_2 = "Once mutated seeds have been analyzed in the " + UI.FormatAsLink("Botanical Analyzer", "GENETICANALYSISSTATION") + ", they are ready to be planted. Continued exposure to naturally occurring radiation or a " + UI.FormatAsLink("Radiation Lamp", "RADIATIONLIGHT") + " is necessary to prevent wilting.\n\n";

		public static LocString HEADER_3 = "Critter Morphs";

		public static LocString PARAGRAPH_3 = "Variations within a " + UI.FormatAsLink("critter", "CREATURES") + " species is common, and while they may share some similarities, different members of a species produce different resources and have their own distinct preferences regarding habitats, environmental " + UI.FormatAsLink("Temperature", "HEAT") + ", and diet.\n\nSee the " + UI.FormatAsLink("Field Guide", "CREATURES::GUIDE") + " to learn more about caring for critters.";
	}
	...
	public class HEAT
	{
		...
		public static LocString PARAGRAPH_6 = "To learn more, watch " + UI.FormatAsLink("Video: Insulation", "VIDEOS17") + " and see the " + UI.FormatAsLink("Duplicant Temperature", "MISCELLANEOUSTIPS8") + " tutorial.\n\n";
	}
	...
	public class MORALE
	{
		...
		public static LocString PARAGRAPH_4 = "To learn more, watch " + UI.FormatAsLink("Video: Duplicant Morale", "VIDEOS13") + " and see " + UI.FormatAsLink("Tutorial: Stress Management", "MISCELLANEOUSTIPS2") + ".\n\n";
	}
	...
	public class RESEARCHDLC1
	{
		...
		public static LocString PARAGRAPH_3 = string.Concat("Advanced research tasks require special research stations to generate the proper kind of research points. These research stations often consume more advanced resources.\n\nUsing higher level research stations also requires Duplicants to have learned higher level research ", UI.FormatAsLink("skills", "ROLES"), ".\n\n", STRINGS.RESEARCH.TYPES.ALPHA.NAME, " is performed at the ", BUILDINGS.PREFABS.RESEARCHCENTER.NAME, "\n", STRINGS.RESEARCH.TYPES.BETA.NAME, " is performed at the ", BUILDINGS.PREFABS.ADVANCEDRESEARCHCENTER.NAME, "\n", STRINGS.RESEARCH.TYPES.GAMMA.NAME, " is performed at the ", BUILDINGS.PREFABS.COSMICRESEARCHCENTER.NAME, "\n", STRINGS.RESEARCH.TYPES.DELTA.NAME, " is performed at the ", BUILDINGS.PREFABS.NUCLEARRESEARCHCENTER.NAME, "\n", STRINGS.RESEARCH.TYPES.ORBITAL.NAME, " is performed at the ", BUILDINGS.PREFABS.ORBITALRESEARCHCENTER.NAME, "\n\n");
	}
	...
	public class STRESS
	{
		...
		public static LocString PARAGRAPH_3 = "To learn more about managing Duplicants' moods, watch " + UI.FormatAsLink("Video: Duplicant Morale", "VIDEOS13") + " and see " + UI.FormatAsLink("Tutorial: Stress Management", "MISCELLANEOUSTIPS2") + ".\n\n";
	}
}
