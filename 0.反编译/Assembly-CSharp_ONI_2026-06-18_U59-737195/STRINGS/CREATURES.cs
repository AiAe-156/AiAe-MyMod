...
public class CREATURES
{
	...
	public class SPECIES
	{
		...
		public class CHAMELEON
		{
			...
			public static LocString DESC = "Dartles are non-hostile critters who eat " + UI.FormatAsLink("Dewdrips", "DEWDRIP") + " and excrete " + UI.FormatAsLink("Bleach Stone", "BLEACHSTONE") + " and " + UI.FormatAsLink("Chlorine Gas", "CHLORINEGAS") + ".\n\nThey are preyed on by " + UI.FormatAsLink("Rhexes", "RAPTOR") + ".";
		...
		public class MOSQUITO
		{
			...
			public static LocString DESC = "Gnits are hostile airborne critters primarily bred as food for the carnivorous " + UI.FormatAsLink("Lura Plants", "FLYTRAPPLANT") + " to produce " + UI.FormatAsLink("Amber", "AMBER") + ".\n\nTheir offspring must be exposed to " + UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID") + " in order to survive.";
		...
		public class PACU
		{
			...
			public class VARIANT_CLEANER
			{
				...
				public static LocString DESC = string.Concat("Gulp Fishes are aquatic critters who inhabit cold liquid pools.\n\nTheir gills filter ", ELEMENTS.DIRTYWATER.NAME, " into ", ELEMENTS.WATER.NAME, ".");
			...
			public static LocString DESC = "Pacus are aquatic creatures that can live in any liquid, such as " + UI.FormatAsLink("Water", "WATER") + " or " + UI.FormatAsLink("Polluted Water", "DIRTYWATER") + ".\n\nEvery organism in the known universe finds the Pacu extremely delicious.";
		...
		public class PARROTFISH
		{
			...
			public static LocString DESC = string.Concat("Beakons are aquatic critters who feast on ", UI.FormatAsLink("Phosphorite", "PHOSPHORITE"), " and ", UI.FormatAsLink("Starnacle", "PLANKTONCORAL"), ", and excrete ", ELEMENTS.LIME.NAME, ".\n\nThey produce ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", and enjoy consuming ", UI.FormatAsLink("Oxygen", "OXYGEN"), ".");
		...
		public class PUFFERFISH
		{
			...
			public static LocString DESC = "Blowters are aquatic critters who produce " + UI.FormatAsLink("Oxygen", "OXYGEN") + " after eating leaves from " + UI.FormatAsLink("Waterweed", "SEALETTUCE") + " plants.";
		...
		public class SNAIL
		{
			...
			public static LocString DESC = "Slogos are nonhostile critters that consume " + UI.FormatAsLink("Salt", "SALT") + " and excrete " + UI.FormatAsLink("Dirt", "DIRT") + ".\n\nThe shells they leave behind after molting can be crushed into " + UI.FormatAsLink("Lime", "LIME") + ".\n\nThey also leave large amounts of " + UI.FormatAsLink("Mucin", "MUCUS") + " in their wake.";
		...
		public class HATCH
		{
			...
			public class VARIANT_METAL
			{
				...
				public static LocString DESC = "Smooth Hatches enjoy burrowing into the ground and excrete " + UI.FormatAsLink("Refined Metal", "REFINEDMETAL") + " when fed " + UI.FormatAsLink("Metal Ore", "METAL") + ".";
		...
		public class WOODDEER
		{
			...
			public static LocString DESC = "Floxes are nonhostile critters that graze on " + UI.FormatAsLink("Bristle Blossoms", "PRICKLEFLOWER") + " and " + UI.FormatAsLink("Pikeapples", "HARDSKINBERRY") + ".\n\nWhen Flox antlers are fully grown, they harden into shearable " + UI.FormatAsLink("Wood", "WOOD") + ".";
		...
		public class GLASSDEER
		{
			...
			public static LocString DESC = string.Concat("Shatter Floxes are nonhostile critters that can subsist on ", PRICKLEFLOWER.NAME, " and ", HARDSKINBERRYPLANT.NAME, ".\n\nTheir shearable ", UI.FormatAsLink("Glass", "GLASS"), " antlers grow only when they are fed ", ELEMENTS.KATAIRITE.NAME, ".");
		...
		public class ICEBELLY
		{
			...
			public class VARIANT_GOLD
			{
				...
				public static LocString DESC = "Regal Bammoths are nonhostile creatures that subsist on " + UI.FormatAsLink("Plume Squash", "CARROT") + " and " + UI.FormatAsLink("Nosh Beans", "BEANPLANTSEED") + ".\n\nTheir ornate crests grow only when they are fed " + UI.FormatAsLink("Squash Fries", "FRIESCARROT") + ".";
			...
			public static LocString DESC = string.Concat("Bammoths are lumbering, nonhostile creatures that subsist on ", UI.FormatAsLink("Plume Squash", "CARROT"), ", ", UI.FormatAsLink("Nosh Beans", "BEANPLANTSEED"), " and ", UI.FormatAsLink("Squash Fries", "FRIESCARROT"), ".\n\nTheir thick overcoats can be shorn for ", ITEMS.INDUSTRIAL_PRODUCTS.BASIC_FABRIC.NAME, ".");
		...
		public class SEAL
		{
			...
			public static LocString DESC = string.Concat("Spigot Seals are charismatic creatures who produce ", UI.FormatAsLink("Ethanol", "ETHANOL"), ".\n\nThey eat ", UI.FormatAsLink("Sucrose", "SUCROSE"), ", and drink ", ELEMENTS.SUGARWATER.NAME, " straight from the ", UI.FormatAsLink("Bonbon Tree", "SPACETREE"), ".");
		...
		public class DIESELMOO
		{
			...
			public static LocString DESC = string.Concat("Husky Moos are extraterrestrial critters that feed on ", ITEMS.INDUSTRIAL_PRODUCTS.PLANT_FIBER.NAME, " and ", GASGRASS.NAME, ", and excrete ", ELEMENTS.CARBONDIOXIDE.NAME, ".\n\nWhen domesticated and fed, they can be milked for ", ELEMENTS.REFINEDLIPID.NAME, ".");
		}
		...
		public class LIGHTBUG
		{
			...
			public class VARIANT_ORANGE
			{
				...
				public static LocString DESC = string.Concat("Sun Bugs emit a soft orange ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_PURPLE
			{
				...
				public static LocString DESC = string.Concat("Royal Bugs emit a soft purple ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_PINK
			{
				...
				public static LocString DESC = string.Concat("Coral Bugs emit a soft pink ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_BLUE
			{
				...
				public static LocString DESC = string.Concat("Azure Bugs emit a soft blue ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_BLACK
			{
				...
				public static LocString DESC = string.Concat("This Shine Bug emits no ", UI.FormatAsLink("Light", "LIGHT"), ", but it makes up for it by having an excellent personality.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public class VARIANT_CRYSTAL
			{
				...
				public static LocString DESC = string.Concat("Radiant Bugs emit an extra-bright ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
			...
			public static LocString DESC = string.Concat("Shine Bugs emit a soft ", UI.FormatAsLink("Light", "LIGHT"), " when ", UI.FormatAsLink("Happy", "CREATURES::GUIDE::MOOD"), ", in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of ", ELEMENTS.NATURALRESIN.NAME, " that can be harvested when cracked at the ", BUILDINGS.PREFABS.EGGCRACKER.NAME, ".");
		...
		public class RAPTOR
		{
			...
			public static LocString DESC = "Rhexes are carnivorous critters that feed on smaller " + UI.FormatAsLink("Critters", "CREATURES") + " and produce " + UI.FormatAsLink("Brine Ice", "BRINEICE") + ".\n\nTheir tailfeathers can be shorn for " + UI.FormatAsLink("Feather Fiber", "FEATHER_FABRIC") + ".";
		...
		public class PREHISTORICPACU
		{
			...
			public static LocString DESC = "Jawbos are carnivorous aquatic critters that feed on " + UI.FormatAsLink("Pacus", "PACU") + " and produce " + UI.FormatAsLink("Rust", "RUST") + ".\n\nThey pose no danger to Duplicants.";
		...
		public class ALGAE_STEGO
		{
			...
			public static LocString DESC = "Blum Lumbs are non-hostile critters that produce " + UI.FormatAsLink("Algae", "ALGAE") + ".\n\nWhen they stomp heavily near " + UI.FormatAsLink("plants", "PLANTS") + ", the commotion causes harvestable items to fall to the ground.";
		...
		public class BUTTERFLY
		{
			...
			public static LocString DESC = string.Concat("Mimikas are airborne organisms that help nearby ", UI.FormatAsLink("Plants", "PLANTS"), " grow more quickly.\n\nWhen its leaves dry up, it will harden into ", SEEDS.BUTTERFLYPLANTSEED.NAME, ".");
		}
		...
		public class SEAFAIRY
		{
			...
			public static LocString DESC = string.Concat("Kelpoles are non-hostile aquatic critters that spawn along ", UI.FormatAsLink("Tower Kelp", "SEATREE"), " stalks.\n\nThey can be harvested for ", ITEMS.FOOD.NORI.NAME, ".");
		}
		...
		public class SEATURTLE
		{
			...
			public static LocString DESC = string.Concat("Orehulls are shy aquatic critters that eat ", FAMILY_PLURAL.SEAFAIRYSPECIES, " and excrete ", UI.FormatAsLink("Polluted Mud", "TOXICMUD"), ".\n\nThey can be sheared for ", ELEMENTS.IRONORE.NAME, ".");
		...
		public class SQUID
		{
			...
			public static LocString DESC = string.Concat("Glo Squids are nonhostile critters unless their eggs are nearby.\n\nThey eat ", TUBEWORM.NAME, " and excrete ", UI.FormatAsLink("Abyssalite", "KATAIRITE"), " .\n\nThey can be milked for ", ELEMENTS.INK.NAME, ".");
		...
		public class GEYSER
		{
			...
			public class UNDERWATERVENT
			{
				...
				public static LocString DESC = "A subaquatic fissure that allows high-pressure " + UI.FormatAsLink("Natural Gas", "METHANE") + " to escape from the planet's crust.\n\nBlockages caused by built-up " + UI.FormatAsLink("Sulfur", "SULFUR") + " can be removed using a " + UI.FormatAsLink("Marine Drill", "UNDERWATERVENTDRILL") + ".";
			}
		...
		public class URCHINPLANT
		{
			...
			public static LocString DESC = "Pinpokets produce " + UI.FormatAsLink("Pinpoki", "URCHIN") + ", which can be processed into " + UI.FormatAsLink("Uni", "URCHINMEAT") + " or " + UI.FormatAsLink("Diamond", "DIAMOND") + ".";
		...
		public class GASGRASS
		{
			...
			public static LocString DESC = string.Concat("Gas Grass is an alien lifeform tentatively categorized as a \"plant.\"\n\nIt can be harvested for ", ITEMS.INDUSTRIAL_PRODUCTS.PLANT_FIBER.NAME, " or eaten as-is by ", FAMILY_PLURAL.MOOSPECIES, ".");
		...
		public class BULBLOOM
		{
			...
			public static LocString DESC = "Bulblooms emit a bioluminescent " + UI.FormatAsLink("Light", "LIGHT") + " that enhances " + UI.FormatAsLink("Decor", "DECOR") + ".";

			public static LocString DOMESTICATEDDESC = "This plant improves ambient " + UI.FormatAsLink("Decor", "DECOR") + " and produces " + UI.FormatAsLink("Light", "LIGHT") + ".";
		...
		public class WATERCUPS
		{
			...
			public static LocString DESC = "Husha Cups are " + UI.FormatAsLink("Decorative", "DECOR") + " " + UI.FormatAsLink("Plants", "PLANTS") + " with a temper-cooling blue hue.\n\nTheir presence provides a " + UI.FormatAsLink("Morale", "MORALE") + "-boosting \"cup half-full\" energy.";
		...
		public class DEWDRIPPERPLANT
		{
			...
			public static LocString DESC = "Dew Drippers produce " + UI.FormatAsLink("Dewdrips", "DEWDRIP") + " that can be crushed into " + UI.FormatAsLink("Brackene", "MILK") + ".";

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ELEMENTS.MILK.NAME, ".");
		}
		...
		public class SALTYSTICKSPLANT
		{
			...
			public static LocString DESC = string.Concat("Sodicane produces ", ITEMS.FOOD.SALTYSTICKSFOOD.NAME, ", a sodium-rich ", UI.FormatAsLink("Food", "FOOD"), " that leaves Duplicants feeling quite parched.");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces edible ", ITEMS.FOOD.SALTYSTICKSFOOD.NAME, ".");
		}
		...
		public class DINOFERN
		{
			...
			public static LocString DESC = string.Concat("Megafronds produce ", ITEMS.FOOD.FERNFOOD.NAME, ", an ancient grain that can be processed into ", UI.FormatAsLink("Food", "FOOD"), ".");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ITEMS.FOOD.FERNFOOD.NAME, ".");
		}
		...
		public class OXYCORAL
		{
			...
			public static LocString DESC = string.Concat("Flue Corals are aquatic organisms that use ", UI.FormatAsLink("Light", "LIGHT"), " to produce ", ELEMENTS.OXYGEN.NAME, ".\n\nDue to their size, they can only be planted in a ", UI.FormatAsLink("Wide Hydroponic Farm", "WIDEFARMTILE"), ".");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ELEMENTS.OXYGEN.NAME, ".");
		}
		...
		public class PLANKTONCORAL
		{
			...
			public static LocString DESC = string.Concat("Starnacles are aquatic organisms that consume ", UI.FormatAsLink("Coquina", "COQUINA"), ".\n\n Its ", ITEMS.INDUSTRIAL_PRODUCTS.PLANKTON_CORAL_PRODUCT.NAME, " build-up can be consumed by ", UI.FormatAsLink("Beakons", "PARROTFISH"), " or harvested by Duplicants.");

			public static LocString DOMESTICATEDDESC = string.Concat("This coral produces ", ITEMS.INDUSTRIAL_PRODUCTS.PLANKTON_CORAL_PRODUCT.NAME, ".");
		...
		public class CLAM
		{
			...
			public static LocString DESC = string.Concat("Clampums are aquatic bivalves that transform ", ELEMENTS.SAND.NAME, " into ", ELEMENTS.PEARL.NAME, ".\n\nDue to their size, they can only be planted in a ", UI.FormatAsLink("Wide Hydroponic Farm", "WIDEFARMTILE"), ".");

			public static LocString DOMESTICATEDDESC = string.Concat("This organism produces ", ELEMENTS.PEARL.NAME, ".");
		}
		...
		public class TUBEWORM
		{
			...
			public static LocString DESC = "Tublias are aquatic organisms that sprout in " + UI.FormatAsLink("Hot", "HEAT") + " liquid environments.\n\nThey can be harvested for " + UI.FormatAsLink("Plastic", "POLYPROPYLENE") + ".";
		...
		public class DEWPALM
		{
			...
			public static LocString DESC = "Gum Palms can be harvested for " + UI.FormatAsLink("Gum Wood", "PALMWOOD") + ", which can be processed into " + UI.FormatAsLink("Latex", "LATEX") + " at the " + UI.FormatAsLink("Plant Pulverizer", "MILKPRESS") + ".\n\nDue to their size, they can only be planted in a " + UI.FormatAsLink("Wide Hydroponic Farm", "WIDEFARMTILE") + ".";
		...
		public class FILAMENTPLANT
		{
			...
			public static LocString DESC = "Petta Poufs are " + UI.FormatAsLink("Decorative", "DECOR") + " aquatic " + UI.FormatAsLink("Plants", "PLANTS") + ".\n\nThe gentle touch of their blooms soothes passing Duplicants' nerves.";
		...
		public class FLYTRAPPLANT
		{
			...
			public static LocString DESC = "Lura plants are carnivorous plants that trap flying critters, such as " + UI.FormatAsLink("Gnits", "MOSQUITO") + ".\n\nTheir digestive processes produce harvestable " + UI.FormatAsLink("Amber", "AMBER") + ".";

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ELEMENTS.NATURALRESIN.NAME, ".");
		...
		public class KELPPLANT
		{
			...
			public static LocString DESC = "Seakombs consume " + UI.FormatAsLink("Polluted Dirt", "TOXICSAND") + ".\n\nTheir leaves can be processed to extract " + UI.FormatAsLink("Phyto Oil", "PHYTOOIL") + ".";

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ITEMS.INGREDIENTS.KELP.NAME, ".");
		}
		...
		public class VINEMOTHER
		{
			...
			public static LocString DESC = "Ovagro Nodes are trellis plants that spread onto nearby available surfaces.\n\nA single " + UI.FormatAsLink("Ovagro Node", "VINEMOTHER") + " can support several " + UI.FormatAsLink("Ovagro Vines", "VINEMOTHER") + " without any increase in its " + UI.FormatAsLink("Water", "WATER") + " requirements.";

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ITEMS.FOOD.VINEFRUIT.NAME, ".");
		}
		...
		public class VINEBRANCH
		{
			...
			public static LocString DESC = "Ovagro Vines are plants that produce edible " + UI.FormatAsLink("Ovagro Fig", "VINEFRUIT") + ".\n\nIf a vine is cut off from its " + UI.FormatAsLink("Ovagro Node", "VINEMOTHER") + ", it will perish.";
		}
		...
		public class SEATREE
		{
			...
			public static LocString DESC = string.Concat("Tower Kelp is an aquatic plant that grows in temperate pools.\n\nIt can be harvested for ", ITEMS.FOOD.NORI.NAME, ".");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ITEMS.FOOD.NORI.NAME, ".");
		}
		...
		public class SEATREEBRANCH
		{
			...
			public static LocString DESC = string.Concat("These stalks are the individual shoots of the ", SEATREE.NAME, " plant.\n\nThey act as cross-species nurseries for ", UI.FormatAsLink("Kelpoles", "SEATREEFAIRY"), " that can be harvested for ", ITEMS.FOOD.NORI.NAME, ".");
		...
		public class SEAURCHIN
		{
			...
			public static LocString DESC = "Pinpoki grow in " + UI.FormatAsLink("Pinpokets", "URCHINPLANT") + ".\n\nThey can be harvested for " + UI.FormatAsLink("Uni", "URCHINMEAT") + " and " + UI.FormatAsLink("Diamond", "DIAMOND") + ".";

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ITEMS.FOOD.URCHINMEAT.NAME, ".");
		}
		...
		public class GARDENFOODPLANT
		{
			...
			public static LocString DESC = string.Concat("Sweatcorn Stalks produce ", ITEMS.FOOD.GARDENFOODPLANTFOOD.NAME, ", a crisp vegetable that can be harvested for ", UI.FormatAsLink("Food", "FOOD"), ".");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces edible ", ITEMS.FOOD.GARDENFOODPLANTFOOD.NAME, "s.");
		}
		...
		public class BUTTERFLYPLANT
		{
			...
			public static LocString DESC = string.Concat("Mimika Buds are self-harvesting plants that produce airborne ", UI.FormatAsLink("Mimikas", "BUTTERFLY"), ".\n\n", UI.FormatAsLink("Mimikas", "BUTTERFLY"), " boost growth for nearby ", UI.FormatAsLink("Plants", "PLANTS"), " before hardening into ", SEEDS.BUTTERFLYPLANTSEED.NAME, ".");
		...
		public class GARDENDECORPLANT
		{
			...
			public static LocString DESC = "Ring Rosebushes are " + UI.FormatAsLink("Decorative", "DECOR") + " " + UI.FormatAsLink("Plants", "PLANTS") + " that add a touch of whimsy wherever they are planted.";
		...
		public class SEEDS
		{
			public class VINEMOTHER
			{
				...
				public static LocString DESC = "The " + UI.FormatAsLink("Seed", "PLANTS") + " of an " + UI.FormatAsLink("Ovagro Node", "VINEMOTHER") + ".\n\nDigging up Buried Objects may uncover an Ovagro Node Seed.";
			}
			...
			public class SEATREE
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.SEATREE.NAME, ".\n\nDigging up Buried Objects may uncover a Tower Kelp Seed.");
			}
			...
			public class URCHINPLANT
			{
				...
				public static LocString DESC = "The " + UI.FormatAsLink("Seed", "PLANTS") + " of a " + UI.FormatAsLink("Pinpoket", "URCHINPLANT") + ".";
			}
			...
			public class DEWDRIPPERPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.DEWDRIPPERPLANT.NAME, " plant.");
			}
			...
			public class DINOFERN
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.DINOFERN.NAME, " plant.");
			}
			...
			public class OXYCORAL
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.OXYCORAL.NAME, ".");
			}
			...
			public class PLANKTONCORAL
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.PLANKTONCORAL.NAME, ".");
			}
			...
			public class CLAM
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.CLAM.NAME, ".");
			}
			...
			public class TUBEWORM
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.TUBEWORM.NAME, ".");
			}
			...
			public class SALTYSTICKSPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.SALTYSTICKSPLANT.NAME, " plant.");
			}
			...
			public class WATERCUPS
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.WATERCUPS.NAME, " plant.");
			}
			...
			public class DEWPALM
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.DEWPALM.NAME, " plant.");
			}
			...
			public class FILAMENTPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.FILAMENTPLANT.NAME, " plant.");
			}
			...
			public class BULBLOOM
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.BULBLOOM.NAME, ".\n\nDigging up Buried Objects may uncover a Bulbloom Seed.");
			}
			...
			public class FLYTRAPPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.FLYTRAPPLANT.NAME, ".\n\nDigging up Buried Objects may uncover a Lura Seed.");
			}
			...
			public class KELPPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.KELPPLANT.NAME, ".\n\nDigging up Buried Objects may uncover a Seakomb Seed.");
			}
			...
			public class GARDENFOODPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.GARDENFOODPLANT.NAME, ".\n\nDigging up Buried Objects may uncover a Sweatcorn Seed.");
			}
			...
			public class GARDENDECORPLANT
			{
				...
				public static LocString DESC = "The " + UI.FormatAsLink("Seed", "PLANTS") + " of a " + UI.FormatAsLink("Ring Rosebush", "GARDENDECORPLANT") + ".\n\nDigging up Buried Objects may uncover a Rosebush Seed.";
			}
			...
			public class SEAFAIRYPLANTSEED
			{
				...
				public static LocString DESC = string.Concat("An inedible ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.SEATREE.NAME, " plant.\n\nIt can be sown to cultivate more plants, or processed into ", UI.FormatAsLink("Food", "FOOD"), ".\n\nDigging up Buried Objects may uncover Tower Kelp Seed.");
			}
		}
	}
	...
	public class STATUSITEMS
	{
		...
		public class BUBBLEGASPRODUCTION
		{
			...
			public static LocString TOOLTIP = "This aquatic organism is generating a steady stream of " + UI.PRE_KEYWORD + "Gas" + UI.PST_KEYWORD + " bubbles";
		}
		...
		public class PUFFER_INFLATED
		{
			...
			public static LocString TOOLTIP = "This critter's recent meal caused " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " bloating\n\nIt will return to normal size after belching";
		}
		...
		public class PUFFER_VENTING
		{
			...
			public static LocString TOOLTIP = "This critter is releasing stored " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " into the surrounding environment\n\nWhat a relief";
		}
		...
		public class PUFFER_SHARING_AIR
		{
			...
			public static LocString TOOLTIP = "This critter is letting a Duplicant consume its stored " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + "\n\nIt will then return to normal size";
		}
		...
		public class SURFACE_AIR_CONSUMER_MOVING
		{
			...
			public static LocString TOOLTIP = "This critter is swimming toward the surface to consume " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " as a little treat";
		}
		...
		public class SURFACE_AIR_CONSUMER_CONSUMING
		{
			...
			public static LocString TOOLTIP = "This critter is consuming " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " at the surface of this pool\n\nWhat a delight";
		}
		...
		public class PUNCH_CLAM_APPROACH
		{
			...
			public static LocString TOOLTIP = "This critter is going to investigate a closed " + UI.PRE_KEYWORD + "Clampum" + UI.PST_KEYWORD + "\n\nWhat's that plant hiding?";
		}
		...
		public class PUNCH_CLAM_ATTACK
		{
			...
			public static LocString TOOLTIP = "This critter is attacking a closed " + UI.PRE_KEYWORD + "Clampum" + UI.PST_KEYWORD + "\n\nIt doesn't like things being hidden";
		}
		...
		public class AQUATICCREATURESUFFOCATING
		{
			...
			public static LocString TOOLTIP = "This critter cannot breathe outside of " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD + "!\n\nTime until death: {0}";
		}
		...
		public class FISHMILKFULL
		{
			...
			public static LocString TOOLTIP = "This critter is full of " + UI.PRE_KEYWORD + "Ovolene" + UI.PST_KEYWORD + " and ready to be milked";
		}
		...
		public class INKFULL
		{
			...
			public static LocString TOOLTIP = "This critter is full of " + UI.PRE_KEYWORD + "Squid Ink" + UI.PST_KEYWORD + " and ready to be milked";
		}
		...
		public class POLLINATING
		{
			...
			public class INTERACTING
			{
				...
				public static LocString TOOLTIP = "This critter's gentle ministrations are boosting this " + UI.PRE_KEYWORD + "Plant" + UI.PST_KEYWORD + "'s growth";
			}
		}
		...
		public class NOT_POLLINATED
		{
			...
			public static LocString TOOLTIP = "This plant must be tended by a pollinator " + UI.PRE_KEYWORD + "Critter" + UI.PST_KEYWORD + " in order to grow";
		}
		...
		public class DESICCATION
		{
			...
			public static LocString TOOLTIP = "This critter is unable to maintain adequate " + UI.PRE_KEYWORD + "Moisture" + UI.PST_KEYWORD + "\n\nIt will die in {0} unless it is submerged in " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD;
		}
	...
	public class STATS
	{
		...
		public class HAPPINESS
		{
			...
			public static LocString TOOLTIP_LUX = "High " + UI.PRE_KEYWORD + "Happiness" + UI.PST_KEYWORD + " increases a critter's productivity and enables them to produce " + UI.PRE_KEYWORD + "Light" + UI.PST_KEYWORD + "\n\nIt also indirectly improves their " + UI.PRE_KEYWORD + "Egg" + UI.PST_KEYWORD + " laying rates";
		}
		...
		public class BECKONING
		{
			...
			public static LocString TOOLTIP = "At 100% " + UI.PRE_KEYWORD + "Accu-moo-lation" + UI.PST_KEYWORD + ", this critter will call a friend to join them on this asteroid\n\nOnce the newcomer has landed, " + UI.PRE_KEYWORD + "Accu-moo-lation" + UI.PST_KEYWORD + " is rolled back to 0%";
		}
		...
		public class PHOTOSYNTHESIS
		{
			...
			public static LocString TOOLTIP = "This plant requires at least {LUX} of " + UI.PRE_KEYWORD + "Light" + UI.PST_KEYWORD + " to produce " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD;
		}
		...
		public class SCALEGROWTH
		{
			...
			{
				if (DISPLAYED_NAME_CACHED != null)
				{
					return DISPLAYED_NAME_CACHED;
				}
				DISPLAYED_NAME_CACHED = new Dictionary<Tag, LocString>
				{
					["Drecko"] = SCALE,
					["DreckoPlastic"] = SCALE,
					["WoodDeer"] = ANTLER,
			...
			{
				if (TOOLTIP_PREFIX_CACHED != null)
				{
					return TOOLTIP_PREFIX_CACHED;
				}
				TOOLTIP_PREFIX_CACHED = new Dictionary<Tag, LocString>
				{
					["Drecko"] = ITEMS.INDUSTRIAL_PRODUCTS.BASIC_FABRIC.NAME,
					["DreckoPlastic"] = ELEMENTS.POLYPROPYLENE.NAME,
					["WoodDeer"] = ITEMS.INDUSTRIAL_PRODUCTS.WOOD.NAME,
					["GlassDeer"] = ELEMENTS.GLASS.NAME.text,
					["IceBelly"] = ITEMS.INDUSTRIAL_PRODUCTS.BASIC_FABRIC.NAME,
					["GoldBelly"] = ELEMENTS.GOLD.NAME,
					["Raptor"] = ITEMS.INDUSTRIAL_PRODUCTS.FEATHER_FABRIC.NAME,
					["SeaTurtle"] = ELEMENTS.IRONORE.NAME
				};
				return TOOLTIP_PREFIX_CACHED;
			}
		}
		...
		public class MOISTURE
		{
			...
			public static LocString TOOLTIP = "At 0% " + UI.PRE_KEYWORD + "Moisture" + UI.PST_KEYWORD + ", this critter will die\n\nMoisture can be restored by submerging the critter in " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD;
		}
	...
	public class MODIFIERS
	{
		...
		public class HADMILK
		{
			...
			public static LocString TOOLTIP = "This critter recently drank " + UI.PRE_KEYWORD + "Brackene" + UI.PST_KEYWORD + " from a " + UI.PRE_KEYWORD + "Critter Fountain" + UI.PST_KEYWORD + "\n\nIt doesn't mind overcrowding quite as much right now";
		}
		...
		public class HADINK
		{
			...
			public static LocString TOOLTIP = "This critter recently drank " + UI.PRE_KEYWORD + "Squid Ink" + UI.PST_KEYWORD + " from a " + UI.PRE_KEYWORD + "Critter Fountain" + UI.PST_KEYWORD + "\n\nIt doesn't mind overcrowding quite as much right now";
		}
		...
		public class FISHFOOD
		{
			...
			public static LocString TOOLTIP = "This critter recently ate a " + UI.PRE_KEYWORD + "Pacu Treat" + UI.PST_KEYWORD + "\n\nDelicious!";
		}
		...
		public class JAWBOFOOD
		{
			...
			public static LocString TOOLTIP = "This critter recently ate " + UI.PRE_KEYWORD + "Cooked Seafood" + UI.PST_KEYWORD + "\n\nNom nom nom!";
		}
		...
		public class DUPE_MOSQUITO_BITE
		{
			...
			public static LocString TOOLTIP = "This Duplicant was recently stung by a " + UI.PRE_KEYWORD + "Gnit" + UI.PST_KEYWORD + " and is feeling annoyed";
		}
		...
		public class DUPE_MOSQUITO_BITE_SUPPRESSED
		{
			...
			public static LocString TOOLTIP = "This Duplicant is unbothered by their recent " + UI.PRE_KEYWORD + "Gnit" + UI.PST_KEYWORD + " sting, thanks to " + UI.PRE_KEYWORD + "Allergy Medication" + UI.PST_KEYWORD;
		}
		...
		public class CRITTER_MOSQUITO_BITE
		{
			...
			public static LocString TOOLTIP = "This critter was recently stung by a " + UI.PRE_KEYWORD + "Gnit" + UI.PST_KEYWORD + " and is feeling upset about it";
		}
		...
		public class CRITTER_MOSQUITO_BITE_SUPPRESSED
		{
			...
			public static LocString TOOLTIP = "This critter is unbothered by its recent " + UI.PRE_KEYWORD + "Gnit" + UI.PST_KEYWORD + " sting thanks to " + UI.PRE_KEYWORD + "Allergy Medication" + UI.PST_KEYWORD;
		}
		...
		public class OVERCROWDED
		{
			...
			public class CRAMPED
			{
				...
				public static LocString FISHTOOLTIP = "This " + UI.PRE_KEYWORD + "Pool" + UI.PST_KEYWORD + " will become too crowded once all nearby " + UI.PRE_KEYWORD + "Eggs" + UI.PST_KEYWORD + " hatch\n\nThe selected {contextCritterType} has slowed its " + UI.PRE_KEYWORD + "Reproduction" + UI.PST_KEYWORD + " to prevent further overpopulation";
			}
			...
			public class CROWDED
			{
				...
				public static LocString TOOLTIP = "This {contextCritterType} isn't comfortable with so many other critters in a " + UI.PRE_KEYWORD + "Room" + UI.PST_KEYWORD + " of this size\n{explanation}\n{bullets}";
		...
		public class BUTTERFLYPOLLINATED
		{
			...
			public static LocString TOOLTIP = string.Concat("A ", SPECIES.BUTTERFLY.NAME, " visited this ", UI.PRE_KEYWORD, "Plant", UI.PST_KEYWORD, ", boosting its growth");
		}
		...
		public class HUSKYMOOWELLFED
		{
			...
			public static LocString TOOLTIP = "This critter's recent meal is boosting their " + UI.PRE_KEYWORD + "Biodiesel" + UI.PST_KEYWORD + " supply";
		}
		...
		public class SQUIDWELLFED
		{
			...
			public static LocString TOOLTIP = "This critter's recent meal is boosting their " + UI.PRE_KEYWORD + "Ink" + UI.PST_KEYWORD + " production";
		}
		...
		public class GOLDBELLYWELLFED
		{
			...
			public static LocString TOOLTIP = "This critter's recent meal is boosting their " + UI.PRE_KEYWORD + "Regal Bammoth Crest" + UI.PST_KEYWORD + " growth";
		}
		...
		public class SEATURTLEWELLFED
		{
			...
			public static LocString TOOLTIP = "This critter's recent meal is boosting their " + UI.PRE_KEYWORD + "Iron Ore" + UI.PST_KEYWORD + " growth";
		}
		...
		public class SURFACEAIRCONSUMED
		{
			...
			public static LocString TOOLTIP = "This critter recently consumed " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " from the surface and is feeling invigorated";
		}
	...
	public class FERTILITY_MODIFIERS
	{
		...
		public class DECOR
		{
			...
			public static LocString DESC = "Dwells in an area with a " + UI.PRE_KEYWORD + "Decor" + UI.PST_KEYWORD + " value of {0} or higher";
		}
