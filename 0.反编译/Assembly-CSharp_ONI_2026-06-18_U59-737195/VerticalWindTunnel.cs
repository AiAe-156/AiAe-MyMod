...
public class VerticalWindTunnel : StateMachineComponent<VerticalWindTunnel.StatesInstance>, IGameObjectEffectDescriptor, ISim200ms
{
	...
	protected override void OnSpawn()
	{
		...
		for (int num = 0; num < workables.Length; num++)
		{
			...
			verticalWindTunnelWorkable.overrideAnim = overrideAnims[num];
			verticalWindTunnelWorkable.preAnims = workPreAnims[num];
			verticalWindTunnelWorkable.loopAnim = workAnims[num];
			verticalWindTunnelWorkable.pstAnims = workPstAnims[num];
			workables[num] = verticalWindTunnelWorkable;
			workables[num].windTunnel = this;
		}
		base.smi.StartSM();
	}
