...
public class GravitasCeilingLightConfig : IEntityConfig
{
	...
	{
		GameObject obj = EntityTemplates.CreatePlacedEntity("GravitasCeilingLight", STRINGS.BUILDINGS.PREFABS.PROPGRAVITASCEILINGLIGHT.NAME, STRINGS.BUILDINGS.PREFABS.PROPGRAVITASCEILINGLIGHT.DESC, 25f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_light2_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 1, height: 1, permittedRotation: PermittedRotations.Unrotatable, orientation: Orientation.Neutral, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
