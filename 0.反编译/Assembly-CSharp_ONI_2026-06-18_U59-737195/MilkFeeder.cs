...
public class MilkFeeder : GameStateMachine<MilkFeeder, MilkFeeder.Instance, IStateMachineTarget, MilkFeeder.Def>
{
	public class Def : BaseDef, IGameObjectEffectDescriptor
	{
		...
		public List<Descriptor> GetDescriptors(GameObject go)
		{
			...
			{
				_ = MilkFeederConfig.EffectsPerDrinkableLiquid[i].first;
	...
	public new class Instance : GameInstance
	{
		...
		{
			return milkStorage.FindFirstWithMass(base.def.elementProducedTag, base.def.unitsProducedPerFeeding) != null;
		}

		public Tag ConsumeMilkForOneFeeding()
		{
			Tag tag = milkStorage.FindFirstWithMass(base.def.elementProducedTag, base.def.unitsProducedPerFeeding).PrefabID();
