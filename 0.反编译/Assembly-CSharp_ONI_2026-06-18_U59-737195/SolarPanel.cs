...
public class SolarPanel : Generator
{
	...
	protected void OnActiveChanged(object data)
	{
		...
		selectable.SetStatusItem(Db.Get().StatusItemCategories.Power, status_item, this);
	}
	...
	private void UpdateStatusItem()
	{
		...
		{
			selectable.ReplaceStatusItem(statusHandle, Db.Get().BuildingStatusItems.SolarPanelWattage, this);
		}
	}
	...
	public override void EnergySim200ms(float dt)
	{
		...
		if (operational.IsOperational)
		{
			...
			{
				int num2 = Grid.LightIntensity[Grid.OffsetCell(cachedCell, offset)];
