...
public class ClamConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		gameObject.GetComponent<UprootedMonitor>().monitorCells = new CellOffset[3]
		{
			new CellOffset(0, -1),
			new CellOffset(-1, -1),
			new CellOffset(1, -1)
	...
	{
		prefab.GetComponent<StandardCropPlant>().anims = CROP_PLANT_DEFAULT_ANIM_SET;
	}
