...
public class LogicCircuitNetwork : UtilityNetwork
{
	...
	public List<ILogicEventSender> Senders => senders;

	public List<ILogicEventReceiver> Receivers => receivers;
	...
	public void UpdateOverloadTime(float dt, int bits_used)
	{
		...
		if (flag)
		{
			...
			if (targetOverloadedWire != null)
			{
				targetOverloadedWire.BoxingTrigger(-794517298, new BuildingHP.DamageSourceInfo
				{
					damage = 1,
