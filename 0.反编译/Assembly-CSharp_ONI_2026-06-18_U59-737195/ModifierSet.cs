...
public class ModifierSet : ScriptableObject
{
	...
	private void LoadEffects()
	{
		...
		Effect effect3 = new Effect("GunkSick", DUPLICANTS.MODIFIERS.GUNKSICK.NAME, DUPLICANTS.MODIFIERS.GUNKSICK.TOOLTIP, 0f, show_in_ui: true, trigger_floating_text: true, is_bad: true);
		effect3.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, 1f / 30f, DUPLICANTS.MODIFIERS.GUNKSICK.NAME));
		effects.Add(effect3);
		Effect effect4 = new Effect("ExpellingGunk", DUPLICANTS.MODIFIERS.EXPELLINGGUNK.NAME, DUPLICANTS.MODIFIERS.EXPELLINGGUNK.TOOLTIP, 0f, show_in_ui: true, trigger_floating_text: true, is_bad: true);
		effect4.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, 1f / 12f, DUPLICANTS.MODIFIERS.GUNKSICK.NAME));
		effects.Add(effect4);
		Effect effect5 = new Effect("GunkHungover", DUPLICANTS.MODIFIERS.GUNKHUNGOVER.NAME, DUPLICANTS.MODIFIERS.GUNKHUNGOVER.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: false, is_bad: true);
		effect5.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, 1f / 30f, DUPLICANTS.MODIFIERS.GUNKHUNGOVER.NAME));
		effects.Add(effect5);
		Effect effect6 = new Effect("NoLubricationMinor", DUPLICANTS.MODIFIERS.NOLUBRICATIONMINOR.NAME, DUPLICANTS.MODIFIERS.NOLUBRICATIONMINOR.TOOLTIP, 0f, show_in_ui: true, trigger_floating_text: true, is_bad: true);
		effect6.Add(new AttributeModifier(Db.Get().Attributes.Athletics.Id, -4f, DUPLICANTS.MODIFIERS.NOLUBRICATIONMINOR.NAME));
		effect6.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, 0.025f, DUPLICANTS.MODIFIERS.NOLUBRICATIONMINOR.NAME));
		effects.Add(effect6);
		Effect effect7 = new Effect("NoLubricationMajor", DUPLICANTS.MODIFIERS.NOLUBRICATIONMAJOR.NAME, DUPLICANTS.MODIFIERS.NOLUBRICATIONMAJOR.TOOLTIP, 0f, show_in_ui: true, trigger_floating_text: true, is_bad: true);
		effect7.Add(new AttributeModifier(Db.Get().Attributes.Athletics.Id, -8f, DUPLICANTS.MODIFIERS.NOLUBRICATIONMAJOR.NAME));
		effect7.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, 0.05f, DUPLICANTS.MODIFIERS.NOLUBRICATIONMINOR.NAME));
		effects.Add(effect7);
		Effect effect8 = new Effect("BionicOffline", DUPLICANTS.MODIFIERS.BIONICOFFLINE.NAME, DUPLICANTS.MODIFIERS.BIONICOFFLINE.TOOLTIP, 0f, show_in_ui: false, trigger_floating_text: true, is_bad: true);
		effect8.Add(new AttributeModifier(Db.Get().Amounts.BionicOil.deltaAttribute.Id, 0f, DUPLICANTS.MODIFIERS.BIONICOFFLINE.NAME));
		effects.Add(effect8);
		Effect effect9 = new Effect("BionicBedTimeEffect", DUPLICANTS.MODIFIERS.BIONICBEDTIMEEFFECT.NAME, DUPLICANTS.MODIFIERS.BIONICBEDTIMEEFFECT.TOOLTIP, 0f, show_in_ui: false, trigger_floating_text: false, is_bad: false);
		effect9.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, -1f / 30f, DUPLICANTS.MODIFIERS.BIONICBEDTIMEEFFECT.NAME));
		effects.Add(effect9);
		Effect effect10 = new Effect("BionicWaterStress", DUPLICANTS.MODIFIERS.BIONICWATERSTRESS.NAME, DUPLICANTS.MODIFIERS.BIONICWATERSTRESS.TOOLTIP, 0f, show_in_ui: true, trigger_floating_text: true, is_bad: true);
		effect10.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, 1f / 3f, DUPLICANTS.MODIFIERS.BIONICWATERSTRESS.NAME));
		...
		Effect effect11 = new Effect("DuplicantDrankInk", DUPLICANTS.MODIFIERS.DUPLICANTDRANKINK.NAME, DUPLICANTS.MODIFIERS.DUPLICANTDRANKINK.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect11.Add(new AttributeModifier(Db.Get().Amounts.Stress.deltaAttribute.Id, -1f / 60f, DUPLICANTS.MODIFIERS.DUPLICANTDRANKINK.NAME));
		effect11.Add(new AttributeModifier(Db.Get().Attributes.QualityOfLife.Id, 1f, DUPLICANTS.MODIFIERS.DUPLICANTDRANKINK.NAME));
		if (DlcManager.IsExpansion1Active())
		{
			effect11.Add(new AttributeModifier(Db.Get().Attributes.RadiationResistance.Id, 0.2f, DUPLICANTS.MODIFIERS.DUPLICANTDRANKINK.NAME));
		}
	...
	public void CreateCritteEffects()
	{
		...
		effect4.Add(new AttributeModifier(Db.Get().Amounts.Wildness.deltaAttribute.Id, -1f / 60f, STRINGS.CREATURES.MODIFIERS.FISHFOOD.NAME));
		effects.Add(effect4);
		Effect effect5 = new Effect("AteWellPreparedJawboFood", STRINGS.CREATURES.MODIFIERS.JAWBOFOOD.NAME, STRINGS.CREATURES.MODIFIERS.JAWBOFOOD.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect5.Add(new AttributeModifier(Db.Get().CritterAttributes.Happiness.Id, 2f, STRINGS.CREATURES.MODIFIERS.JAWBOFOOD.NAME));
		effect5.Add(new AttributeModifier(Db.Get().Amounts.Wildness.deltaAttribute.Id, -1f / 60f, STRINGS.CREATURES.MODIFIERS.JAWBOFOOD.NAME));
		effects.Add(effect5);
		Effect effect6 = new Effect("EggSong", STRINGS.CREATURES.MODIFIERS.INCUBATOR_SONG.NAME, STRINGS.CREATURES.MODIFIERS.INCUBATOR_SONG.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: false, is_bad: false);
		effect6.Add(new AttributeModifier(Db.Get().Amounts.Incubation.deltaAttribute.Id, 4f, STRINGS.CREATURES.MODIFIERS.INCUBATOR_SONG.NAME, is_multiplier: true));
		effects.Add(effect6);
		Effect effect7 = new Effect("EggHug", STRINGS.CREATURES.MODIFIERS.EGGHUG.NAME, STRINGS.CREATURES.MODIFIERS.EGGHUG.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect7.Add(new AttributeModifier(Db.Get().Amounts.Incubation.deltaAttribute.Id, 1f, STRINGS.CREATURES.MODIFIERS.EGGHUG.NAME, is_multiplier: true));
		effects.Add(effect7);
		...
		effects.Add(resource);
		Effect effect8 = new Effect("DivergentCropTended", STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDED.NAME, STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDED.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect8.Add(new AttributeModifier(Db.Get().Amounts.Maturity.deltaAttribute.Id, 0.05f, STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDED.NAME, is_multiplier: true));
		effect8.Add(new AttributeModifier(Db.Get().Amounts.Maturity2.deltaAttribute.Id, 0.05f, STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDED.NAME, is_multiplier: true));
		effects.Add(effect8);
		Effect effect9 = new Effect("DivergentCropTendedWorm", STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDEDWORM.NAME, STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDEDWORM.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect9.Add(new AttributeModifier(Db.Get().Amounts.Maturity.deltaAttribute.Id, 0.5f, STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDEDWORM.NAME, is_multiplier: true));
		effect9.Add(new AttributeModifier(Db.Get().Amounts.Maturity2.deltaAttribute.Id, 0.5f, STRINGS.CREATURES.MODIFIERS.DIVERGENTPLANTTENDEDWORM.NAME, is_multiplier: true));
		effects.Add(effect9);
		Effect effect10 = new Effect("MooWellFed", STRINGS.CREATURES.MODIFIERS.MOOWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.MOOWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect10.Add(new AttributeModifier(Db.Get().Amounts.Beckoning.deltaAttribute.Id, MooTuning.WELLFED_EFFECT, STRINGS.CREATURES.MODIFIERS.MOOWELLFED.NAME));
		effect10.Add(new AttributeModifier(Db.Get().Amounts.MilkProduction.deltaAttribute.Id, MooTuning.MILK_PRODUCTION_PERCENTAGE_PER_SECOND, STRINGS.CREATURES.MODIFIERS.MOOWELLFED.NAME));
		effects.Add(effect10);
		Effect effect11 = new Effect("HuskyMooFed", STRINGS.CREATURES.MODIFIERS.HUSKYMOOFED.NAME, STRINGS.CREATURES.MODIFIERS.HUSKYMOOFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect11.Add(new AttributeModifier(Db.Get().Amounts.Beckoning.deltaAttribute.Id, MooTuning.WELLFED_EFFECT, STRINGS.CREATURES.MODIFIERS.HUSKYMOOFED.NAME));
		effects.Add(effect11);
		Effect effect12 = new Effect("HuskyMooWellFed", STRINGS.CREATURES.MODIFIERS.HUSKYMOOWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.HUSKYMOOWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		...
		Effect effect13 = new Effect("WoodDeerWellFed", STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.DEERWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect13.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 100f / (WoodDeerConfig.ANTLER_GROWTH_TIME_IN_CYCLES * 600f), () => GetScaleGrowthName("WoodDeer"), () => STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME));
		effects.Add(effect13);
		Effect effect14 = new Effect("SquidWellFed", STRINGS.CREATURES.MODIFIERS.SQUIDWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.SQUIDWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect14.Add(new AttributeModifier(Db.Get().Amounts.MilkProduction.deltaAttribute.Id, SquidTuning.INK_PRODUCTION_PERCENTAGE_PER_SECOND, STRINGS.CREATURES.MODIFIERS.SQUIDWELLFED.NAME));
		effects.Add(effect14);
		Effect effect15 = new Effect("GlassDeerWellFed", STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.DEERWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect15.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 1f / 36f, () => GetScaleGrowthName("GlassDeer"), () => STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME));
		effects.Add(effect15);
		Effect effect16 = new Effect("IceBellyWellFed", STRINGS.CREATURES.MODIFIERS.ICEBELLYWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.ICEBELLYWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect16.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 100f / (IceBellyConfig.SCALE_GROWTH_TIME_IN_CYCLES * 600f), () => GetScaleGrowthName("IceBelly"), () => STRINGS.CREATURES.MODIFIERS.ICEBELLYWELLFED.NAME));
		effects.Add(effect16);
		Effect effect17 = new Effect("GoldBellyWellFed", STRINGS.CREATURES.MODIFIERS.GOLDBELLYWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.GOLDBELLYWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect17.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 1f / 60f, () => GetScaleGrowthName("GoldBelly"), () => STRINGS.CREATURES.MODIFIERS.GOLDBELLYWELLFED.NAME));
		effects.Add(effect17);
		Effect effect18 = new Effect("SeaTurtleWellFed", STRINGS.CREATURES.MODIFIERS.SEATURTLEWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.SEATURTLEWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect18.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 100f / (SeaTurtleTuning.SCALE_GROWTH_TIME_IN_CYCLES * 600f), () => GetScaleGrowthName("SeaTurtle"), () => STRINGS.CREATURES.MODIFIERS.SEATURTLEWELLFED.NAME));
		effects.Add(effect18);
		Effect effect19 = new Effect("ButterflyPollinated", STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.NAME, STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.TOOLTIP, 600f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect19.Add(new AttributeModifier(Db.Get().Amounts.Maturity.deltaAttribute.Id, 0.25f, STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.NAME, is_multiplier: true));
		effect19.Add(new AttributeModifier(Db.Get().Amounts.Maturity2.deltaAttribute.Id, 0.25f, STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.NAME, is_multiplier: true));
		...
		effects.Add(resource2);
		Effect effect20 = new Effect("RaptorWellFed", STRINGS.CREATURES.MODIFIERS.RAPTORWELLFED.NAME, STRINGS.CREATURES.MODIFIERS.RAPTORWELLFED.TOOLTIP, 1f, show_in_ui: true, trigger_floating_text: true, is_bad: false);
		effect20.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 100f / (RaptorConfig.SCALE_GROWTH_TIME_IN_CYCLES * 600f), () => GetScaleGrowthName("Raptor"), () => STRINGS.CREATURES.MODIFIERS.RAPTORWELLFED.NAME));
		effects.Add(effect20);
		Effect effect21 = new Effect("PredatorFailedHunt", STRINGS.CREATURES.MODIFIERS.HUNT_FAILED.NAME, STRINGS.CREATURES.MODIFIERS.HUNT_FAILED.TOOLTIP, 45f, show_in_ui: true, trigger_floating_text: false, is_bad: true);
		effect21.tag = GameTags.Creatures.SuppressedDiet;
		effects.Add(effect21);
		...
		Effect resource4 = new Effect("RecentlyProducedLubricant", STRINGS.CREATURES.MODIFIERS.RECENTLYPRODUCEDLUBRICANT.NAME, STRINGS.CREATURES.MODIFIERS.RECENTLYPRODUCEDLUBRICANT.TOOLTIP, 10f, show_in_ui: false, trigger_floating_text: false, is_bad: false);
		effects.Add(resource4);
	}
