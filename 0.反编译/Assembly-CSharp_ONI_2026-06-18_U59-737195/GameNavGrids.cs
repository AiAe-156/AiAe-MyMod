...
public class GameNavGrids
{
	public class SwimValidator : NavTableValidator
	{
		...
		public override void UpdateCell(int cell, NavTable nav_table, CellOffset[] bounding_offsets)
		{
			...
			if (!flag && Grid.IsValidCell(cell2))
			{
				flag = (requireSubstantialLiquidAbove ? Grid.IsSubstantialLiquid(cell2) : Grid.IsLiquid(cell2));
			}
			bool is_valid = Grid.IsWorldValidCell(cell) && flag && IsSwimClear(cell, bounding_offsets);
		...
		private bool IsSwimClear(int cell, CellOffset[] bounding_offsets)
		{
			if (!largeSwimmer)
			{
				return IsClear(cell, bounding_offsets, is_dupe: false);
			}
			for (int i = 0; i < bounding_offsets.Length; i++)
			{
				CellOffset offset = bounding_offsets[i];
				int cell2 = Grid.OffsetCell(cell, offset);
				if (!Grid.IsWorldValidCell(cell2))
				{
					return false;
				}
				if (offset.x == 0 && !NavTableValidator.IsCellPassable(cell2, is_dupe: false))
				{
					return false;
				}
			}
	...
	public class DupeSwimValidator : NavTableValidator
	{
		...
		public override void UpdateCell(int cell, NavTable nav_table, CellOffset[] bounding_offsets)
		{
			bool flag = IsClear(cell, bounding_offsets, is_dupe: true);
			bool flag2 = Grid.IsSubstantialLiquid(cell, 0.1f);
			int cell2 = Grid.CellAbove(cell);
			bool flag3 = Grid.IsWorldValidCell(cell2) && Grid.IsLiquid(cell2);
			bool num = nav_table.IsValid(cell, NavType.Swim);
			bool flag4 = flag && (flag2 || (Grid.IsLiquid(cell) && flag3));
			nav_table.SetValid(cell, NavType.Swim, flag4);
			if (num == flag4)
			{
				return;
			}
			Grid.CellToXY(cell, out var x, out var y);
			int num2 = Grid.ClampX(x - 1);
			int num3 = Grid.ClampY(y - 2);
			int num4 = Grid.ClampX(x + 1);
			int num5 = Grid.ClampY(y + 2);
			for (int i = num3; i <= num5; i++)
			{
				for (int j = num2; j <= num4; j++)
				{
					onDirty(Grid.XYToCell(j, i));
				}
			}
		}
	...
	public GameNavGrids(Pathfinding pathfinding)
	{
		...
		WalkerGrid1x1NoJump = Create1x1NoJumpNavigation(pathfinding, "WalkerNavGrid1x1NoJump", new CellOffset[0]);
		...
		RobotFlyerGrid1x1 = CreateFlyerNavigation(pathfinding, "RobotFlyerGrid1x1", new CellOffset[1]
		{
			new CellOffset(0, 0)
		...
		SwimmerGrid = CreateSwimmerNavigation(pathfinding, "SwimmerNavGrid", new CellOffset[1]
		{
			new CellOffset(0, 0)
		});
		SwimmerGrid1x2 = CreateSwimmerNavigation1x2(pathfinding, "SwimmerNavGrid1x2", new CellOffset[2]
		{
			new CellOffset(0, 0),
			new CellOffset(0, 1)
		});
		SwimmerGrid2x2 = CreateLargeSwimmerNavigation(pathfinding, "SwimmerGrid2x2", new CellOffset[4]
		{
			new CellOffset(0, 0),
			new CellOffset(0, 1),
			new CellOffset(1, 0),
	...
	private void CreateDuplicantNavigation(Pathfinding pathfinding)
	{
		...
		NavGrid.Transition[] setA = new NavGrid.Transition[133]
		{
			...
			new NavGrid.Transition(NavType.Hover, NavType.Hover, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 8, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Hover, NavType.Hover, 0, 1, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 8, "hover_hover_0_1", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Hover, NavType.Hover, 0, -1, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 8, "hover_hover_0_-1", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Hover, NavType.Hover, 1, 1, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 9, "hover_hover_1_1", new CellOffset[0], new CellOffset[0], new NavOffset[2]
			{
				new NavOffset(NavType.Hover, 1, 0),
				new NavOffset(NavType.Hover, 0, 1)
			}, new NavOffset[0]),
			new NavGrid.Transition(NavType.Hover, NavType.Hover, 1, -1, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 9, "hover_hover_1_-1", new CellOffset[0], new CellOffset[0], new NavOffset[2]
			{
				new NavOffset(NavType.Hover, 1, 0),
				new NavOffset(NavType.Hover, 0, -1)
			}, new NavOffset[0]),
			new NavGrid.Transition(NavType.Floor, NavType.Hover, 1, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 8, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Floor, NavType.Hover, 0, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 8, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			...
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 8, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 0, 1, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 8, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 0, -1, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: false, 8, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "swim_swim_1_1_loop", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "swim_swim_1_-1_loop", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Floor, NavType.Swim, 1, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 11, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Floor, NavType.Swim, 1, -2, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 12, "", new CellOffset[3]
			{
				new CellOffset(1, 0),
				new CellOffset(1, -1),
				new CellOffset(1, -2)
			}, new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Floor, NavType.Swim, 0, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Floor, NavType.Swim, 1, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Floor, 0, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 17, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Floor, 0, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 17, "swim_floor_0_1", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Floor, 1, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 17, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Floor, 1, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 17, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Floor, 1, 2, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 22, "", new CellOffset[2]
			{
				new CellOffset(0, 1),
				new CellOffset(0, 2)
			}, new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Ladder, 0, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Ladder, 0, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Ladder, NavType.Swim, 0, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 10, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Ladder, NavType.Swim, 0, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 8, "ladder_swim_0_1", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Pole, 0, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 20, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Pole, 0, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 20, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Pole, NavType.Swim, 0, 0, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 20, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Pole, NavType.Swim, 0, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 20, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Tube, NavType.Swim, 0, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: false, 5, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0])
		};
		...
		DuplicantGrid = new NavGrid("MinionNavGrid", transitions, nav_type_data, bounding_offsets, new NavTableValidator[7]
		{
	...
	{
		NavGrid.Transition[] array = MirrorTransitions(new NavGrid.Transition[3]
		{
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: false, is_escape: true, 1, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true),
		...
		NavTableValidator[] validators = new FloorValidator[1]
		{
			new FloorValidator(is_dupe: false)
		};
		NavGrid navGrid = new NavGrid(id, array, nav_type_data, bounds, validators, 2, 3, array.Length);
	...
	private NavGrid CreateWalkerLargeNavigation(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets)
	{
		...
		{
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 1, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true, 1f, useOffsetX: true),
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 2, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: true, 1, "floor_floor_2_1", new CellOffset[4]
			{
				new CellOffset(1, 1),
				new CellOffset(1, 2),
				new CellOffset(2, 1),
			...
			}, new CellOffset[2]
			{
				new CellOffset(1, 0),
				new CellOffset(2, 0)
			}, new NavOffset[0], new NavOffset[0], critter: true, 1f, useOffsetX: true),
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 2, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: true, 1, "floor_floor_2_-1", new CellOffset[4]
			{
				new CellOffset(1, 0),
				new CellOffset(2, 0),
				new CellOffset(2, -1),
	...
	private void CreateFloaterNavigation(Pathfinding pathfinding)
	{
		...
		{
			new HoverValidator(),
			new SwimValidator(requireSubstantialLiquidAbove: true)
		}, 2, 3, 22);
	...
	private NavGrid CreateFlyerNavigation(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets, bool allow_door_traversal = false)
	{
		...
		{
			new FlyingValidator(exclude_floor: false, exclude_jet_suit_blockers: false, allow_door_traversal),
			new SwimValidator(requireSubstantialLiquidAbove: true)
		}, 2, 2, 16);
		pathfinding.AddNavGrid(navGrid);
		return navGrid;
	...
	private NavGrid CreateSwimmerNavigation(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets, bool use_x_offset = false)
	{
		...
		{
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: false, 1f, use_x_offset),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[2]
			{
				new CellOffset(1, 0),
				new CellOffset(0, 1)
			}, new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true, 1f, use_x_offset),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, -1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[2]
			{
				new CellOffset(1, 0),
				new CellOffset(0, -1)
		...
		NavGrid navGrid = new NavGrid(id, array, nav_type_data, bounding_offsets, new NavTableValidator[1]
		{
			new SwimValidator(requireSubstantialLiquidAbove: false)
		}, 1, 2, array.Length);
		pathfinding.AddNavGrid(navGrid);
		return navGrid;
	}
	...
	private NavGrid CreateSwimmerNavigation1x2(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets)
	{
		NavGrid.Transition[] transitions = new NavGrid.Transition[5]
		{
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[2]
			{
				new CellOffset(1, 0),
				new CellOffset(0, 1)
	...
	private NavGrid CreateLargeSwimmerNavigation(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets)
	{
		...
		{
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "", new CellOffset[4]
			{
				new CellOffset(1, 0),
				new CellOffset(1, 1),
				new CellOffset(2, 0),
			...
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[4]
			{
				new CellOffset(1, 1),
				new CellOffset(1, 2),
				new CellOffset(2, 1),
			...
			new NavGrid.Transition(NavType.Swim, NavType.Swim, -1, -1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[3]
			{
				new CellOffset(-1, 0),
				new CellOffset(0, -1),
				new CellOffset(-1, -1)
			}, new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 0, 1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 3, "swim_swim_1_0", new CellOffset[2]
			{
				new CellOffset(1, 1),
				new CellOffset(1, 2)
			}, new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true),
		...
		NavGrid navGrid = new NavGrid(id, transitions, nav_type_data, bounding_offsets, new NavTableValidator[1]
		{
			new SwimValidator(requireSubstantialLiquidAbove: true, large_swimmer: true)
		}, 2, 2, 16);
		pathfinding.AddNavGrid(navGrid);
		return navGrid;
	}
