...
public class EvilFlowerConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		string name = STRINGS.CREATURES.SPECIES.SEEDS.EVILFLOWER.NAME;
		string desc = STRINGS.CREATURES.SPECIES.SEEDS.EVILFLOWER.DESC;
		...
		EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, dlcRestrictions, SeedProducer.ProductionType.Hidden, "EvilFlowerSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 19, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.4f, 0.4f), "EvilFlower_preview", Assets.GetAnim("potted_evilflower_kanim"), "place", 1, 1);
