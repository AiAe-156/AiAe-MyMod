...
public class SpiceVineConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject template = EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, dlcRestrictions, SeedProducer.ProductionType.Harvest, "SpiceVineSeed", name2, desc2, anim2, "object", 1, additionalTags2, SingleEntityReceptacle.ReceptacleDirection.Bottom, default(Tag), 4, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f), "SpiceVine_preview", Assets.GetAnim("vinespicenut_kanim"), "place", 1, 3);
