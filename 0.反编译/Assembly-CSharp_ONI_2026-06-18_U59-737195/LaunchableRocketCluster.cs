		...
		public void SetupLaunch()
		{
			...
			foreach (Ref<RocketModuleCluster> part in base.master.parts)
			{
				if (part != null)
				{
					...
					part.Get().Trigger(-1277991738, (object)base.master.gameObject);
				}
			}
			CraftModuleInterface craftInterface = base.master.GetComponent<RocketModuleCluster>().CraftInterface;
			if (craftInterface != null)
			{
				craftInterface.Trigger(-1277991738, (object)base.master.gameObject);
				...
				if (component != null)
				{
					...
					{
						e.minionId = item;
						Game.Instance.Trigger(586301400, (object)e);
					}
				}
			}
			Game.Instance.Trigger(-1277991738, (object)base.gameObject);
