...
public class AdvancedResearchCenterConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("AdvancedResearchCenter", 3, 3, "research_center2_kanim", 30, 30f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER1, decor: TUNING.BUILDINGS.DECOR.NONE);
		...
		obj.AudioSize = "large";
		obj.RequiredSkillPerkID = Db.Get().SkillPerks.AllowAdvancedResearch.Id;
		obj.AddSearchTerms(SEARCH_TERMS.RESEARCH);
		return obj;
	}
