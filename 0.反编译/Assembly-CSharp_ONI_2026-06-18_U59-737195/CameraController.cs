...
public class CameraController : KMonoBehaviour, IInputHandler
{
	...
	public void CameraGoHome(float speed = 2f, bool showCameraReturnButton = false)
	{
		...
		{
			GameUtil.FocusCamera(new Vector3(activeTelepad.transform.GetPosition().x, activeTelepad.transform.GetPosition().y + 1f, base.transform.GetPosition().z), speed, playSound: true, showCameraReturnButton);
