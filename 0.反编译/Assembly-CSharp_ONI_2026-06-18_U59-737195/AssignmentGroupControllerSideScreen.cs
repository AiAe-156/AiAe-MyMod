...
public class AssignmentGroupControllerSideScreen : KScreen
{
	...
	private void RefreshRows()
	{
		...
		{
			int num3 = b.isSameWorld.CompareTo(a.isSameWorld);
			return (num3 != 0) ? num3 : b.isPilot.CompareTo(a.isPilot);
		});
		...
		for (int num2 = num; num2 < identityRowMap.Count; num2++)
		{
			identityRowMap[num2].SetActive(value: false);
		}
