...
public class DLC1CosmicResearchCenterConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("DLC1CosmicResearchCenter", 4, 4, "research_space_kanim", 30, 30f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER1, decor: TUNING.BUILDINGS.DECOR.NONE);
		...
		obj.AudioSize = "large";
		obj.RequiredSkillPerkID = Db.Get().SkillPerks.AllowOrbitalResearch.Id;
