...
public class DewPalmConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, null, SeedProducer.ProductionType.Harvest, sEED_ID, name2, desc2, anim2, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 3, domesticatedDescription, EntityTemplates.CollisionShape.CIRCLE, 0.33f, 0.33f), PREVIEW_ID, Assets.GetAnim("rubber_tree_kanim"), "place", 3, 4);
