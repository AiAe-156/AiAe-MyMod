...
public class ChameleonConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public static GameObject CreateChameleon(string id, string name, string desc, string anim_file, bool is_baby)
	{
		...
		Diet diet = new Diet(new Diet.Info(hashSet, POOP_ELEMENT, CALORIES_PER_DRIP_EATEN, KG_POOP_PER_DRIP));
	...
	{
		return EntityTemplates.ExtendEntityToFertileCreature(CreateChameleon("Chameleon", CREATURES.SPECIES.CHAMELEON.NAME, CREATURES.SPECIES.CHAMELEON.DESC, "chameleo_kanim", is_baby: false), this, "ChameleonEgg", CREATURES.SPECIES.CHAMELEON.EGG_NAME, CREATURES.SPECIES.CHAMELEON.DESC, "egg_chameleo_kanim", ChameleonTuning.EGG_MASS, "ChameleonBaby", 0.6f * (float)LIFESPAN, 0.2f * (float)LIFESPAN, ChameleonTuning.EGG_CHANCES_BASE, EGG_SORT_ORDER);
	}
