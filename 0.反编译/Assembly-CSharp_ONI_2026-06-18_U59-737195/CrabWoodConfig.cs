...
public class CrabWoodConfig : IEntityConfig
{
	...
	{
		GameObject prefab = EntityTemplates.ExtendEntityToWildCreature(BaseCrabConfig.BaseCrab(id, name, desc, anim_file, "CrabWoodBaseTrait", is_baby, animPrefix, deathDropIDs, deathDropCounts), CrabTuning.PEN_SIZE_PER_CREATURE);
