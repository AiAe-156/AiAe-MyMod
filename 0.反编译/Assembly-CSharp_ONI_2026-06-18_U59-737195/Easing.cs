...
public class Easing
{
	...
	public static readonly EasingFn ElasticIn = (float x) => (x != 0f) ? ((x != 1f) ? ((0f - Mathf.Pow(2f, 10f * x - 10f)) * Mathf.Sin((x * 10f - 10.75f) * (MathF.PI * 2f / 3f))) : 1f) : 0f;

	public static readonly EasingFn ElasticOut = (float x) => (x != 0f) ? ((x != 1f) ? (Mathf.Pow(2f, -10f * x) * Mathf.Sin((x * 10f - 0.75f) * (MathF.PI * 2f / 3f)) + 1f) : 1f) : 0f;

	public static readonly EasingFn ElasticInOut = (float x) => (x != 0f) ? ((x != 1f) ? ((!((double)x < 0.5)) ? (Mathf.Pow(2f, -20f * x + 10f) * Mathf.Sin((20f * x - 11.125f) * (MathF.PI * 4f / 9f)) / 2f + 1f) : ((0f - Mathf.Pow(2f, 20f * x - 10f) * Mathf.Sin((20f * x - 11.125f) * (MathF.PI * 4f / 9f))) / 2f)) : 1f) : 0f;
