...
public static class BaseRaptorConfig
{
	...
	{
		List<Diet.Info> obj = new List<Diet.Info>
		{
			new Diet.Info(new HashSet<Tag> { "DinosaurMeat", "Meat" }, RaptorTuning.POOP_ELEMENT, RaptorTuning.CALORIES_PER_UNIT_EATEN, RaptorTuning.BASE_PRODUCTION_RATE)
		};
		...
		obj.Add(new Diet.Info(hashSet, RaptorTuning.POOP_ELEMENT, RaptorTuning.CALORIES_PER_UNIT_EATEN, RaptorTuning.PREY_PRODUCTION_RATE, null, 0f, produce_solid_tile: false, Diet.Info.FoodType.EatButcheredPrey));
		return obj;
	}
