...
public class AttackableBase : Workable, IApproachable
{
	...
	public float GetDamageMultiplier()
	{
		...
		{
			AttributeConverterInstance attributeConverterInstance = base.worker.GetAttributeConverter(attributeConverter.Id);
			return Mathf.Max(1f + attributeConverterInstance.Evaluate(), 0.1f);
		}
		return 1f;
	}
