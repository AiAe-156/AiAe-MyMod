	...
	public void EmptyContents()
	{
		...
		if (conduitContents.mass > 0f && conduitContents.element != SimHashes.Vacuum)
		{
			(conduit.type switch
			{
				...
				_ => throw new ArgumentException(), 
			}).CreateChunk(conduitContents.element, conduitContents.mass, conduitContents.temperature, conduitContents.diseaseIdx, conduitContents.diseaseCount, Grid.CellToPosCCC(cell, Grid.SceneLayer.Ore)).Trigger(580035959, (object)base.worker);
		}
	}
