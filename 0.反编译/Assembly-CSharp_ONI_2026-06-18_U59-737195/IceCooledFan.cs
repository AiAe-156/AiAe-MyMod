...
public class IceCooledFan : StateMachineComponent<IceCooledFan.StatesInstance>
{
	...
	public class States : GameStateMachine<States, StatesInstance, IceCooledFan>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			workable.ToggleChore(CreateUseChore, SetRemoteChore, work_pst).EventTransition(GameHashes.ActiveChanged, workable.cooling, (StatesInstance smi) => smi.master.workable.worker != null).EventTransition(GameHashes.OperationalChanged, workable.cooling, (StatesInstance smi) => smi.master.workable.worker != null)
		...
		private static Chore CreateUseChore(StatesInstance smi)
		{
