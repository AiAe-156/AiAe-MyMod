...
public class ClusterDestinationSideScreen : SideScreenContent
{
	...
	public override bool IsValidForTarget(GameObject target)
	{
		...
		bool num = target.GetComponent<RocketModuleCluster>() != null && target.GetComponent<RocketModuleCluster>().GetComponent<PassengerRocketModule>() != null;
		bool flag2 = target.GetComponent<RocketModuleCluster>() != null && target.GetComponent<RocketModuleCluster>().GetComponent<RoboPilotModule>() != null;
		if (num || flag2)
		{
			return true;
		}
		bool flag3 = target.GetComponent<RocketControlStation>() != null && target.GetComponent<RocketControlStation>().GetMyWorld().GetComponent<Clustercraft>()
	...
	private void Refresh(object data = null)
	{
		...
		{
			bool num = targetRocketSelector != null && targetRocketSelector.Repeat && targetRocketSelector.PreviousDestination != AxialI.INVALID;
			string text = "";
			if (num)
			{
