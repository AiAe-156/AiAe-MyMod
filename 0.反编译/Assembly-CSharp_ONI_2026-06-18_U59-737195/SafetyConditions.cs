...
public class SafetyConditions
{
	...
	public SafetyConditions()
	{
		...
		HasSomeOxygen = new SafetyChecker.Condition("HasSomeOxygen", num *= 2, (int cell, int cost, SafetyChecker.Context context) => context.oxygenBreather == null || GasBreatherFromWorldProvider.GetBestBreathableCellAroundSpecificCell(cell, new CellOffset[2]
		{
			CellOffset.none,
			CellOffset.up
