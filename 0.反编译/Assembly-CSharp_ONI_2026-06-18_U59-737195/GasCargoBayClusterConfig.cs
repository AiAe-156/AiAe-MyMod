...
public class GasCargoBayClusterConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("GasCargoBayCluster", 5, 5, "rocket_cluster_storage_gas_kanim", 1000, 60f, TUNING.BUILDINGS.ROCKETRY_MASS_KG.DENSE_TIER2, new string[1] { SimHashes.Steel.ToString() }, 9999f, BuildLocationRule.Anywhere, noise: NOISE_POLLUTION.NOISY.TIER2, decor: TUNING.BUILDINGS.DECOR.NONE);
