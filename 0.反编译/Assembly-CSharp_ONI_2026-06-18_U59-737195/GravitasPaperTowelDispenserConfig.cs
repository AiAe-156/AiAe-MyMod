...
public class GravitasPaperTowelDispenserConfig : IEntityConfig
{
	...
	{
		GameObject obj = EntityTemplates.CreatePlacedEntity("GravitasPaperTowelDispenser", STRINGS.BUILDINGS.PREFABS.PROPGRAVITASPAPERTOLELDISPENSER.NAME, STRINGS.BUILDINGS.PREFABS.PROPGRAVITASPAPERTOLELDISPENSER.DESC, 50f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_paper_towell_dispenser_kanim"), initialAnim: "on", sceneLayer: Grid.SceneLayer.Building, width: 1, height: 1, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
