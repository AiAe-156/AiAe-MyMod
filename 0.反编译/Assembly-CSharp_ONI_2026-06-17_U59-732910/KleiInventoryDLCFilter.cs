...
public class KleiInventoryDLCFilter : KMonoBehaviour
{
	...
	{
		HierarchyReferences component = Util.KInstantiateUI(dlcFilterButtonPrefab, dlcFilterButtonContainer.gameObject, force_active: true).GetComponent<HierarchyReferences>();
