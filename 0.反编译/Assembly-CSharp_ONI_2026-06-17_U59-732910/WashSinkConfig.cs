...
public class WashSinkConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		go.GetComponent<KPrefabID>().prefabInitFn += OnInit;
	}
	...
	private void OnInit(GameObject go)
	{
		...
		component.workerTypeOverrideAnims.Add(BionicMinionConfig.ID, new KAnimFile[1] { Assets.GetAnim("anim_bionic_interacts_wash_sink_kanim") });
	}
