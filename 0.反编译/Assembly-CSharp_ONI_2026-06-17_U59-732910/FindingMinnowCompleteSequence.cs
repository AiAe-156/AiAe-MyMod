...
public static class FindingMinnowCompleteSequence
{
	...
	private static IEnumerator Sequence()
	{
		...
		screen.PlayVictoryLoop(Db.Get().ColonyAchievements.MinnowRecruited.messageBody, Db.Get().ColonyAchievements.MinnowRecruited.Id, Db.Get().ColonyAchievements.MinnowRecruited.loopVideoName, showAchievements: true, AudioMixerSnapshots.Get().VictoryCinematicSnapshot, fadeIn: true);
