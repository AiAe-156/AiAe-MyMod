...
public class EntityTemplates
{
	...
	public static GameObject ExtendEntityToFertileCreature(GameObject prefab, IHasDlcRestrictions dlcRestrictions, string eggId, string eggName, string eggDesc, string eggAnim, float eggMass, float eggShellRatio, string babyId, float fertilityCycles, float incubationCycles, List<FertilityMonitor.BreedingChance> eggChances, int eggSortOrder, bool is_ranchable, bool add_fish_overcrowding_monitor, float egg_anim_scale, bool deprecated, bool preventEggFromDroppingProducts, float eggMassToDrop, bool allowEggCrackerRecipeCreation = true)
	{
		...
		GameObject gameObject = EggConfig.CreateEgg(base_incubation_rate: 100f / (600f * incubationCycles), requiredDlcIds: DlcRestrictionsUtil.GetRequiredDlcsOrNull(dlcRestrictions), forbiddenDlcIds: DlcRestrictionsUtil.GetForbiddenDlcIdsOrNull(dlcRestrictions), id: eggId, name: eggName, desc: eggDesc, creature_id: babyId, anim: eggAnim, mass: eggMass, egg_sort_order: eggSortOrder, preventEggDrops: preventEggFromDroppingProducts, eggMassToDrop: eggMassToDrop, customEggShellRatio: eggShellRatio, allowCrackerRecipeCreation: allowEggCrackerRecipeCreation);
