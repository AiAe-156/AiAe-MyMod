...
public class RescueSweepBotChore : Chore<RescueSweepBotChore.StatesInstance>
{
	...
	public class States : GameStateMachine<States, StatesInstance, RescueSweepBotChore>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			{
				if (rescuer.Get(smi).gameObject.HasTag(GameTags.BaseMinion))
				{
					...
					rescuer.Get(smi).GetComponent<KAnimControllerBase>().AddAnimOverrides(anim);
				}
	...
	public static Precondition CanReachBaseStation = new Precondition
	{
