...
public class UnitConfigurationScreen
{
	...
	private void OnCelsiusClicked()
	{
		...
		{
			Game.Instance.BoxingTrigger(999382396, GameUtil.TemperatureUnit.Celsius);
		}
	}
	...
	private void OnKelvinClicked()
	{
		...
		if (Game.Instance != null)
		{
			Game.Instance.BoxingTrigger(999382396, GameUtil.TemperatureUnit.Kelvin);
		}
	}
	...
	private void OnFahrenheitClicked()
	{
		...
		if (Game.Instance != null)
		{
			Game.Instance.BoxingTrigger(999382396, GameUtil.TemperatureUnit.Fahrenheit);
		}
	}
}
