...
public static class ArtifactSequence
{
	...
	private static IEnumerator Sequence()
	{
		...
		component.PlayShortWithVictoryLoop(Db.Get().ColonyAchievements.CollectedArtifacts.shortVideoName, Db.Get().ColonyAchievements.CollectedArtifacts.messageBody, Db.Get().ColonyAchievements.CollectedArtifacts.Id, Db.Get().ColonyAchievements.CollectedArtifacts.loopVideoName, showAchievements: true, AudioMixerSnapshots.Get().VictoryCinematicSnapshot);
