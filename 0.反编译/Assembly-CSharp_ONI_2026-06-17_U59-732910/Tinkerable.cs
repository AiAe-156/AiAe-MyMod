...
public class Tinkerable : Workable
{
	...
	private void UpdateChore()
	{
		...
		bool num = HasEffect();
		bool flag2 = HasCorrectRoom();
		bool flag3 = !num && flag && flag2 && userMenuAllowed;
		bool flag4 = num || !flag2 || !userMenuAllowed;
		if (chore == null && flag3)
		{
	...
	protected override void OnCompleteWork(WorkerBase worker)
	{
		...
		if (sound != null)
		{
			SoundEvent.EndOneShot(SoundEvent.BeginOneShot(sound, base.transform.position));
		}
	}
