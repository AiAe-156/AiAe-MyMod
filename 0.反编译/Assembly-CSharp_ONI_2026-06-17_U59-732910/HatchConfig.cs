...
public class HatchConfig : IEntityConfig
{
	...
	{
		return EntityTemplates.ExtendEntityToFertileCreature(CreateHatch("Hatch", STRINGS.CREATURES.SPECIES.HATCH.NAME, STRINGS.CREATURES.SPECIES.HATCH.DESC, "hatch_kanim", is_baby: false), this as IHasDlcRestrictions, "HatchEgg", STRINGS.CREATURES.SPECIES.HATCH.EGG_NAME, STRINGS.CREATURES.SPECIES.HATCH.DESC, "egg_hatch_kanim", HatchTuning.EGG_MASS, "HatchBaby", 60.000004f, 20f, HatchTuning.EGG_CHANCES_BASE, EGG_SORT_ORDER);
	}
