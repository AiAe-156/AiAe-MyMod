...
public class WoodGasGeneratorConfig : IBuildingConfig
{
	...
	public override BuildingDef CreateBuildingDef()
	{
		...
		BuildingDef obj = BuildingTemplates.CreateBuildingDef(construction_mass: TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, construction_materials: aLL_METALS, melting_point: 2400f, build_location_rule: BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER5, id: "WoodGasGenerator", width: 2, height: 2, anim: "generatorwood_kanim", hitpoints: 100, construction_time: 120f, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER2);
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		energyGenerator.formula = EnergyGenerator.CreateSimpleFormula("BuildingWood", 1.2f, max_stored_input_mass, SimHashes.CarbonDioxide, 0.17f, store_output_mass: false, new CellOffset(0, 1), 383.15f);
