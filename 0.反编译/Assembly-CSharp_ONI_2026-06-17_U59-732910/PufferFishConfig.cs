...
public class PufferFishConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToWildCreature(BasePufferFish.CreatePrefab(id, "PufferFishBaseTrait", name, desc, anim_file, is_baby, null, 273.15f, 333.15f, 253.15f, 373.15f), PufferFishTuning.PEN_SIZE_PER_CREATURE, add_fixed_capturable_monitor: true);
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToFertileCreature(CreatePufferFish("PufferFish", CREATURES.SPECIES.PUFFERFISH.NAME, CREATURES.SPECIES.PUFFERFISH.DESC, "blowfish_kanim", is_baby: false), this, "PufferFishEgg", CREATURES.SPECIES.PUFFERFISH.EGG_NAME, CREATURES.SPECIES.PUFFERFISH.DESC, "egg_blowfish_kanim", PufferFishTuning.EGG_MASS, "PufferFishBaby", 15.000001f, 5f, PufferFishTuning.EGG_CHANCES_BASE, 500, is_ranchable: true, add_fish_overcrowding_monitor: true);
		gameObject.AddTag(GameTags.OriginalCreature);
		return gameObject;
	}
