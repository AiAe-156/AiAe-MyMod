...
public class SlipperyMonitor : GameStateMachine<SlipperyMonitor, SlipperyMonitor.Instance, IStateMachineTarget, SlipperyMonitor.Def>
{
	...
	public new class Instance : GameInstance
	{
		...
		public bool IsImmune
		{
			get
			{
				if (!effects.HasEffect("RecentlySlippedTracker"))
				{
					return effects.HasImmunityTo(effect);
				}
				return true;
			}
		}
		...
		public bool IsWalking
		{
			get
			{
				if (navigator != null)
				{
					return navigator.CurrentNavType == NavType.Floor;
				}
				return false;
			}
		}
	...
	public class SlipReactable : Reactable
	{
		...
		public override bool InternalCanBegin(GameObject new_reactor, Navigator.ActiveTransition transition)
		{
			...
			if (component.CurrentNavType != NavType.Floor)
			{
				return false;
			}
			return true;
	...
	private static bool IsStandingOnASlipperyCell(Instance smi)
	{
		...
		if (gameObject != null && gameObject.GetComponent<KPrefabID>().HasTag(GameTags.PreventsSlipping))
		{
			return false;
		}
