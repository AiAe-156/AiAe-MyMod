...
public class TRAITS
{
	...
	public static readonly List<System.Action> TRAIT_CREATORS = new List<System.Action>
	{
		...
		TraitUtil.CreateSkillGrantingTrait("GrantSkill_Swimming2", DUPLICANTS.TRAITS.GRANTSKILL_SWIMMING2.NAME, DUPLICANTS.TRAITS.GRANTSKILL_SWIMMING2.DESC, new string[2] { "Swimming", "Swimming2" }),
