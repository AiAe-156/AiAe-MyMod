...
public class BulbloomConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		Light2D light2D = obj.AddOrGet<Light2D>();
		...
		obj.AddComponent<PlantGlowController>();
		...
		EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(obj, this, SeedProducer.ProductionType.Hidden, "BulbloomSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 13, domesticatedDescription), "Bulbloom_preview", Assets.GetAnim("bulbloom_kanim"), "place", 1, 1);
		return obj;
	}
