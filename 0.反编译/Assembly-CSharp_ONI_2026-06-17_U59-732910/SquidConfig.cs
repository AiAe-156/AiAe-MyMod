...
public class SquidConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToWildCreature(BaseSquidConfig.CreatePrefab(id, "SquidBaseTrait", name, desc, anim_file, is_baby, null, 313.15f, 373.15f, 293.15f, 393.15f), SquidTuning.PEN_SIZE_PER_CREATURE, add_fixed_capturable_monitor: true);
