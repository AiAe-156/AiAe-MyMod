...
public class SeaTurtleConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToWildCreature(BaseSeaTurtleConfig.CreatePrefab(id, "SeaTurtleBaseTrait", name, desc, anim_file, is_baby, null, 273.15f, 333.15f, 253.15f, 373.15f), SeaTurtleTuning.PEN_SIZE_PER_CREATURE, add_fixed_capturable_monitor: true);
