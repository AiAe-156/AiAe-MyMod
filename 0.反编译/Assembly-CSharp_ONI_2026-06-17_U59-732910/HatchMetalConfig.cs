...
public class HatchMetalConfig : IEntityConfig
{
	...
	public static HashSet<Tag> METAL_ORE_TAGS => new HashSet<Tag>(GameTags.BasicMetalOres)
	{
	...
	{
		return EntityTemplates.ExtendEntityToFertileCreature(CreateHatch("HatchMetal", STRINGS.CREATURES.SPECIES.HATCH.VARIANT_METAL.NAME, STRINGS.CREATURES.SPECIES.HATCH.VARIANT_METAL.DESC, "hatch_kanim", is_baby: false), this as IHasDlcRestrictions, "HatchMetalEgg", STRINGS.CREATURES.SPECIES.HATCH.VARIANT_METAL.EGG_NAME, STRINGS.CREATURES.SPECIES.HATCH.VARIANT_METAL.DESC, "egg_hatch_kanim", HatchTuning.EGG_MASS, "HatchMetalBaby", 60.000004f, 20f, HatchTuning.EGG_CHANCES_METAL, EGG_SORT_ORDER);
	}
