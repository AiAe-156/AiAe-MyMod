...
public class StarmapScreen : KModalScreen
{
	...
	private void UpdateRangeDisplay()
	{
		...
		breakdownListRow2.ShowStatusData(UI.STARMAP.ROCKETSTATS.TOTAL_THRUST, GameUtil.GetFormattedDistance(currentCommandModule.rocketStats.GetTotalThrust() * 1000f), BreakdownListRow.Status.Green);
		breakdownListRow2.SetImportant(important: true);
		...
		breakdownListRow3.ShowStatusData(UI.STARMAP.ROCKETSTATUS.WEIGHTPENALTY, DisplayDistance(distance), BreakdownListRow.Status.Red);
		breakdownListRow3.SetHighlighted(highlighted: true);
		...
		breakdownListRow4.ShowData(UI.STARMAP.ROCKETSTATS.TOTAL_RANGE, GameUtil.GetFormattedDistance(currentCommandModule.rocketStats.GetRocketMaxDistance() * 1000f));
		breakdownListRow4.SetImportant(important: true);
	}
	...
	private void ShowDestinationPanel()
	{
		...
		if (currentLaunchConditionManager != null && SpacecraftManager.instance.GetSpacecraftFromLaunchConditionManager(currentLaunchConditionManager).state != Spacecraft.MissionState.Grounded)
		{
