...
public class BionicUpgrade_ExplorerBoosterMonitor : BionicUpgrade_SM<BionicUpgrade_ExplorerBoosterMonitor, BionicUpgrade_ExplorerBoosterMonitor.Instance>
{
	...
	public new class Instance : BaseInstance
	{
		...
		public bool IsReadyToDiscover
		{
			get
			{
				...
				{
					return explorerBooster.IsReady;
				}
				return false;
			}
		}
		...
		public float CurrentProgress
		{
			get
			{
				if (explorerBooster != null)
				{
					return explorerBooster.Progress;
				}
				return 0f;
			}
		}
	...
	{
		if (BionicUpgrade_SM<BionicUpgrade_ExplorerBoosterMonitor, Instance>.IsOnline(smi) && BionicUpgrade_SM<BionicUpgrade_ExplorerBoosterMonitor, Instance>.IsInBedTimeChore(smi))
		{
			return IsThereGeysersToDiscover(smi);
		}
		return false;
	}
