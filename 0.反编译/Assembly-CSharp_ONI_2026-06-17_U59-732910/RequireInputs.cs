...
public class RequireInputs : KMonoBehaviour, ISim200ms
{
	...
	private void CheckRequirements()
	{
		...
		bool flag6 = num2 != 0 && conduitConsumer.enabled && requireConduitHasMass && requireConduit;
		bool flag7 = num2 != 0 && conduitConsumer.enabled && requireConduit;
		...
		bool flag12 = num4 != 0 && conduitConsumer.enabled && requireConduitHasMass && requireConduit;
		bool flag13 = num4 != 0 && conduitConsumer.enabled && requireConduit;
