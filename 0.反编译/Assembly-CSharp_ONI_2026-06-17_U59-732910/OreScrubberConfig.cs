...
public class OreScrubberConfig : IBuildingConfig
{
	...
	public override BuildingDef CreateBuildingDef()
	{
		...
		BuildingDef obj = BuildingTemplates.CreateBuildingDef(construction_mass: new float[1] { TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER3[0] }, construction_materials: array, melting_point: 1600f, build_location_rule: BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, id: "OreScrubber", width: 3, height: 3, anim: "orescrubber_kanim", hitpoints: 30, construction_time: 30f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER1);
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		oreScrubber.diseaseRemovalCount = DISEASE_REMOVAL_COUNT;
