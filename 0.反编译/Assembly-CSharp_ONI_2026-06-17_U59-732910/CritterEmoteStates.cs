...
public class CritterEmoteStates : GameStateMachine<CritterEmoteStates, CritterEmoteStates.Instance, IStateMachineTarget, CritterEmoteStates.Def>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		playing.ToggleAnims((Instance smi) => smi.emoteBuildFile).PlayAnims((Instance smi) => smi.emotion.isPositiveEmotion ? new HashedString[1] { "react_pos" } : new HashedString[1] { "react_neg" }).ScheduleGoTo(10f, behaviourcomplete)
