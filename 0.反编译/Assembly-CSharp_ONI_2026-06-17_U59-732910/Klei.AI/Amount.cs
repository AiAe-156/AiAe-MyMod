...
public class Amount : Resource
{
	...
	public bool CanDisplayerDisplayCustomIcons => displayer is IVariableImageAmountDisplayer;
	...
	{
		if (CanDisplayerDisplayCustomIcons)
		{
			return (displayer as IVariableImageAmountDisplayer).GetIcon(this, instance);
		}
		return Assets.GetSprite(uiSprite);
	}
