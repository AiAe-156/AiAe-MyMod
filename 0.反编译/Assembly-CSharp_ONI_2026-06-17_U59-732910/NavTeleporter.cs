...
public class NavTeleporter : KMonoBehaviour
{
	...
	private void SetLink()
	{
		...
		Pathfinding.Instance.GetNavGrid(DUPLICANTSTATS.STANDARD.BaseStats.NAV_GRID_NAME).teleportTransitions[lastRegisteredCell] = cell;
	...
	{
		Pathfinding.Instance.GetNavGrid(DUPLICANTSTATS.STANDARD.BaseStats.NAV_GRID_NAME).teleportTransitions.Remove(lastRegisteredCell);
		Pathfinding.Instance.AddDirtyNavGridCell(lastRegisteredCell);
	}
