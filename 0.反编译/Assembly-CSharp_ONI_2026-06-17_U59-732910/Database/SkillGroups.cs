...
public class SkillGroups : ResourceSet<SkillGroup>
{
		...
		: base("SkillGroups", parent)
	{
		...
		SwimmingSkills = Add(new SkillGroup("SwimmingSkills", DUPLICANTS.CHOREGROUPS.SWIMMING.NAME, DUPLICANTS.CHOREGROUPS.SWIMMING.NAME, "", ""));
		SwimmingSkills.relevantAttributes = new List<Attribute>();
		SwimmingSkills.requiredChoreGroups = new List<string>();
		SwimmingSkills.allowAsAptitude = false;
		if (DlcManager.IsContentSubscribed("DLC3_ID"))
		{
			BionicSkills = Add(new SkillGroup("BionicSkills", null, "", "", ""));
			BionicSkills.relevantAttributes = new List<Attribute>();
			BionicSkills.requiredChoreGroups = new List<string>();
			BionicSkills.allowAsAptitude = false;
		}
	}
}
