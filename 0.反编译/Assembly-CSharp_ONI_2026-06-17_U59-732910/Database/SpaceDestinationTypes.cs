...
public class SpaceDestinationTypes : ResourceSet<SpaceDestinationType>
{
		...
		: base("SpaceDestinations", parent)
	{
		...
		{
			DLC4PrehistoricSpaceDestination = Add(new SpaceDestinationType("DLC4PrehistoricSpaceDestination", parent, UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICSPACEDESTINATION.NAME, UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICSPACEDESTINATION.DESCRIPTION, 96, "prehistoric_base", new Dictionary<SimHashes, MathUtil.MinMax>
			{
				{
					SimHashes.NickelOre,
					new MathUtil.MinMax(100f, 200f)
			...
			DLC4PrehistoricDemoliorSpaceDestination = Add(new SpaceDestinationType("DLC4PrehistoricDemoliorSpaceDestination", parent, UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION.NAME, UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION.DESCRIPTION, 96, "prehistoric_demolior_debris1", new Dictionary<SimHashes, MathUtil.MinMax>
			{
				{
					SimHashes.Iridium,
					new MathUtil.MinMax(100f, 200f)
			...
			}, null, Db.Get().ArtifactDropRates.None, 384000000, 383980000, 60));
			DLC4PrehistoricDemoliorSpaceDestination2 = Add(new SpaceDestinationType("DLC4PrehistoricDemoliorSpaceDestination2", parent, UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION2.NAME, UI.SPACEDESTINATIONS.PLANETS.DLC4PREHISTORICDEMOLIORSPACEDESTINATION2.DESCRIPTION, 96, "prehistoric_demolior_debris2", new Dictionary<SimHashes, MathUtil.MinMax>
			{
				{
					SimHashes.Isoresin,
					new MathUtil.MinMax(100f, 200f)
		...
		{
			DLC5AquaticSpaceDestination = Add(new SpaceDestinationType("DLC5AquaticSpaceDestination", parent, UI.SPACEDESTINATIONS.PLANETS.DLC5AQUATICSPACEDESCRIPTION.NAME, UI.SPACEDESTINATIONS.PLANETS.DLC5AQUATICSPACEDESCRIPTION.DESCRIPTION, 96, "aquatic_base", new Dictionary<SimHashes, MathUtil.MinMax>
			{
				{
					SimHashes.ZincOre,
					new MathUtil.MinMax(100f, 200f)
