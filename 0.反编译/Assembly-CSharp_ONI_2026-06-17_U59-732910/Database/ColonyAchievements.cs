...
public class ColonyAchievements : ResourceSet<ColonyAchievement>
{
		...
		: base("ColonyAchievements", parent)
	{
		...
		if (DlcManager.IsContentSubscribed("DLC5_ID"))
		{
			...
			}, COLONY_ACHIEVEMENTS.FINDING_MINNOW.MESSAGE_TITLE, COLONY_ACHIEVEMENTS.FINDING_MINNOW.MESSAGE_BODY, "victoryShorts/Stay", "DLC5/aquatic_loop", FindingMinnowCompleteSequence.Start, AudioMixerSnapshots.Get().VictoryNISGenericSnapshot, "finding_minnow", DlcManager.DLC5, null, "DLC5_ID", "MinnowRecruitedAchievement"));
		}
	}
}
