...
public class BatteryMediumConfig : BaseBatteryConfig
{
	...
	{
		BuildingDef obj = CreateBuildingDef("BatteryMedium", 2, 2, 30, "batterymed_kanim", 60f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER4, MATERIALS.ALL_METALS, 800f, 0.25f, 1f, noise: NOISE_POLLUTION.NOISY.TIER1, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER2);
