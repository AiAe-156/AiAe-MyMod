...
public class MissileLongRangeProjectile : GameStateMachine<MissileLongRangeProjectile, MissileLongRangeProjectile.StatesInstance, IStateMachineTarget, MissileLongRangeProjectile.Def>
{
	...
	public class StatesInstance : GameInstance
	{
		...
		public void StartTakeoff()
		{
			...
			GetComponent<Pickupable>().handleFallerComponents = false;
		}
		...
		public void ExitWorldEnterStarmap()
		{
			...
			if (gameObject != null)
			{
				...
				if (component != null)
				{
					GameObject obj = GameUtil.KInstantiate(Assets.GetPrefab("ClusterMapLongRangeMissile"), Grid.SceneLayer.NoLayer);
					obj.SetActive(value: true);
					obj.GetSMI<ClusterMapLongRangeMissile.StatesInstance>().Setup(myLocation, component, base.def);
				}
				else
				{
