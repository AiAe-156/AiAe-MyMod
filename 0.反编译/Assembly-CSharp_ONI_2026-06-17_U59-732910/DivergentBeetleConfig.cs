...
public class DivergentBeetleConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject prefab = EntityTemplates.ExtendEntityToWildCreature(BaseDivergentConfig.BaseDivergent(id, name, desc, 50f, anim_file, is_baby ? null : "critter_build_kanim", "DivergentBeetleBaseTrait", is_baby), DivergentTuning.PEN_SIZE_PER_CREATURE);
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToFertileCreature(CreateDivergentBeetle("DivergentBeetle", STRINGS.CREATURES.SPECIES.DIVERGENT.VARIANT_BEETLE.NAME, STRINGS.CREATURES.SPECIES.DIVERGENT.VARIANT_BEETLE.DESC, "critter_kanim", is_baby: false), this, "DivergentBeetleEgg", STRINGS.CREATURES.SPECIES.DIVERGENT.VARIANT_BEETLE.EGG_NAME, STRINGS.CREATURES.SPECIES.DIVERGENT.VARIANT_BEETLE.DESC, "egg_critter_kanim", DivergentTuning.EGG_MASS, "DivergentBeetleBaby", 45f, 15f, DivergentTuning.EGG_CHANCES_BEETLE, EGG_SORT_ORDER);
