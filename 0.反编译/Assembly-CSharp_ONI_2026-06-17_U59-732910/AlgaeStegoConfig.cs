...
public class AlgaeStegoConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToFertileCreature(CreateStego("AlgaeStego", STRINGS.CREATURES.SPECIES.ALGAE_STEGO.NAME, STRINGS.CREATURES.SPECIES.ALGAE_STEGO.DESC, "stego_kanim", is_baby: false), this, "AlgaeStegoEgg", STRINGS.CREATURES.SPECIES.ALGAE_STEGO.EGG_NAME, STRINGS.CREATURES.SPECIES.ALGAE_STEGO.DESC, "egg_stego_kanim", 8f, "AlgaeStegoBaby", 120.00001f, 40f, StegoTuning.EGG_CHANCES_ALGAE, 0);
