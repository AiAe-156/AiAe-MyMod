...
public class CREATURES
{
	...
	public class SPECIES
	{
		...
		public class SEATURTLE
		{
			...
			public static LocString DESC = string.Concat("Orehulls are shy aquatic critters that eat ", FAMILY_PLURAL.SEAFAIRYSPECIES, " and excrete ", UI.FormatAsLink("Polluted Dirt", "TOXICSAND"), ".\n\nThey can be sheared for ", ELEMENTS.IRONORE.NAME, ".");
