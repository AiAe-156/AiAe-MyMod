...
public class MISC
{
	public class TAGS
	{
		...
		public static LocString PLASTIFIABLELIQUID_DESC = "Plastic monomers are organic compounds that can be processed into " + UI.FormatAsLink("Plastics", "PLASTIC") + " that have valuable applications as advanced building materials.\n\nPlastics derived from these monomers can also be used as packaging materials for " + UI.FormatAsLink("Food", "FOOD") + " preservation.";
		...
		public static LocString REMOTEOPERABLE_DESC = "These buildings can be operated from a distance by a " + UI.FormatAsLink("Remote Controller", "REMOTEWORKTERMINAL") + " so long as they are built within range of a " + UI.FormatAsLink("Remote Worker Dock", "REMOTEWORKERDOCK") + ".";

		public static LocString SLIPPERY = UI.FormatAsLink("Slippery", "SLIPPERY");

		public static LocString SLIPPERY_DESC = "Some " + UI.FormatAsLink("liquids", "ELEMENTS_LIQUID") + " and " + UI.FormatAsLink("solids", "ELEMENTS_SOLID") + " have a remarkably low coefficient of friction. These present a safety hazard if left on the ground, as Duplicants may slip and fall when traveling across them.";

		public static LocString CRITTERDRINKABLE = UI.FormatAsLink("Critter Drinkable", "CRITTERDRINKABLE");

		public static LocString CRITTERDRINKABLE_DESC = "These " + UI.FormatAsLink("liquids", "ELEMENTS_LIQUID") + " can be safely consumed by " + UI.FormatAsLink("Critters", "CREATURES") + " at the " + UI.FormatAsLink("Critter Fountain", "MILKFEEDER") + ". Giving critters access to proper hydration improves their mood and helps them better tolerate crowded living conditions.";
		...
		public static LocString ORGANICS_DESC = "Organic materials are useful ingredients gathered from the environment, harvested from " + UI.FormatAsLink("plants", "PLANTS") + " or derived from " + UI.FormatAsLink("critters", "CREATURES") + ".\n\nSome, not all, require additional processing before they can be used.";
		...
		public static LocString SUBLIMATING_DESC = "Sublimators are a class of " + UI.FormatAsLink("Solid", "ELEMENTS_SOLID") + " elements that passively convert to a " + UI.FormatAsLink("Gaseous", "ELEMENTS_GAS") + " state. When off-gassing is complete, no trace of the original solid remains.\n\nThis passive conversion persists when the element is left in storage.";
		...
		public static LocString COMPOSTABLE_DESC = string.Concat("Compostables are biological materials which can be put into a ", UI.FormatAsLink("Compost", "COMPOST"), " to generate clean ", UI.FormatAsLink("Dirt", "DIRT"), ".\n\nComposting also generates a small amount of ", UI.FormatAsLink("Heat", "HEAT"), ".\n\nOnce it starts to rot, consumable food should be composted to prevent ", DUPLICANTS.DISEASES.FOODPOISONING.NAME, ".");
		...
		public static LocString BUILDINGGASKET_DESC = "Gaskets are mechanical seals made from " + UI.FormatAsLink("Rubber", "RUBBER") + " or " + UI.FormatAsLink("Plastic", "PLASTIC") + " at the " + UI.FormatAsLink("Crafting Station", "CRAFTINGTABLE") + ".\n\nThey are essential components for certain buildings and objects that require a strong " + UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID") + " seal.";

		public static LocString COMBUSTIBLEGAS = UI.FormatAsLink("Combustible Gas", "COMBUSTIBLEGAS");

		public static LocString COMBUSTIBLEGAS_DESC = "Combustible Gases can be burned as fuel to be used in the production of " + UI.FormatAsLink("Power", "POWER") + " and " + UI.FormatAsLink("Food", "FOOD") + ".";

		public static LocString COMBUSTIBLELIQUID = UI.FormatAsLink("Combustible Liquid", "COMBUSTIBLELIQUID");

		public static LocString COMBUSTIBLELIQUID_DESC = "Combustible Liquids can be burned as fuels to be used in energy production, such as in a " + UI.FormatAsLink("Petroleum Generator", "PETROLEUMGENERATOR") + " or a " + UI.FormatAsLink(KeroseneEngineHelper.NAME, KeroseneEngineHelper.CODEXID) + ".\n\nThough these liquids have other uses, such as fertilizer for growing a " + UI.FormatAsLink("Nosh Bean", "BEANPLANTSEED") + ", their primary usefulness lies in their ability to be burned for " + UI.FormatAsLink("Power", "POWER") + ".";
	...
	public class STATUSITEMS
	{
		...
		public class UNDERWATERVENTBUILDUPPROGRESS
		{
			...
			public static LocString TOOLTIP = "This geyser will become blocked when " + UI.PRE_KEYWORD + "Sulfur" + UI.PST_KEYWORD + " build-up reaches 100%\n\nIt can be unblocked by building a " + UI.PRE_KEYWORD + "Marine Drill" + UI.PST_KEYWORD + " on top of the vent";
		}
		...
		public class UNDERWATERVENTBLOCKED
		{
			...
			public static LocString TOOLTIP = "This geyser is blocked by " + UI.PRE_KEYWORD + "Sulfur" + UI.PST_KEYWORD + " build-up\n\nIt will resume function when unblocked by a " + UI.PRE_KEYWORD + "Marine Drill" + UI.PST_KEYWORD;
		}
		...
		public class BIONICEXPLORERBOOSTERREADY
		{
			...
			public static LocString TOOLTIP = "This " + UI.PRE_KEYWORD + "Dowsing Booster" + UI.PST_KEYWORD + " has sufficient geodata stored to reveal a new geyser\n\nIt must be installed in a Bionic Duplicant in order to function";
		}
		...
		public class MINNOWPOIDEHYDRATEDSTATUS
		{
			...
			public static LocString TOOLTIP = "This area was once a " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD + " pool occupied by an unknown survivor Duplicant\n\nIts occupant will return when the area is sufficiently flooded";
		}
	...
	public class NOTIFICATIONS
	{
		...
		public class LOTS_OF_GERMS
		{
			...
			public static LocString MESSAGEBODY = string.Concat(UI.FormatAsLink("Germs", "DISEASE"), " such as ", DUPLICANTS.DISEASES.FOODPOISONING.NAME, " and ", DUPLICANTS.DISEASES.SLIMELUNG.NAME, " can cause ", UI.FormatAsLink("Disease", "DISEASE"), " in my Duplicants. I can use the ", UI.FormatAsOverlay("Germ Overlay", Action.Overlay9), " to view all germ concentrations in my colony, and even detect the sources spawning them.\n\nBuilding Wash Basins from the ", UI.FormatAsBuildMenuTab("Medicine Tab", Action.Plan8), " near colony toilets will tell my Duplicants they need to wash up.\n\nRelated ", UI.FormatAsLink("Video: Plumbing and Ventilation", "VIDEOS18"));
		}
		...
		public class BIONICBATTERY
		{
			...
			public static LocString MESSAGEBODY = "Bionic Duplicants require " + UI.FormatAsLink("Power Banks", "ELECTROBANK") + " to function. Bionic Duplicants who run out of " + UI.FormatAsLink("Power", "POWER") + " will become incapacitated and require another Duplicant to reboot them.\n\nBasic power banks can be made at the " + UI.FormatAsLink("Crafting Station", "CRAFTINGTABLE") + ".";
		}
		...
		public class GUNKEDTOILET
		{
			...
			public static LocString MESSAGEBODY = "Bionic Duplicants can dump built-up " + UI.FormatAsLink("Gunk", "LIQUIDGUNK") + " into " + UI.FormatAsLink("Toilets", "REQUIREMENTCLASSTOILETTYPE") + " if no other options are available. This invariably clogs the plumbing, however, and must be removed before facilities can be used by other Duplicants.\n\nBuilding a " + UI.FormatAsLink("Gunk Extractor", "GUNKEMPTIER") + " from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5) + " will ensure that Bionic Duplicants can dispose of their waste appropriately.";
		}
