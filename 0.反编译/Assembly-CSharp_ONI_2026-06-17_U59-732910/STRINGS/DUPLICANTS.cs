...
public class DUPLICANTS
{
	public class MODEL
	{
		public class STANDARD
		{
			...
			public static LocString DESC = "Standard Duplicants are hard workers who enjoy good " + UI.FormatAsLink("Food", "FOOD") + ", fresh " + UI.FormatAsLink("Oxygen", "OXYGEN") + " and creative colony-building.\n\nThey will complete errands in order of " + UI.FormatAsLink("Priority", "PRIORITY") + ".";
		...
		public class BIONIC
		{
			...
			public static LocString DESC = "Bionic Duplicants run on " + UI.FormatAsLink("Power Banks", "ELECTROBANK") + ", " + UI.FormatAsLink("Gear Oil", "LUBRICATINGOIL") + " and unbridled enthusiasm.\n\nThey should not be permitted to use standard " + UI.FormatAsLink("Toilets", "MISCELLANEOUSTIPS") + ".";
	...
	public class STATS
	{
		...
		public class BIONICINTERNALBATTERY
		{
			...
			public static LocString TOOLTIP = "A Bionic Duplicant with zero remaining " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + " will become incapacitated until replacement " + UI.PRE_KEYWORD + "Power Banks" + UI.PST_KEYWORD + " are installed";
		}
		...
		public class BIONICOXYGENTANK
		{
			...
			public static LocString TOOLTIP = "Bionic Duplicants have internal " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " tanks that enable them to work in low breathability areas\n\nThey will prioritize " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " intake from equipped " + UI.PRE_KEYWORD + "Exosuits" + UI.PST_KEYWORD + " to conserve their internal tanks";
		...
		public class BIONICOIL
		{
			...
			public static LocString TOOLTIP = "Bionic Duplicants will slow down significantly when " + UI.PRE_KEYWORD + "Gear Oil" + UI.PST_KEYWORD + " levels reach zero\n\nThey can oil their joints by visiting a " + UI.PRE_KEYWORD + "Lubrication Station" + UI.PST_KEYWORD + " or using " + UI.PRE_KEYWORD + "Gear Balm" + UI.PST_KEYWORD + " ";
		}
		...
		public class BIONICGUNK
		{
			...
			public static LocString TOOLTIP = "Bionic Duplicants become " + UI.PRE_KEYWORD + "Stressed" + UI.PST_KEYWORD + " when too much " + UI.PRE_KEYWORD + "Gunk" + UI.PST_KEYWORD + " builds up in their bionic parts\n\nRegular visits to the " + UI.PRE_KEYWORD + "Gunk Extractor" + UI.PST_KEYWORD + " are required";
		}
		...
		public class BREATH
		{
			...
			public static LocString TOOLTIP = "A Duplicant with zero remaining " + UI.PRE_KEYWORD + "Breath" + UI.PST_KEYWORD + " will become incapacitated and die unless they are rescued\n\nDuplicants can increase their " + UI.PRE_KEYWORD + "Maximum Breath" + UI.PST_KEYWORD + " by learning the " + UI.PRE_KEYWORD + "Basic Swimming" + UI.PST_KEYWORD + " skill";
		}
	...
	public class CHORES
	{
		...
		public class BEOFFLINE
		{
			...
			public static LocString TOOLTIP = "This Duplicant does not have enough " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + " to function";
		}
		...
		public class EXPELLGUNK
		{
			...
			public static LocString TOOLTIP = "This Duplicant didn't get to a " + UI.PRE_KEYWORD + "Gunk Extractor" + UI.PST_KEYWORD + " in time. Urgh";
		}
		...
		public class STRESSSHOCK
		{
			...
			public static LocString TOOLTIP = "This Duplicant's inability to handle " + UI.PRE_KEYWORD + "Stress" + UI.PST_KEYWORD + " is pretty shocking";
		}
		...
		public class RELOADELECTROBANK
		{
			...
			public static LocString TOOLTIP = "Bionic Duplicants need " + UI.PRE_KEYWORD + "Power Banks" + UI.PST_KEYWORD + " to function";
		}
		...
		public class FINDOXYGENSOURCEITEM
		{
			...
			public static LocString TOOLTIP = "Bionic Duplicants are fitted with internal " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " tanks that must be refilled";
		}
		...
		public class BIONICABSORBOXYGENCRITICAL
		{
			...
			public static LocString TOOLTIP = "This Duplicant is refilling their depleted " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " tank in the nearest breathable area: {0} O<sub>2</sub>\n\nImproving colony breathability and scheduling regular " + UI.PRE_KEYWORD + "Downtime" + UI.PST_KEYWORD + " will prevent future emergencies";
		}
		...
		public class CLEANLITTERBOX
		{
			...
			public static LocString TOOLTIP = string.Concat(BUILDINGS.PREFABS.LITTERBOX.NAME, "s need to be scooped in order for their contents to drop");
		}
	...
	public class STATUSITEMS
	{
		public class EMPTYINGLITTERBOX
		{
			...
			public static LocString TOOLTIP = string.Concat("This Duplicant is emptying a ", BUILDINGS.PREFABS.LITTERBOX.NAME, "\n\nUgh");
		}
		...
		public class PUFFER_SHARING_AIR
		{
			...
			public static LocString TOOLTIP = "This Duplicant is breathing in a " + UI.PRE_KEYWORD + "Blowter's" + UI.PST_KEYWORD + " stored " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " to avoid drowning";
		}
		...
		public class BIONICMICROCHIPGENERATION
		{
			...
			public static LocString TOOLTIP = "This Duplicant is programming a microchip for use in " + UI.PRE_KEYWORD + "Booster" + UI.PST_KEYWORD + " production\n\nBionic Duplicants will program microchips while defragmenting\n\nThey will produce 1 microchip every {0}";
		}
		...
		public class BIONICREQUIRESSKILLPERK
		{
			...
			public static LocString TOOLTIP = "Only Duplicants with the following " + UI.PRE_KEYWORD + "Skills" + UI.PST_KEYWORD + " can reboot this Duplicant's bionic systems:\n\n{Skills}";
		}
		...
		public class CLOGGINGTOILET
		{
			...
			public static LocString TOOLTIP = "This Duplicant is clogging a toilet with " + UI.PRE_KEYWORD + "Gunk" + UI.PST_KEYWORD + "\n\nThey couldn't get to a " + UI.PRE_KEYWORD + "Gunk Extractor" + UI.PST_KEYWORD + " in time";
		}
		...
		public class STRESS_SIGNAL_STRESS_SHOCKER
		{
			...
			public static LocString TOOLTIP = "This Duplicant's hanging by a thread...except the thread is a live wire\n\nImprove this Duplicant's " + UI.PRE_KEYWORD + "Morale" + UI.PST_KEYWORD + " before they zap someone";
		}
		...
		public class STRESSFULLYEMPTYINGOIL
		{
			...
			public static LocString TOOLTIP = "This Bionic Duplicant couldn't get to a " + UI.FormatAsLink("Gunk Extractor", "GUNKEMPTIER") + " in time and got desperate\n\n" + UI.FormatAsLink("Gunk Extractors", "GUNKEMPTIER") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5);
		...
		public class BIONICCRITICALBATTERY
		{
			...
			public static LocString TOOLTIP = "This Duplicant's " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + " is dangerously low\n\nThey will become incapacitated unless new " + UI.PRE_KEYWORD + "Power Banks" + UI.PST_KEYWORD + " are delivered";

			public static LocString NOTIFICATION_NAME = "Critical Power Level";

			public static LocString NOTIFICATION_TOOLTIP = "These Duplicants will become incapacitated if they can't find " + UI.PRE_KEYWORD + "Power Banks" + UI.PST_KEYWORD + ":";
		}
		...
		public class REMOTEWORKER
		{
			...
			public class LOWPOWER
			{
				...
				public static LocString TOOLTIP = "This remote worker has low " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + "\n\nIt will recharge at its dock before accepting new chores";
			}
			...
			public class OUTOFPOWER
			{
				...
				public static LocString TOOLTIP = "This remote worker cannot function without " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + "\n\nIt must be returned to its dock";
			}
			...
			public class HIGHGUNK
			{
				...
				public static LocString TOOLTIP = "This remote worker will return to its dock to remove " + UI.PRE_KEYWORD + "Gunk" + UI.PST_KEYWORD + " buildup before accepting new chores";
			}
			...
			public class FULLGUNK
			{
				...
				public static LocString TOOLTIP = "This remote worker cannot function due to excessive " + UI.PRE_KEYWORD + "Gunk" + UI.PST_KEYWORD + " buildup\n\nIt must be returned to its dock";
			}
			...
			public class OUTOFOIL
			{
				...
				public static LocString TOOLTIP = "This remote worker cannot function without " + UI.PRE_KEYWORD + "Gear Oil" + UI.PST_KEYWORD + "\n\nIt must be returned to its dock";
			}
	...
	public class MODIFIERS
	{
		...
		public class FRESHOIL
		{
			...
			public static LocString TOOLTIP = string.Concat("This Duplicant recently used a ", BUILDINGS.PREFABS.OILCHANGER.NAME, " and feels pretty slick");
		}
		...
		public class REFRESHINGTOUCH
		{
			...
			public static LocString TOOLTIP = "This Duplicant recently visited a cooling station and is impervious to " + UI.PRE_KEYWORD + "Toasty Surroundings" + UI.PST_KEYWORD + " as a result";
		}
		...
		public class GUNKSICK
		{
			...
			public static LocString TOOLTIP = "This Duplicant needs to visit a " + UI.PRE_KEYWORD + "Gunk Extractor" + UI.PST_KEYWORD + " as soon as possible\n\nThey will use a toilet as a last resort";
		}
		...
		public class GUNKHUNGOVER
		{
			...
			public static LocString TOOLTIP = "This Duplicant recently expelled built-up " + UI.PRE_KEYWORD + "Gunk" + UI.PST_KEYWORD + " and can still taste it";
		}
		...
		public class BIONICWATERSTRESS
		{
			...
			public static LocString TOOLTIP = "This Duplicant's bionic parts are currently in contact with incompatible " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + "\n\nProlonged exposure could have serious " + UI.PRE_KEYWORD + "Stress" + UI.PST_KEYWORD + " consequences";
		}
		...
		public class DUPLICANTDRANKINK
		{
			...
			public static LocString TOOLTIP = "This Duplicant recently drank " + UI.PRE_KEYWORD + "Squid Ink" + UI.PST_KEYWORD + ". It's helping them relax";
		}
		...
		public class MESSCAVIAR
		{
			...
			public static LocString TOOLTIP = "This Duplicant recently ate a meal topped with " + UI.PRE_KEYWORD + "Caviar" + UI.PST_KEYWORD + "\n\nThey're feeling very swanky";
		}
		...
		public class THIRSTY
		{
			...
			public static LocString TOOLTIP = "This Duplicant ate a very salty snack and is feeling parched\n\nVisiting a " + UI.FormatAsLink("Water Cooler", "WATERCOOLER") + " will restore their " + UI.PRE_KEYWORD + "Stamina" + UI.PST_KEYWORD;
		...
		public class BIONIC_WATTS
		{
			...
			{
				public static LocString ESTIMATED_LIFE_TIME_REMAINING = "Estimated " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + " supply remaining: {0}";
		...
		public class LOWOXYGENBIONIC
		{
			...
			public static LocString TOOLTIP = "This Duplicant's internal " + UI.PRE_KEYWORD + "Oxygen" + UI.PST_KEYWORD + " tank is dangerously low";
		}
		...
		public class BADSLEEPDEFRAGMENTING
		{
			...
			public static LocString TOOLTIP = "This Duplicant kept waking up because of the " + UI.PRE_KEYWORD + "Light" + UI.PST_KEYWORD + " produced by a Bionic Duplicant defragmenting nearby";
		}
	...
	public class TRAITS
	{
		...
		{
			public static LocString NAME = string.Concat(GRANTED_SKILL_SHARED_NAME, ROLES.SWIMMER.NAME);

			public static LocString DESC = ROLES.SWIMMER.DESCRIPTION;
		...
		{
			public static LocString NAME = string.Concat(GRANTED_SKILL_SHARED_NAME, ROLES.EXPERT_SWIMMER.NAME);

			public static LocString DESC = ROLES.EXPERT_SWIMMER.DESCRIPTION;
		...
		public class STARTWITHBOOSTER_DIG1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_DIG1.NAME, "</b>");

			public static LocString SHORT_DESC_TOOLTIP = STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP;
		}
		...
		public class STARTWITHBOOSTER_CONSTRUCT1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_CONSTRUCT1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_CARRY1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_CARRY1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_MEDICINE1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_MEDICINE1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_DIG2
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_DIG2.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_FARM1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_FARM1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_RANCH1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_RANCH1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_COOK1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_COOK1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_OP1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_OP1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_ART1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_ART1.NAME, "</b>");
		...
		public class STARTWITHBOOSTER_SUITS1
		{
			...
			public static LocString SHORT_DESC = string.Concat("Starts with a preinstalled <b>", ITEMS.BIONIC_BOOSTERS.BOOSTER_SUITS1.NAME, "</b>");
		...
		public static LocString STARTING_BIONIC_BOOSTER_SHARED_DESC_TOOLTIP = string.Concat("Bionic Duplicants use boosters to increase their skills and attributes\n\nBoosters can be crafted at the ", BUILDINGS.PREFABS.CRAFTINGTABLE.NAME, " and ", BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME, "\n\nPreinstalled booster effects:");

		public static LocString GRANTED_SKILL_SHARED_NAME = "Skilled: ";

		public static LocString GRANTED_SKILL_NO_MORALE_COST = "This Duplicant begins with a pre-learned " + UI.FormatAsKeyWord("Skill") + ", but does not have increased " + UI.FormatAsKeyWord(DUPLICANTS.NEEDS.QUALITYOFLIFE.NAME) + ".";

		public static LocString GRANTED_SKILL_SHARED_DESC = string.Concat(GRANTED_SKILL_NO_MORALE_COST, "\n\n{0}\n{1}");
	...
	public class ATTRIBUTES
	{
		...
		public class LEARNING
		{
			...
			public static LocString DESC = "Determines how quickly a Duplicant conducts " + UI.PRE_KEYWORD + "Research" + UI.PST_KEYWORD + " and levels up their " + UI.PRE_KEYWORD + "Attributes" + UI.PST_KEYWORD + ".";
	...
	public class ROLES
	{
		...
		public class COOK
		{
			...
			public static LocString DESCRIPTION = string.Concat("Allows Duplicants to cook using the ", BUILDINGS.PREFABS.GOURMETCOOKINGSTATION.NAME, ", ", BUILDINGS.PREFABS.SMOKER.NAME, ", ", BUILDINGS.PREFABS.DEEPFRYER.NAME, ", ", BUILDINGS.PREFABS.SUSHIBAR.NAME, ", and ", BUILDINGS.PREFABS.SPICEGRINDER.NAME);
		}
		...
		public class SENIOR_FARMER
		{
			...
			public static LocString DESCRIPTION = string.Concat("Enables a Duplicant to gather ", ITEMS.INDUSTRIAL_PRODUCTS.PLANT_FIBER.NAME, "s as a byproduct when harvesting certain ", UI.CODEX.CATEGORYNAMES.PLANTS);
		}
		...
		public class BIONICS_C1
		{
			...
			public static LocString DESCRIPTION = string.Concat("Allows Bionic Duplicants to perform research using a ", BUILDINGS.PREFABS.ADVANCEDRESEARCHCENTER.NAME, ", and craft items at the ", BUILDINGS.PREFABS.ADVANCEDCRAFTINGTABLE.NAME, ".");
		}
