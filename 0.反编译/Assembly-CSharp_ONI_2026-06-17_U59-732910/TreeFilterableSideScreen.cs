...
public class TreeFilterableSideScreen : SideScreenContent
{
	...
	private TreeFilterableSideScreenRow AddRow(Tag rowTag)
	{
		...
		foreach (TagOrderInfo item in GetTagsSortedAlphabetically(DiscoveredResources.Instance.GetDiscoveredResourcesFromTag(rowTag)).FindAll((TagOrderInfo t) => !targetFilterable.ForbiddenTags.Contains(t.tag)))
		{
