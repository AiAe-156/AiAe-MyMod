...
public class StatusItemGroup
{
	...
	private static Func<List<Notification>, object, string> OnToolTip = (List<Notification> notifications, object data) => ((StatusItem)data).notificationTooltipText + notifications.ReduceMessages();
