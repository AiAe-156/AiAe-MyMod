...
public class UrchinPlantConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicPlant(gameObject, 303.15f, 313.15f, 353.15f, 383.15f, new SimHashes[5]
		{
			...
			SimHashes.Ink
		}, pressure_sensitive: false, 0f, 0.15f, "Urchin", can_drown: false, can_tinker: true, require_solid_tile: false, require_Backwall_Foundation: true, should_grow_old: true, 2400f, 0f, 2200f, "UrchinPlantOriginal", STRINGS.CREATURES.SPECIES.URCHINPLANT.NAME);
		...
		EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, this, SeedProducer.ProductionType.Harvest, "UrchinPlantSeed", name, desc, anim, "object", 1, additionalTags, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 2, domesticatedDescription), "UrchinPlant_preview", Assets.GetAnim("urchin_plant_kanim"), "place", 2, 2);
		return gameObject;
	}
