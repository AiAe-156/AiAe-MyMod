...
public class MinMaxSlider : KMonoBehaviour
{
	...
	protected override void OnSpawn()
	{
		...
		Slider.Direction direction = (maxSlider.direction = this.direction);
		...
		if (extraSlider != null)
		{
			...
			bool flag = (maxSlider.wholeNumbers = wholeNumbers);
			bool flag3 = (slider3.wholeNumbers = flag);
			slider2.wholeNumbers = flag3;
	...
	{
		float num = (minSlider.value = currentMin);
		currentMinValue = num;
		num = (maxSlider.value = currentMax);
		currentMaxValue = num;
		minLimit = min;
		maxLimit = max;
		minSlider.minValue = minLimit;
