...
public class GravitasPotPlantDeadConfig : IEntityConfig
{
	...
	{
		GameObject obj = EntityTemplates.CreatePlacedEntity("GravitasPotPlantDead", STRINGS.BUILDINGS.PREFABS.PROPGRAVITASPOTPLANTDEAD.NAME, STRINGS.BUILDINGS.PREFABS.PROPGRAVITASPOTPLANTDEAD.DESC, 25f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_tall_plant_dead_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 1, height: 2, permittedRotation: PermittedRotations.Unrotatable, orientation: Orientation.Neutral, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
