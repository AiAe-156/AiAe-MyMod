...
public class SteamUGCService : MonoBehaviour
{
	...
	private void Update()
	{
		...
		foreach (PublishedFileId_t download in downloads)
		{
			...
			if (((itemState & EItemState.k_EItemStateInstalled) == 0 || (itemState & EItemState.k_EItemStateNeedsUpdate) != EItemState.k_EItemStateNone) && (itemState & (EItemState.k_EItemStateDownloading | EItemState.k_EItemStateDownloadPending)) == 0 && SteamUGC.DownloadItem(download, bHighPriority: false))
			{
