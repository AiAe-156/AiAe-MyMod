...
public class PuftConfig : IEntityConfig
{
	...
	{
		return EntityTemplates.ExtendEntityToFertileCreature(CreatePuft("Puft", STRINGS.CREATURES.SPECIES.PUFT.NAME, STRINGS.CREATURES.SPECIES.PUFT.DESC, "puft_kanim", is_baby: false), this as IHasDlcRestrictions, "PuftEgg", STRINGS.CREATURES.SPECIES.PUFT.EGG_NAME, STRINGS.CREATURES.SPECIES.PUFT.DESC, "egg_puft_kanim", PuftTuning.EGG_MASS, "PuftBaby", 45f, 15f, PuftTuning.EGG_CHANCES_BASE, EGG_SORT_ORDER);
	}
