...
public class RadiationMonitor : GameStateMachine<RadiationMonitor, RadiationMonitor.Instance>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		active.sick.minor.ToggleEffect((Instance smi) => (!smi.master.gameObject.HasTag(GameTags.Minions.Models.Bionic)) ? minorSicknessEffect : bionic_minorSicknessEffect).ParamTransition(radiationExposure, active.sick.deadly, COMPARE_GTE_DEADLY).ParamTransition(radiationExposure, active.sick.extreme, COMPARE_GTE_EXTREME)
			.ParamTransition(radiationExposure, active.sick.major, COMPARE_GTE_MAJOR)
		...
		active.sick.major.ToggleEffect((Instance smi) => (!smi.master.gameObject.HasTag(GameTags.Minions.Models.Bionic)) ? majorSicknessEffect : bionic_majorSicknessEffect).ParamTransition(radiationExposure, active.sick.deadly, COMPARE_GTE_DEADLY).ParamTransition(radiationExposure, active.sick.extreme, COMPARE_GTE_EXTREME)
		...
		active.sick.extreme.ParamTransition(radiationExposure, active.sick.deadly, COMPARE_GTE_DEADLY).ToggleEffect((Instance smi) => (!smi.master.gameObject.HasTag(GameTags.Minions.Models.Bionic)) ? extremeSicknessEffect : bionic_extremeSicknessEffect).ToggleAnims("anim_loco_radiation3_kanim", 4f)
