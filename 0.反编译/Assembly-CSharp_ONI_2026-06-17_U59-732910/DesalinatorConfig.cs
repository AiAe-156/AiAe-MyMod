...
public class DesalinatorConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("Desalinator", 4, 3, "desalinator_kanim", 30, 10f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.RAW_METALS, 1600f, BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NOISY.TIER1, decor: TUNING.BUILDINGS.DECOR.PENALTY.TIER0);
		...
		obj.AddSearchTerms(SEARCH_TERMS.FILTER);
		return obj;
	}
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		elementConverter3.consumedElements = new ElementConverter.ConsumedElement[1]
		{
			new ElementConverter.ConsumedElement(new Tag("MurkyBrine"), 5f)
		};
		elementConverter3.outputElements = new ElementConverter.OutputElement[2]
		{
			new ElementConverter.OutputElement(3.5f, SimHashes.DirtyWater, 0f, useEntityTemperature: false, storeOutput: true, 0f, 0.5f, 0.75f),
			new ElementConverter.OutputElement(1.5f, SimHashes.Salt, 0f, useEntityTemperature: false, storeOutput: true, 0f, 0.5f, 0.25f)
		};
		...
		conduitDispenser.elementFilter = new SimHashes[3]
		{
			SimHashes.SaltWater,
			SimHashes.Brine,
