...
public class ResuscitateSuffocatedChore : Chore<ResuscitateSuffocatedChore.StatesInstance>
{
	...
	public override void Begin(Precondition.Context context)
	{
		...
		Vector3 pos = Grid.CellToPosCBC(StatesInstance.FindClosestOxygenCellToIncapacitated(context.consumerState.navigator, Grid.PosToCell(gameObject)), Grid.SceneLayer.Move);
