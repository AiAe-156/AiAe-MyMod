...
public class FloorSwitchActivator : KMonoBehaviour
{
	...
	private void Register()
	{
		if (!registered)
		{
			...
			cellChangeHandlerID = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(base.transform, OnCellChangeDispatcher, this, "FloorSwitchActivator.Register");
			registered = true;
		}
	}
