...
public class WiltCondition : KMonoBehaviour
{
	...
	{
		component.SetCondition(Condition.Entombed, !Boxed<bool>.Unbox(data));
	});
	...
	{
		component.SetCondition(Condition.UnhealthyRoot, Boxed<bool>.Unbox(data));
	});
	...
	{
		component.SetCondition(Condition.Pollination, Boxed<bool>.Unbox(data));
	});
	...
	{
		component.SetCondition(Condition.GermPresence, Boxed<bool>.Unbox(data));
	});
	...
	protected override void OnPrefabInit()
	{
		...
		WiltConditions.Add(13, value: true);
		WiltConditions.Add(14, value: true);
		...
		Subscribe(-200207042, SetPollinatedDelegate);
		Subscribe(-1689370368, SetGermPresenceDelegate);
	}
	...
	public bool IsConditionSatisifed(Condition condition)
	{
		bool value;
		return WiltConditions.TryGetValue((int)condition, out value) && value;
	}
