...
public class ScheduleMinionWidget : KMonoBehaviour
{
	...
	public void RefreshWidgetWorldData()
	{
		...
		label.text = minionIdentity.GetProperName();
	...
	private void DropEntryRefreshAction(DropDownEntry entry, object obj)
	{
		...
		entry.gameObject.GetComponent<HierarchyReferences>().GetReference<RectTransform>("ScheduleIcon").gameObject.SetActive(value: true);
		entry.gameObject.GetComponent<HierarchyReferences>().GetReference<RectTransform>("PortraitContainer").gameObject.SetActive(value: false);
	}
	...
	private void BlankDropEntryRefreshAction(DropDownEntry entry, object obj)
	{
		...
		entry.gameObject.GetComponent<HierarchyReferences>().GetReference<RectTransform>("ScheduleIcon").gameObject.SetActive(value: false);
		entry.gameObject.GetComponent<HierarchyReferences>().GetReference<RectTransform>("PortraitContainer").gameObject.SetActive(value: true);
	}
