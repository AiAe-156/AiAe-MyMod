...
public class ArtifactCargoBayConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("ArtifactCargoBay", 3, 1, "artifact_transport_module_kanim", 1000, 60f, TUNING.BUILDINGS.ROCKETRY_MASS_KG.HOLLOW_TIER1, MATERIALS.REFINED_METALS, 9999f, BuildLocationRule.Anywhere, noise: NOISE_POLLUTION.NOISY.TIER2, decor: TUNING.BUILDINGS.DECOR.NONE);
		...
		obj.AddSearchTerms(SEARCH_TERMS.ROCKET);
		return obj;
	}
