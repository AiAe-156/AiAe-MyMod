...
public class GameNavGrids
{
	...
	private NavGrid CreateLargeSwimmerNavigation(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets)
	{
		NavGrid.Transition[] transitions = new NavGrid.Transition[5]
		{
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0]),
			new NavGrid.Transition(NavType.Swim, NavType.Swim, 1, 1, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 2, "swim_swim_1_0", new CellOffset[1]
			{
				new CellOffset(1, 0)
			}, new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true),
		...
		NavGrid navGrid = new NavGrid(id, transitions2, nav_type_data, bounding_offsets, new NavTableValidator[1]
		{
			new SwimValidator(requireSubstantialLiquidAbove: true)
		}, 2, 2, 16);
		pathfinding.AddNavGrid(navGrid);
