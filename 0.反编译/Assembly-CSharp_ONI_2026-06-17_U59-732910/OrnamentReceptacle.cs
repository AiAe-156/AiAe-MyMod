...
public class OrnamentReceptacle : SingleEntityReceptacle
{
	...
	public bool IsHoldingOrnament
	{
		get
		{
			...
			{
				return base.Occupant.HasTag(GameTags.Ornament);
			}
			return false;
		}
	}
	...
	public virtual void RefreshDecorTag()
	{
		...
		bool num = component.HasTag(GameTags.Decoration);
		bool flag = base.Occupant != null && (operational == null || operational.IsOperational);
		if (flag)
		{
