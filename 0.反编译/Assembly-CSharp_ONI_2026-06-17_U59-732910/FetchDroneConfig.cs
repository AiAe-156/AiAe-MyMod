...
public class FetchDroneConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	public GameObject CreatePrefab()
	{
		...
		gameObject.AddComponent<OccupyArea>().SetCellOffsets(new CellOffset[1] { CellOffset.none });
		gameObject.AddOrGet<DrowningMonitor>();
		gameObject.AddOrGetDef<SubmergedMonitor.Def>();
		gameObject.AddOrGet<Health>();
		gameObject.AddOrGetDef<MoveToLocationMonitor.Def>().invalidTagsForMoveTo = new Tag[1] { GameTags.Robots.Behaviours.NoElectroBank };
