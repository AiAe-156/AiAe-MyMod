...
public class LogicGateFilter : LogicGate, ISingleSliderControl, ISliderControl
{
	...
	protected override void OnSpawn()
	{
		...
		logicCircuitManager.onLogicTick = (System.Action)Delegate.Combine(logicCircuitManager.onLogicTick, new System.Action(onLogicTick));
	}

	protected override void OnCleanUp()
	{
		LogicCircuitManager logicCircuitManager = Game.Instance.logicCircuitManager;
		logicCircuitManager.onLogicTick = (System.Action)Delegate.Remove(logicCircuitManager.onLogicTick, new System.Action(onLogicTick));
		base.OnCleanUp();
	}
